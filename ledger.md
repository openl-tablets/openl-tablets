...
PR #2062 is open on `dead-code/commented-out-java` — two commits, types 56 and 57.
...
- Pom `<resource>`/`<testResource>` directories all exist, and every module re-declaring a root-inherited
  dependency changes its scope.
