...
public class UsersRestTest {
    ...
    public void testMail() throws IOException, MessagingException {
        ...
        client.postForObject("/web/admin/settings/mail-verification-server", newMailConfig, "Authorization", "Basic YWRtaW46YWRtaW4=");
        client.send("users-service/mail/studio-settings");

        MailConfig mailConfig = client.getForObject("/web/admin/settings/mail-verification-server", MailConfig.class, 200, "Authorization", "Basic YWRtaW46YWRtaW4=");
