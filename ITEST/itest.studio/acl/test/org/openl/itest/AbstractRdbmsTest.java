 ...
 * Studio release. Each concrete subclass covers one supported RDBMS (MySQL, SQL Server, Oracle,
 * PostgreSQL) by supplying its container.
 *
 * <p>The test runs as a single pass. The previous-release image creates and seeds the schema, then
