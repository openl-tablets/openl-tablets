...
public class XlsMultiPassBinder extends MultiPassBinder 
{
	...
	static public abstract class XlsMultiPass extends MultiPass
	{
		...
		@Override
		public void makePass(MultiPassBinder mpbinder, IBoundNode node,
				IBindingContext cxt) {
			makeXlsPass((XlsMultiPassBinder)mpbinder, (ATableBoundNode)node, cxt);
			
		}

		public abstract void makeXlsPass(XlsMultiPassBinder mpbinder,
				ATableBoundNode node, IBindingContext cxt);
	...
	static class ParseComponents extends XlsMultiPass
	{
		...
		@Override
		public void makeXlsPass(XlsMultiPassBinder mpbinder,
				ATableBoundNode node, IBindingContext cxt) 
		{
