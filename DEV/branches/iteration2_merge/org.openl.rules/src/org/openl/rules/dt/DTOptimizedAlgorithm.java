...
public class DTOptimizedAlgorithm
{
	 ...
	 * @return
	 */
	public static IDTConditionEvaluator makeEvaluator(IDTCondition condition,
			IOpenClass methodType) throws BoundError
	{
		...
		throw new BoundError(null,"Can not make a Condition Evaluator for parameter " + methodType.getName() + " and [" +  paramStr + "]", null, condition.getSourceCodeModule());
	}
	...
	static public class RuleParamHolder
	{
		...
		/**
		 * 
		 * @return true if paramater requires a dynamic evaluation - in case if paramter presented as formula. 
		 * This is highly unlikely case for Condition parameters - but we need to address this possibility
		 */
...
//		public Object calculateDynamicParameter(IDTCondition condition, Object target, Object[] dtparams, IRuntimeEnv env)
//		{
...
//		}
	 ...
	 * It has to retain the order of the rules. 
	 * 
	 *  An optimized algorithm has 2 distinct steps: 
	 *  1) Create initial discriminate ruleset using indexing in initial conditions.
	 ...
	 *  
	 *  3)Performance. From the algorithm definition it is clear, that 
	 *  step 1 of algoritm is performed with constant or near constant speed with regard
	 *  to the number of the rules. The performance of the part 2 is largely dependend 
	 *  the size of the resulting ruleset. The order of initial indexed conditions does not seem 
	 *  to affect performance much (//TODO this atatement needs verification)   
	 *   
	 *   
