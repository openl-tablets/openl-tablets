...
public class DTAnalyzer {
	...
	public IParameterDeclaration[] referencedSignatureParams(IDecisionRow row) {
		...
		for (Iterator<IOpenField> iter = deps.getFieldsMap().values()
	...
	public IOpenClass transformSignatureType(
			IParameterDeclaration parameterDeclaration, IDTValidatedObject dtvo) 
	{
