...
/**
 * The implementation of the hashCode() and equals()
 * for the derives classes.
 * 
 * @author sam
 */
abstract public class AUserContext implements IUserContext
{
	static Properties props(IUserContext cxt)
	{
		...
		return properties != null
			? properties
			: PropertyFileLoader.NO_PROPERTIES;
	}
	...
	public boolean equals(Object obj)
	{
		...
		.append(getUserHome(), c.getUserHome())
		.append(getUserProperties(), c.getUserProperties())
		.isEquals();
	}
