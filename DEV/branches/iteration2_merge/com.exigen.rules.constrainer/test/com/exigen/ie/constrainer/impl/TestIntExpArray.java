...
public class TestIntExpArray extends TestCase {
  ...
  public TestIntExpArray(String name) {super(name);}
  ...
  public void testMulIntExpArray(){
    IntExpArray array1 = new IntExpArray(C, 10, 1, 10, "array1"),
                array2 = new IntExpArray(C, 10, 1, 10, "array2");
  ...
  public void testMinMax(){
    ...
    int[] min = {1,2,-21, 12, 14, -3, 0, 0 , 4, -21},
          max = {2,3,-20, 15, 17, -2, 0, 17 , 5, -21};
