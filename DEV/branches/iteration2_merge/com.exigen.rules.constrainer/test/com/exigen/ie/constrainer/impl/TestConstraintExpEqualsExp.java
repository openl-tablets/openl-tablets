...
public class TestConstraintExpEqualsExp extends TestCase {
  ...
  public TestConstraintExpEqualsExp(String name) {super(name);}
  public static void main(String[] args) {
    TestRunner.run(new TestSuite(TestConstraintExpEqualsExp.class));
  }
  public void testExecute(){
    IntVar var1 = C.addIntVar(0, 10, "var1", IntVar.DOMAIN_BIT_FAST),
           var2 = C.addIntVar(-1, 11, "var2", IntVar.DOMAIN_BIT_FAST);
    IntExpArray array1 = new IntExpArray(C, 10, 0, 9, "array1"),
                array2 = new IntExpArray(C, 10, 0, 9, "array1");
    try{
