...
public class PrimalErrorCodes {
 /*status codes returned by getPrimStatus() */
   ...
   */
  static public int  LPX_P_UNDEF  =  native_LPX_P_UNDEF();   /* primal status is undefined */
  /**
   * solution is primal feasible
   * @see LPX#getPrimStatus()
   */
  static public int  LPX_P_FEAS   =  native_LPX_P_FEAS();   /* solution is primal feasible */
  /**
   * solution is primal infeasible
   * @see LPX#getPrimStatus()
   */
  static public int  LPX_P_INFEAS =  native_LPX_P_INFEAS();  /* solution is primal infeasible */
  /**
   * no primal feasible solution exist
   * @see LPX#getPrimStatus()
   */
  static public int  LPX_P_NOFEAS =  native_LPX_P_NOFEAS();   /* no primal feasible solution exists */
