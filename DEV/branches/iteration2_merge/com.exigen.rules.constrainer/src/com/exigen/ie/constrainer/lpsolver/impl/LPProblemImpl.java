...
public class LPProblemImpl extends ConstrainerObjectImpl implements ConstrainerLP{
 ...
 // private Vector _isConstraintValid = new Vector();
  ...
  public LPProblemImpl(FloatExp exp, boolean maximization, Constrainer c, String name)
  ...
  public LPProblemImpl(FloatExpArray array, double[] costCoeffs,
                     ...
                     throws NonLinearExpression
  {
    ...
    for (int i=0;i<array.size();i++){
      FloatExp curExp = (FloatExp)array.get(i);
      if (!curExp.isLinear())
  ...
  public LPProblemImpl(FloatExpArray array, double[] costCoeffs, boolean maximization)
                      throws NonLinearExpression
  {
