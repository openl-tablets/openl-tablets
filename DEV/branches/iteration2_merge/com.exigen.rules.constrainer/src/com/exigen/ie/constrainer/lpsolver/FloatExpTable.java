...
public class FloatExpTable extends ConstrainerObjectImpl implements ConstrainerObject{
  ...
  /**
   * @param m Row number
   * @return <code>FloatExpArray</code> corresponds to the m'th row of the table
   */
   ...
   * @return <code>FloatExpArray</code> corresponds to the n'th column of the table
   */
  ...
  /**
   * Assignes some <code>FloatExp</code> to the element of the table with coordinates (m,n)
  ...
  /**
   * Returns the expression for the product of the two dimensional array and array of double
   * @param vec Array of double
   * @return <code>FloatExpArray</code> the i'th element of which equals to the scalar product of the
   * i'th row and input array.
   */
   ...
   * @return <code>FloatExpArray</code> the i'th element of which equals to the (i/nbCols, i%nbCols)
