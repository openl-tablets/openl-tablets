...
public interface IGrid
{
  ...
  // This type is not supported by HSSF, so it can be used only for read-only grids (filters)
...
//  public final static int CELL_SUB_TYPE_DATE = 12;
  ...
  FormattedCell getFormattedCell(int column, int row);
	...
	/**
	 * Calculates cell height: if it is left top corner of merged region - returns region height, else - returns 1. 
	 */
