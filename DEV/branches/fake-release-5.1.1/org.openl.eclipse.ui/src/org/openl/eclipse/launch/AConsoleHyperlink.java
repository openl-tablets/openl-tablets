...
public abstract class AConsoleHyperlink
  extends LaunchBase
  implements IHyperlink, SourceCodeURLConstants
{
	...
	if (window != null) {
		...
		if (page != null) {
			try {
				...
				getLogPlugin().getLog().log(new Status(IStatus.ERROR, OpenlBasePlugin.PLUGIN_ID,IStatus.OK,e.getMessage(), e));
			}	
		}
	}
	return null;
...
//  }
  ...
  //  }
  //
  //  protected ITextEditor getSourceEditor(IJavaSourceLocation location, String typeName)
  //  {
  //    try
  //    {
  //      Object sourceElement = location.findSourceElement(typeName);
  //      return sourceElement != null ? getSourceEditorForSourceElement(sourceElement) : null;
  //    }
  //    catch (Exception e)
  //    {
  //      handleException(e);
  ...
  //   * @exception CoreException if unable to retrieve the text
  //   */
  //  protected ITextEditor getSourceEditor(IJavaSourceLocation[] locations, String typeName)
  //  {
  //    ITextEditor editor;
  //
