...
/* exit codes returned by the simplex-based solver routines: */
  ...
  /**
    * The solver can't start the search because either the problem has no rows or columns
    * or some rows has non zero objective coefficients
    */
  ...
  /**
    * The search was prematurely  terrminated due to iterations limit being exceeded
    */
  ...
  /**
    * The search was prematurely terminated due to numerical instability on solving Newtonial system
    */
