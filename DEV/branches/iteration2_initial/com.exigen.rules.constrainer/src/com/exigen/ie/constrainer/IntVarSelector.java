...
/**
 * An interface for the selection of the integer variable from a given array of variables.
 * Used in GoalGenerate.
 * @see GoalGenerate
...
{
  /**
   * Returns the index of the selected variable in the array of IntVar(s).
