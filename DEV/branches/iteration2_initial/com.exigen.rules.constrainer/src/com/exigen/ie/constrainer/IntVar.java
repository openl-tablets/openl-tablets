...
//
/**
 * An interface for the constrained integer variable.
 * The following code creates an integer variable:
 * <pre>
...
public interface IntVar extends IntExp
{
  ...
  /**
   * The type of the domain implementation: plain.
  ...
  /**
   * The type of the domain implementation: default.
   * The concrete type is choosen depending on the state of the domain.
   */
