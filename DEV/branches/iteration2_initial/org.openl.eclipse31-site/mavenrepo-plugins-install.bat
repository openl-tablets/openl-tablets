...
call mvn install:install-file -DgroupId=org.openl.rules -DartifactId=org.openl.rules.j -Dversion=5.0.5 -Dpackaging=jar -Dfile=plugins/org.openl.rules.j_5.0.5.jar -DgeneratePom=true
call mvn install:install-file -DgroupId=org.openl.rules -DartifactId=org.openl.rules.helpers -Dversion=5.0.5 -Dpackaging=jar -Dfile=plugins/org.openl.rules.helpers_5.0.5.jar -DgeneratePom=true
