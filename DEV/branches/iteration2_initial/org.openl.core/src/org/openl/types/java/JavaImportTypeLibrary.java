...
public class JavaImportTypeLibrary implements ITypeLibrary
{
    ...
    public JavaImportTypeLibrary(String[] importClasses,
	    String[] importPackages, ClassLoader loader)
    {
	this.loader = loader;
	...
	for (int i = 0; i < importPackages.length; i++)
	{
	    try
	    {
		Class<?> c = ClassFactory.forName(importPackages[i] + "."
			+ typename, getClassLoader());
