...
public class JavaOpenClass extends AOpenClass {
    ...
    public Iterator<IOpenClass> superClasses() {
        ...
        return OpenIterator.merge(OpenIterator.single((IOpenClass) JavaOpenClass.getOpenClass(superClass)), interfaces);
    }
     ...
     * DOCUMENT ME!
     * 
     * @param c object or null, does not work on primitives
     * 
