...
public class IndexNodeBinder extends ANodeBinder
{
  ...
  /* (non-Javadoc)
   * @see org.openl.binding.INodeBinder#bindTarget(org.openl.syntax.ISyntaxNode, org.openl.binding.IBindingContext, org.openl.binding.IBoundNode)
   */
    ...
    throws Exception
  {
      ...
      throw new BoundError(node, 
        "Index operator " + node.getType() + "[" + indexExprType.getName() +"] not found" );

  }

  IOpenIndex getMehodBasedIndex(
	IOpenClass indexExprType,
	IOpenClass componentType,
	IBindingContext cxt)
  {

	IMethodCaller reader =
	  MethodSearch.getMethodCaller(INDEX_METHOD_NAME, new IOpenClass[]{indexExprType} ,cxt , componentType);
	...
	IMethodCaller writer =
	   MethodSearch.getMethodCaller(INDEX_METHOD_NAME, new IOpenClass[]{indexExprType, returnType} ,cxt , componentType);
    ...
    IBindingContext bindingContext)
  {
    ...
    IMethodCaller reader =
      BinaryOperatorNodeBinder.findBinaryOperatorMethodCaller(INDEX_METHOD_NAME, types, bindingContext);
