...
public interface IDecisionTableConstants
{
	...
	static final int INFO_COLUMN = 0, CODE_COLUMN = 1, PARAM_COLUMN = 2,
			PRESENTATION_COLUMN = 3, DATA_COLUMN = 4;
	...
	public static final int 
		...
		BOOLEAN_VALUE = 1,
		PARAMETER_VALUE = 2,
		DEFAULT_VALUE = 3, //true if all conditions to the left, except for special cases are false
