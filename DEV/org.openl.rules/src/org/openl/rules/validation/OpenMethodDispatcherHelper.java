...
class OpenMethodDispatcherHelper {
     ...
     * {@link OpenMethodDispatcher}, extract all methods from a class and return
     * new list of methods without {@link OpenMethodDispatcher}.
     * 
     * @param openClass the class
     * @return list of {@link IOpenMethod}, unwrapped from
     *         {@link OpenMethodDispatcher}.
     */
