...
public class LazyMethodWrapper implements IOpenMethod, IOpenMethodWrapper {
    ...
    public LazyMethodWrapper(XlsModuleOpenClass xlsModuleOpenClass, IOpenMethod method) {
