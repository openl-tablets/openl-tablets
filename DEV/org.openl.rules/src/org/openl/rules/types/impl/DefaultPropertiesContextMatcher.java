...
public class DefaultPropertiesContextMatcher implements IPropertiesContextMatcher {
    ...
    protected void initilaize() {
        ...
        constraints.put("caRegions",
            new MatchingConstraint<org.openl.rules.enumeration.CaRegionsEnum[], org.openl.rules.enumeration.CaRegionsEnum>() {
                ...
                @Override
                protected boolean matchNotNulls(org.openl.rules.enumeration.CaRegionsEnum[] propertyValue,
                        org.openl.rules.enumeration.CaRegionsEnum contextValue) {
                    return CONTAINS(propertyValue, contextValue);
                }

            });
        constraints.put("caProvinces",
            new MatchingConstraint<org.openl.rules.enumeration.CaProvincesEnum[], org.openl.rules.enumeration.CaProvincesEnum>() {
                ...
                @Override
                protected boolean matchNotNulls(org.openl.rules.enumeration.CaProvincesEnum[] propertyValue,
                        org.openl.rules.enumeration.CaProvincesEnum contextValue) {
                    return CONTAINS(propertyValue, contextValue);
                }

            });
        constraints.put("country",
            new MatchingConstraint<org.openl.rules.enumeration.CountriesEnum[], org.openl.rules.enumeration.CountriesEnum>() {
                ...
                @Override
                protected boolean matchNotNulls(org.openl.rules.enumeration.CountriesEnum[] propertyValue,
                        org.openl.rules.enumeration.CountriesEnum contextValue) {
                    return CONTAINS(propertyValue, contextValue);
                }

            });
        constraints.put("region",
            new MatchingConstraint<org.openl.rules.enumeration.RegionsEnum[], org.openl.rules.enumeration.RegionsEnum>() {
                ...
                @Override
                protected boolean matchNotNulls(org.openl.rules.enumeration.RegionsEnum[] propertyValue,
                        org.openl.rules.enumeration.RegionsEnum contextValue) {
                    return CONTAINS(propertyValue, contextValue);
                }

            });
        constraints.put("currency",
            new MatchingConstraint<org.openl.rules.enumeration.CurrenciesEnum[], org.openl.rules.enumeration.CurrenciesEnum>() {
                ...
                @Override
                protected boolean matchNotNulls(org.openl.rules.enumeration.CurrenciesEnum[] propertyValue,
                        org.openl.rules.enumeration.CurrenciesEnum contextValue) {
                    return CONTAINS(propertyValue, contextValue);
                }

            });
        constraints.put("lang",
            new MatchingConstraint<org.openl.rules.enumeration.LanguagesEnum[], org.openl.rules.enumeration.LanguagesEnum>() {
                ...
                @Override
                protected boolean matchNotNulls(org.openl.rules.enumeration.LanguagesEnum[] propertyValue,
                        org.openl.rules.enumeration.LanguagesEnum contextValue) {
                    return CONTAINS(propertyValue, contextValue);
                }
        ...
        constraints.put("usregion",
            new MatchingConstraint<org.openl.rules.enumeration.UsRegionsEnum[], org.openl.rules.enumeration.UsRegionsEnum>() {
                ...
                @Override
                protected boolean matchNotNulls(org.openl.rules.enumeration.UsRegionsEnum[] propertyValue,
                        org.openl.rules.enumeration.UsRegionsEnum contextValue) {
                    return CONTAINS(propertyValue, contextValue);
                }

            });
        constraints.put("state",
            new MatchingConstraint<org.openl.rules.enumeration.UsStatesEnum[], org.openl.rules.enumeration.UsStatesEnum>() {
                ...
                @Override
                protected boolean matchNotNulls(org.openl.rules.enumeration.UsStatesEnum[] propertyValue,
                        org.openl.rules.enumeration.UsStatesEnum contextValue) {
                    return CONTAINS(propertyValue, contextValue);
                }
