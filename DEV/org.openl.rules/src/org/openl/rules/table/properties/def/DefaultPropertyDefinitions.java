...
public final class DefaultPropertyDefinitions {
    ...
    static {
        ...
        definitions[29].setDefaultValue("org.openl.generated.spreadsheetresults");
        definitions[29].setDescription("The name of the package for spreadsheet result beans generation");
        definitions[29].setDimensional(false);
        definitions[29].setDisplayName("Spreadsheet Result Package");
        ...
        definitions[29].setName("spreadsheetResultPackage");
        definitions[29].setPrimaryKey(false);
        definitions[29].setSystem(false);
        definitions[29].setTableType(new XlsNodeTypes[] {XlsNodeTypes.XLS_SPREADSHEET, XlsNodeTypes.XLS_PROPERTIES});
