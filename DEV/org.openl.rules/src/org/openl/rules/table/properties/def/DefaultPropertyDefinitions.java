...
public final class DefaultPropertyDefinitions {
    ...
    static {
        ...
        definitions[29].setConstraints(new org.openl.rules.table.constraints.Constraints("Worksheet, Workbook, Module"));
        ...
        definitions[31].setConstraints(new org.openl.rules.table.constraints.Constraints("regexp:([a-zA-Z_]{1}[a-zA-Z0-9_]*(\\.[a-zA-Z_]{1}[a-zA-Z0-9_]*)*)"));
        ...
        definitions[32].setDescription("Defines whether or not to use cache while recalculating the table for a variatio"
        ...
        definitions[34].setConstraints(new org.openl.rules.table.constraints.Constraints("regexp:(-?[0-9]+)"));
        ...
        definitions[37].setDescription("If true calculates all cells in the Spreadsheet, otherwise calculates only cells"
        ...
        definitions[39].setConstraints(new org.openl.rules.table.constraints.Constraints("list: Defined by method getNature()"));
        ...
        definitions[39].setExpression(new org.openl.rules.table.properties.expressions.match.MatchingExpression("eq(nature)"));
