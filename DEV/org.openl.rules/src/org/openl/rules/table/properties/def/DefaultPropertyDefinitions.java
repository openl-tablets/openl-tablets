...
public final class DefaultPropertyDefinitions {
    ...
    static {
        ...
        definitions[30].setConstraints(new org.openl.rules.table.constraints.Constraints("regexp:([a-zA-Z_]{1}[a-zA-Z0-9_]*(\\.[a-zA-Z_]{1}[a-zA-Z0-9_]*)*)"));
        ...
        definitions[30].setInheritanceLevel(new InheritanceLevel[] { InheritanceLevel.MODULE });
        definitions[30].setName("spreadsheetResultPackage");
        definitions[30].setPrimaryKey(false);
        definitions[30].setSystem(false);
        definitions[30].setTableType(new XlsNodeTypes[] {XlsNodeTypes.XLS_PROPERTIES});
        ...
        definitions[31].setDescription("Defines whether or not to use cache while recalculating the table for a variatio"
        ...
        definitions[32].setDescription("The way of recalculation of the table for a variation - slightly varied input pa"
         + "rameter(s)");
        ...
        definitions[32].setType(org.openl.types.java.JavaOpenClass.getOpenClass(org.openl.rules.enumeration.RecalculateEnum.class));
        ...
        definitions[36].setDescription("If true calculates all cells in the Spreadsheet, otherwise calculates only cells"
        ...
        definitions[38].setConstraints(new org.openl.rules.table.constraints.Constraints("list: Defined by method getNature()"));
        ...
        definitions[38].setExpression(new org.openl.rules.table.properties.expressions.match.MatchingExpression("eq(nature)"));
