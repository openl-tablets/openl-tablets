...
import org.openl.rules.util.Modular;
...
public class LibrariesRegistry {
    ...
    static {
        ...
        DEFAULT.addJavalib(Var.class);
        DEFAULT.addJavalib(Covar.class);
        DEFAULT.addJavalib(Correl.class);
        DEFAULT.addJavalib(Forecast.class);
        DEFAULT.addJavalib(Intercept.class);
        DEFAULT.addJavalib(Slope.class);
        DEFAULT.addJavalib(StdDev.class);
