...
public class BExGrammarWithParsingHelp extends BExGrammar {
    ...
    public void parseTopNode(String type) {
        try {
            ...
            syntaxBuilder.addError(new SyntaxNodeException("", e, pos(token), syntaxBuilder.getModule()));
        }
    }
    ...
    private SyntaxNodeException reparseTokens() {
        ...
        while (true) {
            ...
            try {
                ...
                return new SyntaxNodeException(err.getMessage(), null, loc, syntaxBuilder.getModule());
            }
            if (t.kind == EOF) {
                break;
            }
