...
public class WrongAliasDatatypeTest {
	...
	public void test2() {
		File xlsFile = new File(
				"test/rules/datatype/WrongAliasDatatype2Test.xlsx");
		TestHelper<ITest> testHelper = new TestHelper<ITest>(xlsFile,
				ITest.class);
	...
	public void test8() {
		File xlsFile = new File(
				"test/rules/datatype/WrongAliasDatatypeUsage4Test.xlsx");
		TestHelper<ITest> testHelper = new TestHelper<ITest>(xlsFile,
				ITest.class);
	...
	public void test9() {
		File xlsFile = new File(
				"test/rules/datatype/WrongAliasDatatypeUsage5Test.xlsx");
		TestHelper<ITest> testHelper = new TestHelper<ITest>(xlsFile,
				ITest.class);
	...
	public void test10() {
		File xlsFile = new File(
				"test/rules/datatype/WrongAliasDatatypeUsage6Test.xlsx");
		TestHelper<ITest> testHelper = new TestHelper<ITest>(xlsFile,
				ITest.class);
