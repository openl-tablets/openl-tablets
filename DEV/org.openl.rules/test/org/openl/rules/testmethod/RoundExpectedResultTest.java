                ...
                if (successfulTests.contains(name)) {
                    ...
                    for (int i = 0; i < testUnits.size(); i++) {
                        if (successfulRows.contains(i)) {
                            assertEquals(TestUnitResultComparator.TestStatus.TR_OK.getStatus(), testUnits.get(i).compareResult());
                        } else {
                            assertEquals(TestUnitResultComparator.TestStatus.TR_NEQ.getStatus(), testUnits.get(i).compareResult());
                        }
                    }
                }
            }
