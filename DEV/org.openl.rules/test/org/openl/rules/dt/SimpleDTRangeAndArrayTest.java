...
class SimpleDTRangeAndArrayTest {
    ...
    @Test
    void simpleLookup3paramRangeArray() {
    ...
    @Test
    void simpleLookup4paramTitleRange() {
        assertEquals(Double.valueOf(0.9),
                TestUtils.invoke(instance,
    ...
    @Test
    void simpleLookup4paramNotEnoughValues() {
        assertEquals(Double.valueOf(0.9),
                TestUtils.invoke(instance,
