...
public class SimpleDTCompoundResultTest extends BaseOpenlBuilderHelper {
    private static final String SRC = "./test/rules/dt/SimpleDTCompoundResultTest.xls";

    public SimpleDTCompoundResultTest() {
        super(SRC);
    }
