...
public class SmartDTTest extends BaseOpenlBuilderHelper {
    private static final String SRC = "./test/rules/dt/SmartDTTest.xls";
    ...
    public void test2() {
        IOpenMethod method = getCompiledOpenClass().getOpenClass().getMethod("test2",
            new IOpenClass[] { JavaOpenClass.STRING, JavaOpenClass.INT });
        Object instance = newInstance();
        SimpleRuntimeEnv env = new SimpleRulesVM().getRuntimeEnv();
        assertEquals(new DoubleValue(0.02), method.invoke(instance, new Object[] { "v2", 2 }, env));
        assertEquals(new DoubleValue(0.05), method.invoke(instance, new Object[] { "v5", 5 }, env));
    }
