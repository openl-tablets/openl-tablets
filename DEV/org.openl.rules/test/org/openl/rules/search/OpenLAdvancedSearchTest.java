    ...
    public void testColumnSearch() {
        ...
        if ((searchResult != null) && (searchResult instanceof OpenLAdvancedSearchResult)) {
            ...
            for (int i = 0; i < 2; i++) {
                ...
                if (i == 0) {
                    assertEquals("Theft Rating Table", result.getFoundTableAndRows()[i].getTsn()
                        .getTableProperties()
                        .getName());
                } else {
                    assertEquals("Injury Rating Table", result.getFoundTableAndRows()[i].getTsn()
                        .getTableProperties()
                        .getName());
                }
            }
    ...
    public void testColumnSearch1() {
        ...
        if ((searchResult != null) && (searchResult instanceof OpenLAdvancedSearchResult)) {
            ...
            for (int i = 0; i < 2; i++) {
                assertTrue(result.getFoundTableAndRows()[i].getRows().length > 0);
                if (i == 0) {
                    assertEquals("Injury Rating Table", (String) result.getFoundTableAndRows()[i].getTsn()
                        .getTableProperties()
                        .getName());
                } else {
                    assertEquals("Vehicle Discounts", (String) result.getFoundTableAndRows()[i].getTsn()
                        .getTableProperties()
                        .getName());
                }
            }
