...
public abstract class BenchmarkUnit
{
  ...
  /**
   *  return not null if this is a part of the chain; it means that multiple executions(iterations) can be
   *  done only on the whole chain from the very beginning
   */
  ...
  /**
   * This is rhe method you usually want to redefine. There can be cases 
