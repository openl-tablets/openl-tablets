 ...
 * @author snshor
 *
 * This class contains a bunch of utilities related to arrays, Iterarators and Collections. 
 * Hence, the name 
 */
...
{
	/**
	 * Collect objects from array src[] to array dst[] using Collector ic. Does not check boundaries.
	 * 
	 * @param dst
	 * @param src
	 * @param ic
	...
	static public Object[] collect(Object[] dst, Object[] src, IConvertor ic)
	{
