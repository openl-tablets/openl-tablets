...
public class MathUtilsTest {
    ...
    public void testSumByte() {
        byte[] array = new byte[] { (byte) 3, (byte) 4, (byte) 8 };
        assertEquals(Byte.valueOf((byte) 15), MathUtils.sum(array));
    }

    @Test
    public void testSumShort() {
        short[] array = new short[] { (short) 3, (short) 4, (short) 8 };
        assertEquals(Short.valueOf((short) 15), MathUtils.sum(array));
    }

    @Test
    public void testSumInteger() {
        int[] array = new int[] { 3, 4, 8 };
        assertEquals(Integer.valueOf(15), MathUtils.sum(array));
    }
    
    @Test
    public void testSumLong() {
        long[] array = new long[] { 3l, 4l, 8l };
        assertEquals(Long.valueOf(15), MathUtils.sum(array));
    }

    @Test
    public void testSumFloat() {
        float[] array = new float[] { 3f, 4f, 8f };
        assertEquals(Float.valueOf(15), MathUtils.sum(array));
    }

    @Test
    public void testSumDouble() {
        double[] array = new double[] { 3d, 4d, 8d };
        assertEquals(Double.valueOf(15), MathUtils.sum(array));
    }
    ...
    public void testSumBigInteger() {
        ...
        assertEquals(BigInteger.valueOf(15), MathUtils.sum(array));

        array = new BigInteger[] { null,
                BigInteger.valueOf(3),
                null,
                BigInteger.valueOf(4),
                null,
        ...
        assertEquals(null, MathUtils.sum(array));
    ...
    public void testSumBigDecimal() {
        ...
        assertEquals(BigDecimal.valueOf(15), MathUtils.sum(array));
    ...
    public void testSumT() {
        Long[] array = new Long[] { null, null, null };
        assertEquals(null, MathUtils.sum(array));

        array = new Long[] { null, 2l, null };
        assertEquals(Long.valueOf(2l), MathUtils.sum(array));
