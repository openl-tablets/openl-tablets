...
public class OpenlTool
{
	...
	static public IOpenMethodHeader getMethodHeader(
	...
	static public IOpenClass makeType(
		IOpenSourceCodeModule src,
		OpenL openl,
		IBindingContextDelegator cxt)
	{
		try
		{
			...
			if (cxt == null)
				cxt =
					new BindingContextDelegator(
						openl.getBinder().makeBindingContext());
			cxt.pushErrors();
			IOpenParser parser = openl.getParser();
	...
	static IBoundMethodNode bindMethodType(
		IBoundMethodNode bnode,
