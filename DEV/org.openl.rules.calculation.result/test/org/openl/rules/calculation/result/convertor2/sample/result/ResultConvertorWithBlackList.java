...
import org.openl.rules.calculation.result.convertor2.BlackListRowFilter;
 ...
 *
 */
public class ResultConvertorWithBlackList {
    ...
    public ResultConvertorWithBlackList() {
        init();
    }
    ...
    private void init() {
        ...
        NestedSpreadsheetConfiguration<SimpleStep, CompoundStep> configuration = new NestedSpreadsheetConfiguration<SimpleStep, CompoundStep>(
            ...
            protected RowFilter initRowFilter() {
                return BlackListRowFilter.buildBlackListRowFilter(blackList);
            }
        };
