...
public class ColumnToExtract {
     ...
     * @param containNested indicates if there is any row for this column with
     *            nested result. For information which values considered to be
     *            nested see {@link NestedDataRowExtractorsFactory}
     */
