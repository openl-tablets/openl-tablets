...
public class DefaultFormat implements IFormat
{
	 ...
	 * @return
	 */
	protected StringBuffer formatCollection(Collection collection, int mode,
			StringBuffer buf)
	{
...
public StringBuffer formatIterator(Iterator it, int mode, StringBuffer buf, int maxLength, int actualLength, String brackets)
	{
