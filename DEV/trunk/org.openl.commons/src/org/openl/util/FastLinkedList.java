 ...
 * all the comments and notations of the original source with explicit change notes. To find out what exactly have been changed from the original implementation look for 
 * CHANGE!!! comment in the source  
 * 
 * @author snshor
 *   
 */
...
public class FastLinkedList<E> extends AbstractSequentialList<E> implements List<E>, Deque<E>, Cloneable,
    ...
    /**
     * Returns the first element in this list. CHANGE!!! this is a new method to
     * externalize entries
     * 
     * @return the first element in this list
     * @throws NoSuchElementException if this list is empty
    ...
    private class ListItr implements ListIterator<E> {
        ...
        public void remove() {
            ...
            try {
                FastLinkedList.this.remove(lastReturned);
    ...
    /**
     * New method for fast public access CHANGE!!!
     * 
     * @param e
     */

    public boolean moveToLast(Entry<E> e) {
        if (header.previous == e)
            return false;
        removeEntry(e);
        addLastEntry(e);
        return true;
    ...
    public void addLastEntry(Entry<E> e) {
    ...
    @SuppressWarnings("unchecked")
    public Object clone() {
        FastLinkedList<E> clone = null;
        try {
            clone = (FastLinkedList<E>) super.clone();
