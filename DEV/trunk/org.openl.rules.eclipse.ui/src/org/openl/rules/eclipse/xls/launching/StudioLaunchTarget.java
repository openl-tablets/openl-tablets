...
public class StudioLaunchTarget extends ALaunchTarget {
	...
	static public final String VM_ARGS = "-Xms256M -Xmx1024M -D"
			+ IRulesLaunchConstants.START_PROJECT_PROPERTY_NAME + "=";
	...
	public boolean isLaunchedBy(ILaunchConfiguration c) {
		try {
			...
			String attrMain = c.getAttribute(
					IJavaLaunchConfigurationConstants.ATTR_MAIN_TYPE_NAME, "");
			String attrProject = c.getAttribute(
					IJavaLaunchConfigurationConstants.ATTR_PROJECT_NAME, "");
			String vmArgs = c.getAttribute(
			...
			return STUDIO_PROJECT_NAME.equals(attrProject)
					&& MAIN_CLASS_NAME.equals(attrMain)
	...
	public void initDefaultLaunchConfiguration(
			ILaunchConfigurationWorkingCopy wc, ILaunchRequest request)
			throws Exception {
