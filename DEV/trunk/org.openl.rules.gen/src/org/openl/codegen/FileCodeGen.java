 ...
 * input file inFileLocation. Insertion places are defined
 * by INSERT_TAG. The insertion logic is handled by ICodeGenAdaptor, there could be
 * multiple INSERT_TAGS in the code, calling class can redefine INSERT_TAG value  
 * 
 * @author snshor
 * Created Jul 27, 2009 
 *
...
public class FileCodeGen {
   public static final String DEFAULT_INSERT_TAG = "<<< INSERT";
    private String inFileLocation, outFileLocation;
