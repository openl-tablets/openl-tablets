...
public class JavaCodeGen implements ICodeGen {
    ...
    static final public String PRIVATE = "private", PUBLIC = "public", STATIC = "static", CLASS = "class";

    static final public String END_OF_EXPR = ";\n", START_MULTILINE_COMMENT = "/*\n", MULTILINE_COMMENT = " * ",
            END_MULTILINE_COMMENT = " */\n", START_SINGLELINE_COMMENT = " // ", ASSIGN_OP = "=", CHAIN_OP = ".",
            START_METHOD_BRACE = "(", END_METHOD_BRACE = ")", CLASS_SUFFIX = ".class",

            NEW_OP = "new", NULL_CONST = "null";

    public static final int MODULE_LEVEL = 0, CLASS_DECLARATION_LEVEL = 0, METHOD_DECLARATION_LEVEL = 1,
            METHOD_BODY_LEVEL = 2;
    ...
    static public int MAX_STR_LEN = 80;
    ...
    public StringBuilder genLiteralJavaOpenClass(JavaOpenClass jc, StringBuilder sb) {
        return sb.append(JavaOpenClass.class.getName()).append(".getOpenClass(")
                .append(jc.getInstanceClass().getName()).append(CLASS_SUFFIX).append(")");
    }
