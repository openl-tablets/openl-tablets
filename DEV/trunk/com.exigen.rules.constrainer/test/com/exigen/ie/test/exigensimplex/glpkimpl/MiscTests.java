...
public class MiscTests {
  ...
  public static void main(String[] args) {
    ...
    assertion(lp.getColumnBounds(2).getType() == VariableType.DOUBLE_BOUNDED, "Boolean column has correct bounds type");
    ...
    int[]    types  ={VariableType.BOUNDED_ABOVE,
                      VariableType.BOUNDED_BELOW,
                      VariableType.DOUBLE_BOUNDED,
                      VariableType.FIXED_VARIABLE,
                      VariableType.FREE_VARIABLE};
