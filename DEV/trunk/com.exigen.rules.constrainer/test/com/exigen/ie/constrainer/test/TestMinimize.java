...
public class TestMinimize {
     ...
     * c.traceFailureStack(); // c.traceExecution(); // IntValueSelector
     * value_selector = new IntValueSelectorMin(); // IntVarSelector
     * var_selector = new IntVarSelectorMinSize(vars); // Goal searchGoal = new
     * GoalGenerate(vars,var_selector,value_selector);
     * 
     ...
     * 
     * Goal fail = new GoalFail(c); // c.printInformation();
     * 
     * 
