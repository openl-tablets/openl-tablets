...
public class TestIntExpArrayElement extends TestCase {
  ...
  public TestIntExpArrayElement(String name){super(name);}
  ...
  public void testMinAndMax(int stop){
    try{
      ...
      for (int i=0;i<array.size()/2;i++){
        ...
        cursor.setMin(i);
        cursor.setMax(array.size()-i-1); //subarray [i..size()-i-1] of array
        C.propagate();
  ...
  public void testWork(){
    ...
    /* Our aim is to find "indices" array such that:
     * x = {vars[indices[0]], vars[indices[1]], vars[indices[2]]};
     * Where x is to satisfy the linear system:
     * each variable has only one value being a component of a solution vector x in it's domain,
     * e.g. if the solution vector is {-2, 1} the variables would be: var[0] [-4, 0] and var[1] [0, 3]
     * The solution is: indices = order;
    */
    try{
      //<init block>
      ...
      vars.set(C.addIntVar(x[x.length-1]-delta, x[x.length-1]+delta, IntVar.DOMAIN_BIT_FAST), order[b.length-1]);
  ...
  public void testElementDomain(int stop){
    ...
    try{index.removeValue(3);}catch(Failure f){}
...
class TestData{
  ...
  static {
    ...
    Data dat2 = new Data();
    dat2.A = new int[][]{
      {17, -58, -17, -57, 37, -10, 22, -84, -76, -54},
      {-15, -24, -39, 29, -58, -92, -97, -9, -10, -52},
      {3, 57, 75, -36, 68, -95, -97, -12, 43, -90},
      {-33, 36, -97, 92, 26, -38, -62, -29, 79, -85},
      {-13, -8, 54, 46, -74, -98, 17, -70, -46, 28},
      {-55, 14, 95, -18, -59, -23, -89, 35, -49, -62},
      {16, 59, 99, 49, 22, 37, -27, 40, 73, 69},
      {52, -89, 58, -47, 26, -82, 26, 46, -54, -66},
      {6, 21, -12, -12, -26, -93, 44, -4, 61, -66},
    ...
    Data dat3 = new Data();
    dat3.A = new int[][]{
        {-87, -55, 57, -90, 99, 92, 37},
        {98, 16, 36, -17, 58, 46, -58},
        {17, 52, -8, -39, -12, -18, 68},
        {-15, 6, 14, 75, 0, 49, 26},
        {3, 28, 59, -97, -57, -47, -74},
        {-33, -58, -89, 54, 29, -12, -59},
        {-13, -24, 21, 95, -36, 87, 22}
    };
