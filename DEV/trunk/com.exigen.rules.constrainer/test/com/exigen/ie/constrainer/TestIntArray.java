...
public class TestIntArray extends TestCase {
  ...
  public TestIntArray(String name) {super(name);}
  ...
  public void testConstructors(){
    ...
    assertTrue(Arrays.equals(array1.data(),array4.data()) &&
               Arrays.equals(array1.data(),array3.data()) );
  }
  ...
  public void testWork(){
    ...
    int[] b = {50, 0, -120};
    /* Our aim is to find "indices" array subjected to:
     * vars = {0, 10, -10};
     * x = {vars[indices[0]], vars[indices[1]], vars[indices[2]]};
     * Where x is to satisfy the linear system:
     * A*x = b( the only solution of which is x = {-10, 0, 10})
     * The solution is: indices = {2, 0, 1};
     */
    try{
