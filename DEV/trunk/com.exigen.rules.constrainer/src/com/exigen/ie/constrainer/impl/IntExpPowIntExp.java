 ...
 * (min_power); } } else { if (((int) Math.pow (_base.max (), _power.min ())) <
 * min) { int min_power; min_power = (int) (Math.log (min) / Math.log (_base.max
 * ())); if ((int) Math.pow (_base.max (), min_power) < min) { min_power ++; }
