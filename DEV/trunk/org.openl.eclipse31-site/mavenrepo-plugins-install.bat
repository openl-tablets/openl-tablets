...
call mvn install:install-file -DgroupId=org.openl.rules -DartifactId=org.openl.j -Dversion=5.0.5 -Dpackaging=jar -Dfile=plugins/org.openl.j_5.0.5.jar -DgeneratePom=true
