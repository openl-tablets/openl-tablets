...
public class BTreeSet extends AbstractSet {
    ...
    public class BTreeNode {
        ...
        private boolean isFull() {
            return nrElements == (BTreeSet.this.order - 1);
        }
        ...
        private void prepareForDeletion(int parentIndex) {
            ...
            // If not root and can't steal left or right and can't merge left
            // you must be able to merge right
            else
        ...
        private void mergeLeft(int parentIndex) {
            ...
            if (isLeaf()) { // Don't worry about children
                ...
                if (p.nrElements == MIN && p != BTreeSet.this.root) { // Push
                    // everything
                    // to
                    // the
                    // right
