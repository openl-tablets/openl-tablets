...
public class EscherProperties {
    ...
    private static void initProps() {
        if (properties == null) {
            ...
            addProp(PROTECTION__LOCKAGAINSTGROUPING, data("protection.lockagainstgrouping",
            ...
            addProp(GROUPSHAPE__WRAPPOLYGONVERTICES, data("groupshape.wrappolygonvertices",
