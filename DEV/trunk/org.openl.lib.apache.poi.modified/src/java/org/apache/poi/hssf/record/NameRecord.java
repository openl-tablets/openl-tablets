...
public class NameRecord extends Record {
    ...
    public NameRecord(byte builtin, short index) {
        ...
        this.setEqualsToIndexToSheet(index); // the extern sheets are set
        // through references
    ...
    protected void fillFields(byte[] data, short size, int offset) {
         ...
         * field_12_name_text = "Print_Titles"; // DEBUG // System.out.println(
         * field_12_name_text );
         * 
         ...
         * field_13_raw_name_definition.length ); // DEBUG //
