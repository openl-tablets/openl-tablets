...
abstract public class EscherRecord {
    ...
    static class EscherRecordHeader {
        ...
        public String toString() {
            return "EscherRecordHeader{" + "options=" + options + ", recordId=" + recordId + ", remainingBytes="
                    + remainingBytes + "}";
        }
     ...
     *            is useful because the serialization is hierarchical/recursive
     *            and sometimes you need to be able break into that.
     * @return the number of bytes written.
     */
