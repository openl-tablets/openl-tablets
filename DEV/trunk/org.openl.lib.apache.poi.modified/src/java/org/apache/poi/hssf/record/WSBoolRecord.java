...
public class WSBoolRecord extends Record {
    ...
    static final private BitField autobreaks = new BitField(0x01); // are
                                                                    // automatic
                                                                    // page
                                                                    // breaks
                                                                    // visible
                                    // bits 1 to 3 unused
    static final private BitField dialog = new BitField(0x10); // is sheet

    // dialog sheet
    static final private BitField applystyles = new BitField(0x20); // whether

    // to apply
                                                                    // automatic
                                                                    // styles to
                                                                    // outlines
    static final private BitField rowsumsbelow = new BitField(0x40); // whether
                                                                // summary
                                                                        // rows
                                                                        // will
                                                                        // appear
                                                                        ...
                                                                        // in
                                                                        // outlines
    static final private BitField rowsumsright = new BitField(0x80); // whether
                                                                    // summary
                                                                        // rows
                                                                        // will
                                                                        // appear
                                                                        ...
                                                                        // in
                                                                        // outlines
    static final private BitField fittopage = new BitField(0x01); // whether
                                                                    // to fit
                                                                    // stuff to
                                                                    // the page
                                                                        // bit 2 reserved
    static final private BitField displayguts = new BitField(0x06); // whether
                                                                    // to
                                                                    // display
                                                                    // outline
                                                                    // symbols
                                                                    ...
                                                                    // gutters)
                                                                        // bits 4-5 reserved
    static final private BitField alternateexpression = // whether to use
                                                        // alternate expression
                                                        // eval
    new BitField(0x40);

    static final private BitField alternateformula = // whether to use
                                                        // alternate formula
                                                        // entry
    new BitField(0x80);

    private byte field_1_wsbool; // crappy names are because this is really
    // one big short field (2byte)
    private byte field_2_wsbool; // but the docs inconsistantly use it as 2
                                    // seperate bytes
    ...
    protected void fillFields(byte[] data, short size, int offset) {
        field_1_wsbool = data[1 + offset]; // backwards because theoretically
                                            // this is one short field
        field_2_wsbool = data[0 + offset]; // but it was easier to implement it
    ...
    public void setAlternateExpression(boolean altexp) {
        field_2_wsbool = alternateexpression.setByteBoolean(field_2_wsbool, altexp);
    }
    ...
    public void setAlternateFormula(boolean formula) {
        field_2_wsbool = alternateformula.setByteBoolean(field_2_wsbool, formula);
    }
