...
public class TabIdRecord extends Record {
    ...
    protected void fillFields(byte[] data, short size, int offset) {
        ...
        for (int k = 0; k < field_1_tabids.length; k++) {
            field_1_tabids[k] = LittleEndian.getShort(data, (k * 2) + offset);
        }
    }
    ...
    public String toString() {
        ...
        for (int k = 0; k < field_1_tabids.length; k++) {
            buffer.append("    .element_" + k + "       = ").append(field_1_tabids[k]).append("\n");
        }
        buffer.append("[/TABID]\n");
    ...
    public int serialize(int offset, byte[] data) {
        ...
        LittleEndian.putShort(data, 2 + offset, ((short) length)); // nubmer
        // tabids *
