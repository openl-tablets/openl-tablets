...
/**
 * This class provides methods to read a DocumentEntry managed by a Filesystem
 * instance.
 *
...
public class DocumentInputStream extends InputStream {
     ...
     *
     * @exception IOException if the DocumentEntry cannot be opened (like, maybe
     *                it has been deleted?)
     */
    ...
    public DocumentInputStream(final POIFSDocument document) throws IOException {
        _current_offset = 0;
        _marked_offset = 0;
        _document_size = document.getSize();
        _closed = false;
     ...
     *         without blocking.
     *
     * @exception IOException on error (such as the stream has been closed)
     */
     ...
     * to be read before the mark position gets invalidated. This
     * implementation, however, does not care.
     * <p>
     ...
     *
     * @param ignoredReadlimit the maximum limit of bytes that can be read
     *            before the mark position becomes invalid. Ignored by this
     *            implementation.
     */
     ...
     * the end of the stream has been reached, the value -1 is returned. The
     * definition of this method in java.io.InputStream allows this method to
     * block, but it won't.
     *
    ...
    public int read() throws IOException {
        ...
        return (_tiny_buffer[0]) & 0x000000FF;
    }

    /**
     * Reads some number of bytes from the input stream and stores them into the
     * buffer array b. The number of bytes actually read is returned as an
     * integer. The definition of this method in java.io.InputStream allows this
     * method to block, but it won't.
     * <p>
     ...
     * <p>
     * The definition of this method in java.io.InputStream allows it to block,
     * but it won't.
     * <p>
     ...
     * state that depends on the particular type of the input and how it was
     * created. The bytes that will be supplied to subsequent callers of the
     * read method depend on the particular type of the input stream. </li>
     * </ul>
     * </li>
     * </ul>
     * <p>
     * All well and good ... this class's markSupported method returns true and
     * this method does not care whether you've called mark at all, or whether
     * you've exceeded the number of bytes specified in the last call to mark.
     * We're basically walking a byte array ... mark and reset to your heart's
     * content.
     */
