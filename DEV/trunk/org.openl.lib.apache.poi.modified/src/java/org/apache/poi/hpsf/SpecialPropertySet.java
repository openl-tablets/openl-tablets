 ...
 * general {@link PropertySet}. Creating a special subclass should be as easy
 * as calling the special subclass' constructor and pass the general
...
public abstract class SpecialPropertySet extends PropertySet {
     ...
     * 
     * FIXME: Return an <code>int</code> instead of a <code>long</code> in
     * the next major version, i.e. when incompatible changes are allowed.
     */
