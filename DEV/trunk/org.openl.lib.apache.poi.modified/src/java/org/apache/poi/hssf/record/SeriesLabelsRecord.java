 ...
 * format record. NOTE: This source is automatically generated please do not
...
public class SeriesLabelsRecord extends Record {
     ...
     *
     * @param id id must be 0x100c or an exception will be throw upon validation
    ...
    /**
     * Sets the label as percentage field value. show category label/value as
     * percentage (pie charts only)
     */
    ...
    /**
     * Sets the show percent field value. show value as percentage of total (pie
     * charts only)
     */
