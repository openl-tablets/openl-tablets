...
/**
 * The data format record is used to index into a series. NOTE: This source is
...
public class DataFormatRecord extends Record {
     ...
     *
     * @param id id must be 0x1006 or an exception will be throw upon validation
    ...
    public String toString() {
        ...
        buffer.append("    .pointNumber          = ").append("0x").append(HexDump.toHex(getPointNumber())).append(" (")
                .append(getPointNumber()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .seriesIndex          = ").append("0x").append(HexDump.toHex(getSeriesIndex())).append(" (")
                .append(getSeriesIndex()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .seriesNumber         = ").append("0x").append(HexDump.toHex(getSeriesNumber()))
