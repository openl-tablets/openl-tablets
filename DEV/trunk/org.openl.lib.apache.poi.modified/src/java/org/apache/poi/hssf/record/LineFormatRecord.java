...
/**
 * Describes a line format record. The line format record controls how a line on
 * a chart appears. NOTE: This source is automatically generated please do not
...
public class LineFormatRecord extends Record {
     ...
     *
     * @param id id must be 0x1007 or an exception will be throw upon validation
     ...
     *
     * @return One of LINE_PATTERN_SOLID LINE_PATTERN_DASH LINE_PATTERN_DOT
     *         LINE_PATTERN_DASH_DOT LINE_PATTERN_DASH_DOT_DOT LINE_PATTERN_NONE
     *         LINE_PATTERN_DARK_GRAY_PATTERN LINE_PATTERN_MEDIUM_GRAY_PATTERN
     ...
     *
     * @return One of WEIGHT_HAIRLINE WEIGHT_NARROW WEIGHT_MEDIUM WEIGHT_WIDE
     */
     ...
     *
     * @param field_2_linePattern One of LINE_PATTERN_SOLID LINE_PATTERN_DASH
    ...
    /**
     * Sets the unknown field value. book marks this as reserved = 0 but it
     ...
     *
     * @param field_3_weight One of WEIGHT_HAIRLINE WEIGHT_NARROW WEIGHT_MEDIUM
     *            WEIGHT_WIDE
     */
    ...
    public String toString() {
        ...
        buffer.append("    .lineColor            = ").append("0x").append(HexDump.toHex(getLineColor())).append(" (")
                .append(getLineColor()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .linePattern          = ").append("0x").append(HexDump.toHex(getLinePattern())).append(" (")
                .append(getLinePattern()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .weight               = ").append("0x").append(HexDump.toHex(getWeight())).append(" (")
                .append(getWeight()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .format               = ").append("0x").append(HexDump.toHex(getFormat())).append(" (")
                .append(getFormat()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        ...
        buffer.append("    .colourPaletteIndex   = ").append("0x").append(HexDump.toHex(getColourPaletteIndex()))
