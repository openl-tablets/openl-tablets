 ...
 * two well-known section format IDs: those of the
 * <tt>\005SummaryInformation</tt> stream and the
 * <tt>\005DocumentSummaryInformation</tt> stream.
 * </p>
 * 
 * <p>
 * If you have a section format ID you can use it as a key to query this map. If
 * you get a {@link PropertyIDMap} returned your section is well-known and you
 * can query the {@link PropertyIDMap} for PID strings. If you get back
 * <code>null</code> you are on your own.
 * </p>
 * 
 * <p>
 * This {@link Map} expects the byte arrays of section format IDs as keys. A key
 * maps to a {@link PropertyIDMap} describing the property IDs in sections with
 * the specified section format ID.
 * </p>
 * 
...
public class SectionIDMap extends HashMap {
     ...
     * </p>
     */
    public final static byte[] SUMMARY_INFORMATION_ID = new byte[] { (byte) 0xF2, (byte) 0x9F, (byte) 0x85,
            (byte) 0xE0, (byte) 0x4F, (byte) 0xF9, (byte) 0x10, (byte) 0x68, (byte) 0xAB, (byte) 0x91, (byte) 0x08,
            (byte) 0x00, (byte) 0x2B, (byte) 0x27, (byte) 0xB3, (byte) 0xD9 };

    /**
     * <p>
     * The DocumentSummaryInformation's first section's format ID. The second
     * section has a different format ID which is not well-known.
     * </p>
     */
    public final static byte[] DOCUMENT_SUMMARY_INFORMATION_ID = new byte[] { (byte) 0xD5, (byte) 0xCD, (byte) 0xD5,
            (byte) 0x02, (byte) 0x2E, (byte) 0x9C, (byte) 0x10, (byte) 0x1B, (byte) 0x93, (byte) 0x97, (byte) 0x08,
            (byte) 0x00, (byte) 0x2B, (byte) 0x2C, (byte) 0xF9, (byte) 0xAE };
    ...
    public static SectionIDMap getInstance() {
        if (defaultMap == null) {
            ...
            m.put(DOCUMENT_SUMMARY_INFORMATION_ID, PropertyIDMap.getDocumentSummaryInformationProperties());
            defaultMap = m;
        }
        return defaultMap;
    }
     ...
     * ID in a section format ID's namespace.
     * </p>
     * 
     ...
     * @return The well-known property ID string associated with the property ID
     *         <var>pid</var> in the name space spanned by <var>
     *         sectionFormatID</var> . If the <var>pid</var> /<var>sectionFormatID
     *         </var> combination is not well-known, the string "[undefined]" is
     *         returned.
     */
    public static String getPIDString(final byte[] sectionFormatID, final int pid) {
        final PropertyIDMap m = (PropertyIDMap) getInstance().get(sectionFormatID);
        if (m == null)
            return UNDEFINED;
        else {
