...
class BlockListImpl implements BlockList {
    ...
    /**
     * get the blocks making up a particular stream in the list. The blocks are
    ...
    public ListManagedBlock[] fetchBlocks(final int startBlock) throws IOException {
        if (_bat == null) {
     ...
     *
     * @exception IOException if the index is out of range or has already been
     *                removed
     */
     ...
     *
     * @param index the index of the specified block; if the index is out of
     *            range, that's ok
     */
