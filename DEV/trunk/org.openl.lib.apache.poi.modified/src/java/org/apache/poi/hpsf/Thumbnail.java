...
public class Thumbnail {
     ...
     *
     * <p>
     * Note: The <code>byte[]</code> that starts at
     * <code>OFFSET_WMFDATA</code> and ends at
     * <code>getThumbnail().length - 1</code> forms a complete WMF image. It
     * can be saved to disk with a <code>.wmf</code> file type and read using
     * a WMF-capable image viewer.
     * </p>
     */
     ...
     * target="_blank">http://msdn.microsoft.com/library/en-us/dnolegen/html/msdn_propset.asp</a>.
     * </p>
     */
     ...
     *
     * <p>
     * A <code>DWORD</code> indicating a Macintosh clipboard format value
     * </p>
     *
     * <p>
     * See: <a
     ...
     *
     * <p>
     * A <code>DWORD</code> indicating No data. This is rarely used.
     * </p>
     *
     * <p>
     * See: <a
     ...
     * to store thumbnails in Property Streams.
     * </p>
     *
     * <p>
     ...
     * target="_blank">msdn.microsoft.com/library/en-us/dnw98bk/html/clipboardoperations.asp</a>.
     * </p>
     */
    ...
    /**
     * <p>
     * A <code>byte[]</code> to hold a thumbnail image in ({@link
    ...
    /**
     * <p>
     * Default Constructor. If you use it then one you'll have to add the
     * thumbnail <code>byte[]</code> from {@link
     * SummaryInformation#getThumbnail()} to do any useful manipulations,
     * otherwise you'll get a <code>NullPointerException</code>.
     * </p>
     */
    public Thumbnail() {
        super();
    ...
    /**
     * <p>
     * Creates a <code>Thumbnail</code> instance and initializes with the
     * specified image bytes.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns an <code>int</code> representing the Clipboard Format
     * </p>
     *
     * <p>
     * Will throw an exception if the Thumbnail's Clipboard Format Tag is not
    ...
    /**
     * <p>
     * Returns an <code>int</code> representing the Clipboard Format Tag
     * </p>
     *
     * <p>
     * Possible return values are:
     ...
     *
     * <p>
     * See <a href="http://www.wvware.com/caolan/ora-wmf.html"
     * target="_blank">http://www.wvware.com/caolan/ora-wmf.html</a> for more
     * information on the WMF image format.
     * </p>
     *
