...
public class Util {
     ...
     */
    public static void copy(final byte[] src, final int srcOffset, final int length, final byte[] dst,
            final int dstOffset) {
     ...
     * <li>
     * <p>
     * if for each <var>i</var> with <var>i</var>&nbsp;&gt;=&nbsp;0 and <var>i</var>&nbsp;&lt;&nbsp;<var>a.length</var>
     * holds <var>a</var>[<var>i</var>]&nbsp;==&nbsp;<var>b</var>[<var>i</var>].
     * </p>
     * </li>
     *
     * </ul>
