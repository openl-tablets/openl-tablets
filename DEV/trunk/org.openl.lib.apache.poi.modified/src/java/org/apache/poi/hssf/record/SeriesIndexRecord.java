...
/**
 * links a series to its position in the series list. NOTE: This source is
...
public class SeriesIndexRecord extends Record {
     ...
     *
     * @param id id must be 0x1065 or an exception will be throw upon validation
    ...
    public String toString() {
        ...
        buffer.append("    .index                = ").append("0x").append(HexDump.toHex(getIndex())).append(" (")
