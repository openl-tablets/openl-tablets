 ...
 * <P>
 * Description: Flag specifying whether 1904 date windowing is used. (tick toc
 * tick toc...BOOM!)
 * <P>
...
public class DateWindow1904Record extends Record {
    ...
    /**
     * gets whether or not to use 1904 date windowing (which means you'll be
     * screwed in 2004)
     *
    ...
    public int serialize(int offset, byte[] data) {
        ...
        LittleEndian.putShort(data, 2 + offset, ((short) 0x02)); // 2 bytes
                                                                    // (6 total)
    ...
    /**
     * sets whether or not to use 1904 date windowing (which means you'll be
     * screwed in 2004)
     *
     * @param window flag - 0/1 (false,true)
     */

    public void setWindowing(short window) { // I hate using numbers in
                                                // method names so I wont!
