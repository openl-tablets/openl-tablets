...
public class BigDecimalValue extends ExplanationNumberValue<BigDecimalValue> {
    ...
    public static org.openl.meta.BigDecimalValue median(org.openl.meta.BigDecimalValue[] values) {
        ...
        return new org.openl.meta.BigDecimalValue(new org.openl.meta.BigDecimalValue(median),
            NumberOperations.MEDIAN,
            values);
    }

    public static org.openl.meta.BigDecimalValue max(org.openl.meta.BigDecimalValue value1,
    ...
    public static org.openl.meta.BigDecimalValue min(org.openl.meta.BigDecimalValue value1,
            org.openl.meta.BigDecimalValue value2) {
        // Commented to support operations with nulls
        // "null" means that data does not exist
    ...
    public static org.openl.meta.BigDecimalValue multiply(org.openl.meta.BigDecimalValue value1,
        ...
        return new org.openl.meta.BigDecimalValue(value1, value2, Operators.multiply(value1.getValue(),
    ...
    public static org.openl.meta.BigDecimalValue subtract(org.openl.meta.BigDecimalValue value1,
        ...
        return new org.openl.meta.BigDecimalValue(value1, value2, Operators.subtract(value1.getValue(),
    ...
    public static org.openl.meta.BigDecimalValue product(org.openl.meta.BigDecimalValue[] values) {
        ...
        return new org.openl.meta.BigDecimalValue(new org.openl.meta.BigDecimalValue(product),
    ...
    public static org.openl.meta.BigDecimalValue mod(org.openl.meta.BigDecimalValue number,
        ...
        if (number != null && divisor != null) {
            org.openl.meta.BigDecimalValue result = new org.openl.meta.BigDecimalValue(MathUtils.mod(number.getValue(),
                divisor.getValue()));
    ...
    public static org.openl.meta.BigDecimalValue small(org.openl.meta.BigDecimalValue[] values, int position) {
        ...
        return new org.openl.meta.BigDecimalValue((org.openl.meta.BigDecimalValue) getAppropriateValue(values,
            new org.openl.meta.BigDecimalValue(small)), NumberOperations.SMALL, values);
    }
    ...
    public static org.openl.meta.BigDecimalValue big(org.openl.meta.BigDecimalValue[] values, int position) {
        ...
        return new org.openl.meta.BigDecimalValue((org.openl.meta.BigDecimalValue) getAppropriateValue(values,
            new org.openl.meta.BigDecimalValue(big)), NumberOperations.BIG, values);
    }
    ...
    public static org.openl.meta.BigDecimalValue pow(org.openl.meta.BigDecimalValue value1,
        ...
        return new org.openl.meta.BigDecimalValue(new org.openl.meta.BigDecimalValue(Operators.pow(value1.getValue(),
            value2.getValue())), NumberOperations.POW, new org.openl.meta.BigDecimalValue[] { value1, value2 });
    }
