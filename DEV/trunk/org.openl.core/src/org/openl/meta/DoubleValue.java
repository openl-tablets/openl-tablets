...
public class DoubleValue extends ExplanationNumberValue<DoubleValue> {
    ...
    public static org.openl.meta.DoubleValue mod(org.openl.meta.DoubleValue number, org.openl.meta.DoubleValue divisor) {
        if (number != null && divisor != null) {
            org.openl.meta.DoubleValue result = new org.openl.meta.DoubleValue(MathUtils.mod(number.getValue(),
                divisor.getValue()));
    ...
    public static org.openl.meta.DoubleValue small(org.openl.meta.DoubleValue[] values, int position) {
        ...
        return new org.openl.meta.DoubleValue((org.openl.meta.DoubleValue) getAppropriateValue(values,
            new org.openl.meta.DoubleValue(small)), NumberOperations.SMALL, values);
    }
    ...
    public static org.openl.meta.DoubleValue big(org.openl.meta.DoubleValue[] values, int position) {
        ...
        return new org.openl.meta.DoubleValue((org.openl.meta.DoubleValue) getAppropriateValue(values,
            new org.openl.meta.DoubleValue(big)), NumberOperations.BIG, values);
    }
    ...
    public static org.openl.meta.DoubleValue pow(org.openl.meta.DoubleValue value1, org.openl.meta.DoubleValue value2) {
        ...
        return new org.openl.meta.DoubleValue(new org.openl.meta.DoubleValue(Operators.pow(value1.getValue(),
            value2.getValue())), NumberOperations.POW, new org.openl.meta.DoubleValue[] { value1, value2 });
    }
