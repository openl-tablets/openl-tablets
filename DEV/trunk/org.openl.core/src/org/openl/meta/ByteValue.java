...
public class ByteValue extends ExplanationNumberValue<ByteValue> {
    ...
    public static org.openl.meta.ByteValue mod(org.openl.meta.ByteValue number, org.openl.meta.ByteValue divisor) {
        if (number != null && divisor != null) {
            org.openl.meta.ByteValue result = new org.openl.meta.ByteValue(MathUtils.mod(number.getValue(),
                divisor.getValue()));
            return new org.openl.meta.ByteValue(result, NumberOperations.MOD, new org.openl.meta.ByteValue[] { number,
                    divisor });
        }
        return null;
    }
    ...
    public static org.openl.meta.ByteValue small(org.openl.meta.ByteValue[] values, int position) {
        ...
        return new org.openl.meta.ByteValue((org.openl.meta.ByteValue) getAppropriateValue(values,
            new org.openl.meta.ByteValue(small)), NumberOperations.SMALL, values);
    }
    ...
    public static org.openl.meta.ByteValue big(org.openl.meta.ByteValue[] values, int position) {
        ...
        return new org.openl.meta.ByteValue((org.openl.meta.ByteValue) getAppropriateValue(values,
            new org.openl.meta.ByteValue(big)), NumberOperations.BIG, values);
    }
    ...
    public static org.openl.meta.ByteValue pow(org.openl.meta.ByteValue value1, org.openl.meta.ByteValue value2) {
        ...
        return new org.openl.meta.ByteValue(new org.openl.meta.ByteValue(Operators.pow(value1.getValue(),
            value2.getValue())), NumberOperations.POW, new org.openl.meta.ByteValue[] { value1, value2 });
    }
