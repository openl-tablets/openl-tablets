...
/**
 * Just a prototype for now to have one place for
 * stack trace formatting/parsing.
 * 
 * @author sam
 *
 */
public class StackTrace
{
  ...
  /**
   * Returns zero-bazed line number associated with the stack trace
   * line or negative number if none.
   */
