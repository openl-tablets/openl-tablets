...
public class OpenlMain implements SourceCodeURLConstants
{
	 ...
	 *  - olm.sourceFileName = ...
	 *  - .....
	 *  - String commandLine = "java OpenlMain " + olm.makeArgs());
	 */
...
//			throw new IllegalArgumentException(ARG_SOURCE_FILE_NAME);
	 ...
	 *  - home - current directory, launches start in the project directory
	 *  - classLoader - nothing, all required classes are already in the project
	 */
	...
	void run(String[] args)
	{
		...
		safeRunOpenl(
			openlName != null ? openlName : getOpenlName(sourceFileName),
			openlSource,
			methodName,
			new Object[] { methodArgs });
	}

	public Object safeRunOpenl(
		String openlName,
...
//		}
	...
	/**
	 * Returns openl name for a given filename
	 * in the form: org.openl.<filename-extension>
	 * 
	 * Examples:
	 *  - file.j          -> org.openl.j 
	 *  - file.j.simple   -> org.openl.j.simple 
	...
	static public String getOpenlName(String filename)
	{
		...
		if (idx < 0)
			throw new RuntimeException(
				"File: " + filename + " does not have an extension");
