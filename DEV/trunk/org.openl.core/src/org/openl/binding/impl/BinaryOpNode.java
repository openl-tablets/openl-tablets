...
public class BinaryOpNode extends MethodBoundNode
{
     ...
     * @param method
     */
    public BinaryOpNode(ISyntaxNode syntaxNode, IBoundNode[] child,
    ...
    static public Object evaluateBinaryMethod(IRuntimeEnv env, Object[] pars,
	    IMethodCaller boundMethod) throws OpenLRuntimeException
    {
