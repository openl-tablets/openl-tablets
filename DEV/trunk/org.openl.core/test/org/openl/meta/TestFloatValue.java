...
public class TestFloatValue {
    ...
    public void testRound() {
        ...
        value1 = new FloatValue(12.525f);
        
        assertEquals("12.53", FloatValue.round(value1, 2).toString());
        
        value1 = new FloatValue(0.525f);
        
        FloatValue tmp = FloatValue.round(value1, 2);
        
        assertEquals("0.53", FloatValue.round(tmp, 2).toString());
