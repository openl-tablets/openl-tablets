...
public class TablesTest extends TestCase
{
	...
	/**
	 * Constructor for TablesTest.
	 * @param name
	 */
	public TablesTest(String name)
	{
		super(name);
	}
	...
	public void testSplitter() throws Exception
	{
		...
		for (int i = 0; i < nsheets; i++)
		{
			...
			if (name.equals("ABC"))
			{
				...
				{
					System.out.println(
						XlsUtil.xlsCellPresentation(
							tables[j].getGridColumn(0, 0),
							tables[j].getGridRow(0, 0)));
				}
				...
				ILogicalTable lt = LogicalTable.logicalTable(tables[5]);
				...
				ILogicalTable invRow2 = LogicalTable.logicalTable(new TransposedGridTable(row2.getGridTable()));
	...
	void subtestRegion(ILogicalTable testHeader1) throws Exception
	{
	...
	public static void main(String[] args) throws Exception {
		new TablesTest("zz").testSplitter();
	}
