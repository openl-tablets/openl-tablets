...
public class TestRulesDependencies extends BaseOpenlBuilderHelper {
    ...
    public void testDTExistingDependency() {
        ...
        if (tsn != null) {
            ...
            Set<AMethod> rulesMethods = bindDep.getRulesMethods();
    ...
    public void testSpreadsheet() {
        ...
        if (tsn != null) {
            ...
            Set<AMethod> expectedRuledDependencies = new HashSet<AMethod>();
            expectedRuledDependencies.add((AMethod)findTable("Rules String driverAgeType(Driver driver)").getMember());
            expectedRuledDependencies.add((AMethod)findTable(
                "Rules String driverEligibility(Driver driver, String ageType)").getMember());
            expectedRuledDependencies.add((AMethod)findTable("Rules String driverRisk(Driver driver)").getMember());
            expectedRuledDependencies.add((AMethod)findTable(
    ...
    public void testMethod() {
        ...
        if (tsn != null) {
            ...
            Set<AMethod> expectedRuledDependencies = new HashSet<AMethod>();
            expectedRuledDependencies.add((AMethod)findTable("Method int start2()").getMember());
            expectedRuledDependencies.add((AMethod)findTable("Method void callVoid()").getMember());
