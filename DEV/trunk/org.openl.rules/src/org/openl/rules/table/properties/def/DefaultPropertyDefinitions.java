...
public class DefaultPropertyDefinitions 
{
    ...
    static {  
		...
		definitions[0].setConstraints(new org.openl.rules.table.constraints.Constraints("unique in:module&regexp:([a-zA-Z_][a-zA-Z0-9_]*)"));
		...
		definitions[0].setTableType(new XlsNodeTypes[] {XlsNodeTypes.XLS_DT, XlsNodeTypes.XLS_SPREADSHEET, XlsNodeTypes.XLS_TBASIC, XlsNodeTypes.XLS_COLUMN_MATCH, XlsNodeTypes.XLS_METHOD});
		...
		definitions[1].setDescription("The name of the table, should be unique");
		...
		definitions[5].setDisplayName("Effective Date");
		definitions[5].setExpression(new org.openl.rules.table.properties.expressions.match.MatchingExpression("le(currentDate)"));
		...
		definitions[7].setConstraints(new org.openl.rules.table.constraints.Constraints("< endRequestDate"));
		definitions[7].setDescription("The date when rules become available in production, so the requests may be proce"
		 + "ssed by these rules");
		definitions[7].setDimensional(true);
		definitions[7].setDisplayName("Start Request Date");
		definitions[7].setExpression(new org.openl.rules.table.properties.expressions.match.MatchingExpression("max(le(requestDate))"));
		...
		definitions[7].setName("startRequestDate");
		definitions[7].setPrimaryKey(true);
		...
		definitions[8].setConstraints(new org.openl.rules.table.constraints.Constraints("> startRequestDate"));
		definitions[8].setDescription("The last date when rules are available in production, so the requests can not be"
		 + " processed by these rules");
		definitions[8].setDimensional(true);
		definitions[8].setDisplayName("End Request Date");
		definitions[8].setExpression(new org.openl.rules.table.properties.expressions.match.MatchingExpression("min(ge(requestDate))"));
		...
		definitions[8].setName("endRequestDate");
		...
		definitions[10].setBusinessSearch(true);
		definitions[10].setConstraints(new org.openl.rules.table.constraints.Constraints("no"));
		definitions[10].setDescription("The date of the table creation");
		definitions[10].setDimensional(false);
		definitions[10].setDisplayName("Created On");
		...
		definitions[10].setName("createdOn");
		...
		definitions[10].setSystemValuePolicy(SystemValuePolicy.IF_BLANK_ONLY);
		...
		definitions[12].setConstraints(new org.openl.rules.table.constraints.Constraints("no"));
		definitions[12].setDescription("The date of the last table modification");
		definitions[12].setDimensional(false);
		definitions[12].setDisplayName("Modified On");
		definitions[12].setFormat("MM/dd/yyyy");
		definitions[12].setGroup("Info");
		definitions[12].setInheritanceLevel(new InheritanceLevel[] {InheritanceLevel.TABLE});
		definitions[12].setName("modifiedOn");
		definitions[12].setPrimaryKey(false);
		definitions[12].setSecurityFilter("no");
		definitions[12].setSystem(true);
		definitions[12].setSystemValueDescriptor("currentDate");
		definitions[12].setSystemValuePolicy(SystemValuePolicy.ON_EACH_EDIT);
		definitions[12].setType(org.openl.types.java.JavaOpenClass.getOpenClass(java.util.Date.class));
