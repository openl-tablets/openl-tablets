...
public class DefaultPropertyDefinitions 
{
    ...
    static {  
		...
		definitions = new TablePropertyDefinition[28];
		...
		definitions[10].setName("modifiedOn");
		...
		definitions[12].setDescription("Defines gap/overlap validation mode for Decision Table");
		...
		definitions[13].setExpression(new org.openl.rules.table.properties.expressions.match.MatchingExpression("eq(lob)"));
		...
		definitions[14].setConstraints(new org.openl.rules.table.constraints.Constraints("data: usRegions"));
		definitions[14].setDescription("US Region");
		definitions[14].setDimensional(true);
		definitions[14].setDisplayName("US Region");
		definitions[14].setExpression(new org.openl.rules.table.properties.expressions.match.MatchingExpression("contains(usRegion)"));
		...
		definitions[14].setType(org.openl.types.java.JavaOpenClass.getOpenClass(org.openl.rules.enumeration.UsRegionsEnum[].class));
		definitions[15] = new TablePropertyDefinition();
		definitions[15].setBusinessSearch(false);
		definitions[15].setConstraints(new org.openl.rules.table.constraints.Constraints("data: countries"));
		definitions[15].setDescription("Country");
		definitions[15].setDimensional(true);
		definitions[15].setDisplayName("Countries");
		definitions[15].setExpression(new org.openl.rules.table.properties.expressions.match.MatchingExpression("contains(country)"));
		...
		definitions[15].setName("country");
		...
		definitions[15].setType(org.openl.types.java.JavaOpenClass.getOpenClass(org.openl.rules.enumeration.CountriesEnum[].class));
		...
		definitions[16].setDefaultValue("USD");
		definitions[16].setDescription("Currency");
		...
		definitions[17].setDefaultValue("ENG");
		definitions[17].setDescription("Language");
		...
		definitions[18].setConstraints(new org.openl.rules.table.constraints.Constraints("data: usStates"));
		definitions[18].setDescription("US State");
		definitions[18].setDimensional(true);
		definitions[18].setDisplayName("US States");
		definitions[18].setExpression(new org.openl.rules.table.properties.expressions.match.MatchingExpression("contains(usState)"));
		...
		definitions[18].setType(org.openl.types.java.JavaOpenClass.getOpenClass(org.openl.rules.enumeration.UsStatesEnum[].class));
		definitions[19] = new TablePropertyDefinition();
		definitions[19].setBusinessSearch(true);
		definitions[19].setConstraints(new org.openl.rules.table.constraints.Constraints("data: regions"));
		definitions[19].setDescription("Economic Region");
		definitions[19].setDimensional(true);
		definitions[19].setDisplayName("Region");
		definitions[19].setExpression(new org.openl.rules.table.properties.expressions.match.MatchingExpression("contains(region)"));
		definitions[19].setGroup("Business Dimension");
		definitions[19].setInheritanceLevel(new InheritanceLevel[] {InheritanceLevel.MODULE, InheritanceLevel.CATEGORY});
		definitions[19].setName("region");
		...
		definitions[19].setType(org.openl.types.java.JavaOpenClass.getOpenClass(org.openl.rules.enumeration.RegionsEnum[].class));
		definitions[20] = new TablePropertyDefinition();
		definitions[20].setBusinessSearch(false);
		definitions[20].setConstraints(new org.openl.rules.table.constraints.Constraints("NN.NN[.NN]"));
		definitions[20].setDescription("Version is a dimension with a specific constraint - one and only one version mus"
		 + "t be active(per dimension), the dispatch is done automatically to the active ver"
		 + "sion");
		definitions[20].setDimensional(false);
		definitions[20].setDisplayName("Version");
		definitions[20].setGroup("Version");
		definitions[20].setInheritanceLevel(new InheritanceLevel[] {InheritanceLevel.TABLE});
		definitions[20].setName("version");
		...
		definitions[20].setType(org.openl.types.java.JavaOpenClass.getOpenClass(java.lang.String.class));
		definitions[21] = new TablePropertyDefinition();
		definitions[21].setBusinessSearch(false);
		definitions[21].setConstraints(new org.openl.rules.table.constraints.Constraints("unique in:TableGroup"));
		definitions[21].setDefaultValue("true");
		definitions[21].setDescription("Indicates an active version");
		definitions[21].setDimensional(false);
		definitions[21].setDisplayName("Active");
		definitions[21].setGroup("Version");
		definitions[21].setInheritanceLevel(new InheritanceLevel[] {InheritanceLevel.TABLE});
		definitions[21].setName("active");
		...
		definitions[22].setDefaultValue("false");
		definitions[22].setDescription("Raises an error if no rules were matched. The error will display at least parame"
		 + "ter set, if possible trace(not complete)");
		definitions[22].setDimensional(false);
		definitions[22].setDisplayName("Fail On Miss");
		definitions[22].setGroup("Dev");
		definitions[22].setInheritanceLevel(new InheritanceLevel[] {InheritanceLevel.MODULE, InheritanceLevel.CATEGORY, InheritanceLevel.TABLE});
		definitions[22].setName("failOnMiss");
		...
		definitions[23].setDescription("Defines scope for properties");
		...
		definitions[23].setTableType(new XlsNodeTypes[] {XlsNodeTypes.XLS_PROPERTIES});
		...
		definitions[24].setConstraints(new org.openl.rules.table.constraints.Constraints("regexp:([a-z_]{1}[a-z0-9_]*(\\.[a-z_]{1}[a-z0-9_]*)*)"));
		definitions[24].setDefaultValue("org.openl.generated.beans");
		definitions[24].setDescription("Defines the name of the package for datatype generation");
		definitions[24].setDimensional(false);
		definitions[24].setDisplayName("Datatype Package");
		definitions[24].setGroup("Dev");
		definitions[24].setInheritanceLevel(new InheritanceLevel[] {InheritanceLevel.MODULE, InheritanceLevel.TABLE});
		definitions[24].setName("datatypePackage");
		definitions[24].setPrimaryKey(false);
		definitions[24].setSystem(false);
		definitions[24].setTableType(new XlsNodeTypes[] {XlsNodeTypes.XLS_DATATYPE});
