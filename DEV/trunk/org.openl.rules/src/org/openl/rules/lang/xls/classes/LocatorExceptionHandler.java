...
/**
 * Classes that implement this interface will handle exceptions thrown while locating classes
 * Use cases: logging, adding error messages to WebStudio, rethrowing unchecked exception etc. 
 * 
 * @author NSamatov
 *
 */
