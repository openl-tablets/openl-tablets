...
public class AlgorithmCompiler {
    ...
    private void declareSubroutine(List<AlgorithmTreeNode> nodesToCompile) throws BoundError {
        ...
        // .asSourceCodeModule();
        // throw new BoundError(String.format("Can't compile subroutine %s",
        // methodName), errorSource);
    }
    ...
    private Object convertParam(List<AlgorithmTreeNode> nodesToCompile, Class<? extends Object> clazz,
        ...
        if (clazz.equals(String.class)) {
            ...
            if (operationParam == null) {
                ...
                AlgorithmTreeNode executionNode = getNodeWithResult(nodesToCompile,
                        extractOperationName(operationParam));
    ...
    private IOpenClass getTypeOfFieldValue(List<AlgorithmTreeNode> nodesToCompile, String openlStatementInstruction)
            throws BoundError {
