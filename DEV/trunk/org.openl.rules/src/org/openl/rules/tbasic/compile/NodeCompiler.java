...
public abstract class NodeCompiler {
    ...
    // private RuntimeOperation compileBefore(List<RuntimeOperation> operations,
    // AlgorithmTreeNode node){
    ...
    // private RuntimeOperation compileAfter(List<RuntimeOperation> operations,
    // AlgorithmTreeNode node){
    // RuntimeOperation operation = null;
    // //TODO openL statement
    // //operation = new PerformOperation(String openLStatement);
    ...
    public NodeCompiler(List<RuntimeOperation> operations, AlgorithmTreeNode node) {
        super();
