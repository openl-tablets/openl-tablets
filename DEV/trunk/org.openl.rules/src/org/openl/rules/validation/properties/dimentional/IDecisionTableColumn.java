...
/**
 * The abstraction that represents the column(it may be a row in transparent
 * view) of the decision table. Decision table column contains next cells:
 * <ol>
 *  <li>Column type</li>
...
public interface IDecisionTableColumn {
    ...
    /**
     * Gets the first value for given rule index. If the {@link #getNumberOfLocalParameters()} is more than 1.
     * Use {@link #getRuleValue(int, int)} to get all values.
     * 
    ...
    /**
     * As condition may has several local parameters see {@link #getNumberOfLocalParameters()}, so the 
     * rule values is a matrix, where first index is the rule index, the second - the index of local parameter.
     * If the {@link #getNumberOfLocalParameters()} is more than 1, use this method to get all rule values.
