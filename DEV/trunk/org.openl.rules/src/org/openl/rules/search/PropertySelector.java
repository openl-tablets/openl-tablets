...
public class PropertySelector extends ATableSyntaxNodeSelector
{
	...
	{
		propertyNameSelector = se.isAny(se.getValue1()) ? null : AStringBoolOperator.makeOperator("matches", se.getValue1());
		propertyValueSelector = se.isAny(se.getValue2()) ? null : AStringBoolOperator.makeOperator(se.getOpType2(), se.getValue2());
	}
