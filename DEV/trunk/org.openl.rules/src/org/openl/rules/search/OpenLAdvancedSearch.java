...
public class OpenLAdvancedSearch implements ITableNodeTypes, ISearchConstants {
    ...
    static public String[] typeButtons = { "Rules", "Data", "Method", "Datatype", "Test", "Run", "Env", "Other" };

    static public String[] types = { XLS_DT, XLS_DATA, XLS_METHOD, XLS_DATATYPE, XLS_TEST_METHOD, XLS_RUN_METHOD,
            XLS_ENVIRONMENT, XLS_OTHER };
