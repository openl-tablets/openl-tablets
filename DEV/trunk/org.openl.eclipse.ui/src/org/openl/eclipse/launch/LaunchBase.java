   ...
   implements ILaunchBase
{
  ...
  {
    return "No_targets_in_"
      + (selection.isFromEditor() ? "active_editor" : "selection")
      + "_to_"
...
//  }
   ...
   * Returns chosen element(s) or null if dialog was cancelled.
   */
  public Object[] selectionDialog(
    Object[] elements,
    String title,
    String message,
    boolean multi)
  {
    // TODO re-think: implement DebugModelPresentation extension for ILaunchTarget?
