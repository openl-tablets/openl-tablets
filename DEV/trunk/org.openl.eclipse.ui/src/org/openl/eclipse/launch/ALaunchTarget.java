...
/**
 * ALaunchTarget specifies some functionalities from ILaunchTarget
 *  - creating of the default launch configuration
 * 
 * @author sam
 */
...
{
  /**
   * Returns default configuration type ID for this target.
   * Used when the new default launch configuration is created.
   * Example, IJavaLaunchConfigurationConstants.ID_JAVA_APPLICATION.
   */
   ...
   */
  abstract public void initDefaultLaunchConfiguration(
  ...
  
  {
    try
    {
      ...
      ILaunchConfigurationWorkingCopy wc =
        getLaunchManager()
          .getLaunchConfigurationType(getDefaultLaunchConfigurationTypeID())
