...
public interface IntExp extends Expression
{
   ...
   * Please notice that <code>MIN_VALUE == -MAX_VALUE</code> which is not
   * true for <code>java.lang.Integer</code>.
   */
 ...
 /**
  * Returns the expression: <code>(-this)</code>.
...
//  public Constraint equals(FloatExp exp);
   ...
   * <code>doSomethingOrStop(int val)</code> of <code>IntDomainIterator</code>.
   *
  ...
  */
   ...
   * Returns the expression: <code>pow(this,value)</code>.
   * Value should be >= 0.
   * For value < 0 use pow(double value).
   *
