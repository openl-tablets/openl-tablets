 ...
 * <p>
 * Any specific subclass of the ConstraintImpl should implement:<ul>
...
public abstract class ConstraintImpl extends GoalImpl implements Constraint
{
  ...
  /**
   * Returns a constraint: <code>(NOT this)</code>.
   * An opposite constraint has semantically an opposite meaning to this constraint.
   * <p>
   * <b>Note</b>: this method simple prints an alert message and returns null.
   * It should be redefined in the subclass of the ConstraintImpl when:
   * <ul>
   * <li>The constraint could be involved in the "ifThen" and "ifThenElse" constraints.
...
//  }
//
//  public Constraint ifThen(Constraint constraint) // if this, then constraint
//  {
//    if (opposite()==null)
//    {
//      System.out.println("Constraint::ifThen: Not defined opposite constraint for "+this);
//    }
//    return opposite().or(constraint);  // careful!!: opposite may not be defined
//  }
//
//  public Constraint ifThenElse(Constraint constraint1, Constraint constraint2)
//  {
//    if (opposite()==null)
//    {
//      System.out.println("Constraint::ifThenElse: Not defined opposite constraint for "+this);
//    }
//    Constraint first_if = opposite().or(constraint1);  // careful!!: opposite may not be defined
//    Constraint second_if = this.or(constraint2);
//    return first_if.and(second_if);
//  }
  public IntBoolExp toIntBoolExp(){return null;}
