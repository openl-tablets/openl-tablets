...
public abstract class Observer implements EventOfInterest.Constants, java.io.Serializable
{
  ...
  /**
   * Called as a notification about an "event" that occured whith the "subject".
   * This observer should be subscribed to the corresponding event type for this "subject".
   */
  public abstract void update(Subject subject, EventOfInterest event)
  throws Failure;
