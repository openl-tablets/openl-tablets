...
/**
 * A goal can be defined in terms of it's subgoals. <code>Class GoalAnd</code> makes it
 ...
 * }
 * </pre>
 * GoalAnd pushes all it's subgoals to the execution stack.
 * It succeeds if and only if
 * all it's subgoals succeed. In that case it returns null otherwise it generates an
