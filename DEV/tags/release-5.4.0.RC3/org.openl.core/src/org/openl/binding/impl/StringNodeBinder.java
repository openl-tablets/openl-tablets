...
public class StringNodeBinder extends ANodeBinder {
    ...
    static protected int processOctal(String s, int startIndex, StringBuffer buf) throws Exception {
        int res = 0;
        int i;
        for (i = 0; i < 3; ++i) {
    ...
    static protected char processUnicode(String s, int startIndex) throws Exception {
        int res = 0;
        for (int i = 0; i < 4; ++i) {
            char c = s.charAt(startIndex + i);
            if ('0' <= c && c <= '9') {
