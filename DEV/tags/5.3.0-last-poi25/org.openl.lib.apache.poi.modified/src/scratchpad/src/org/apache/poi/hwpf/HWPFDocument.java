...
// implements Cloneable
{
    ...
    public HWPFDocument(InputStream istream) throws IOException {
        ...
        _pbt = new PAPBinTable(_mainStream, _tableStream, _dataStream, _fib.getFcPlcfbtePapx(), _fib
                .getLcbPlcfbtePapx(), fcMin);
    ...
    public void write(OutputStream out) throws IOException {
        ...
        fibSize += POIFSConstants.BIG_BLOCK_SIZE - (fibSize % POIFSConstants.BIG_BLOCK_SIZE);
