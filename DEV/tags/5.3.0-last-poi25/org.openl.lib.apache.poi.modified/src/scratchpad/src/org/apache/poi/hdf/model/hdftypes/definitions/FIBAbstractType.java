...
/**
 * File information Block. NOTE: This source is automatically generated please
 * do not modify this file. Either subclass or remove the record in
...
public abstract class FIBAbstractType implements HDFType {
     ...
     */
    public int getSize() {
        return 4 + +2 + 2 + 2 + 2 + 2 + 2 + 2 + 2 + 2 + 2 + 2 + 2 + 4 + 4 + 2 + 2 + 2 + 2 + 2 + 2 + 2 + 2 + 2 + 2 + 2
                + 2 + 2 + 2 + 2 + 2 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4
    ...
    public String toString() {
        ...
        buffer.append("0x");
        buffer.append(HexDump.toHex(getNFibBack()));
        buffer.append(" (").append(getNFibBack()).append(" )\n");

        buffer.append("    .lKey                 = ");
        buffer.append("0x");
        buffer.append(HexDump.toHex(getLKey()));
        buffer.append(" (").append(getLKey()).append(" )\n");

        buffer.append("    .envr                 = ");
        buffer.append("0x");
        buffer.append(HexDump.toHex(getEnvr()));
        buffer.append(" (").append(getEnvr()).append(" )\n");

        buffer.append("    .history              = ");
        buffer.append("0x");
        buffer.append(HexDump.toHex(getHistory()));
