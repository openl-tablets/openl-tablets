...
public class StyleSheet implements HDFType {
    ...
    public StyleSheet(byte[] tableStream, int offset) {
        ...
        offset = (LittleEndianConsts.SHORT_SIZE + _stshiLength);
        ...
        for (int x = 0; x < stdCount; x++) {
            ...
            if (stdSize > 0) {
                ...
                StyleDescription aStyle = new StyleDescription(tableStream, _baseLength, offset, true);
    ...
    public boolean equals(Object o) {
        ...
        if (ss._baseLength == _baseLength && ss._flags == _flags && ss._maxFixedIndex == _maxFixedIndex
                && ss._maxIndex == _maxIndex && ss._rgftc[0] == _rgftc[0] && ss._rgftc[1] == _rgftc[1]
