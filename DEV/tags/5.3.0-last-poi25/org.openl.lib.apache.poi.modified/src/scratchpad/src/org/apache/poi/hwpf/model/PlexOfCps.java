 ...
 * front that relate to an array of abitrary data structures in the back.
 *
 *
 * @author Ryan Ackley
 */
public class PlexOfCps {
     ...
     * @param sizeOfStruct The size of the data structure type stored in this
     *            PlexOfCps.
     */
    ...
    public byte[] toByteArray() {
        ...
        LittleEndian.putInt(buf, LittleEndianConsts.INT_SIZE * size, node.getEnd());
