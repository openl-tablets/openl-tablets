...
public class StyleSheet {
    ...
    static void doCHPOperation(CHP oldCHP, CHP newCHP, int operand, int param, byte[] varParam, byte[] grpprl,
            int offset, StyleSheet styleSheet) {
        switch (operand) {
            case 0:
        ...
        switch (operand) {
            ...
            case 0x21:
                ...
                if (index >= newTAP._itcMac) {
                    ...
                    System.arraycopy(newTAP._rgdxaCenter, index + 1, rgdxaCenter, index + count, (newTAP._itcMac)
                            - (index));
                    // copy rgtc
        ...
        while (offset < grpprl.length) {
            ...
            switch (propertyType) {
                ...
                case CHP_TYPE:
                    ...
                    doCHPOperation((CHP) parent, (CHP) newProperty, operand, param, varParam, grpprl, offset,
                            styleSheet);
                    break;
                case SEP_TYPE:
