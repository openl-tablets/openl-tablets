...
public class HSSFSheet {
    ...
    public int addMergedRegion(Region region) {
        ...
        return sheet.addMergedRegion(region.getRowFrom(), region.getColumnFrom(),
     ...
     *
     * @param addLow whether to add the row to the low level model - false if
     *            its already there
     */
    ...
    public boolean getAlternateExpression() {
        return ((WSBoolRecord) sheet.findFirstRecordBySid(WSBoolRecord.sid)).getAlternateExpression();
    }
    ...
    public boolean getDialog() {
        return ((WSBoolRecord) sheet.findFirstRecordBySid(WSBoolRecord.sid)).getDialog();
    }
    ...
    public boolean getDisplayGuts() {
        return ((WSBoolRecord) sheet.findFirstRecordBySid(WSBoolRecord.sid)).getDisplayGuts();
    }
    ...
    public boolean getFitToPage() {
        return ((WSBoolRecord) sheet.findFirstRecordBySid(WSBoolRecord.sid)).getFitToPage();
    }
    ...
    public boolean getHorizontallyCenter() {
        HCenterRecord record = (HCenterRecord) sheet.findFirstRecordBySid(HCenterRecord.sid);
     ...
     * @return HSSFRow representing the rownumber or null if its not defined on
     *         the sheet
     */
    ...
    public boolean getRowSumsBelow() {
        return ((WSBoolRecord) sheet.findFirstRecordBySid(WSBoolRecord.sid)).getRowSumsBelow();
    }
    ...
    public boolean getRowSumsRight() {
        return ((WSBoolRecord) sheet.findFirstRecordBySid(WSBoolRecord.sid)).getRowSumsRight();
    }
    ...
    public boolean getVerticallyCenter(boolean value) {
        VCenterRecord record = (VCenterRecord) sheet.findFirstRecordBySid(VCenterRecord.sid);
    ...
    public void removeRow(HSSFRow row) {
        ...
        if (rows.size() > 0) {
            ...
            while (iter.hasNext()) {
                ...
                sheet.removeValueRecord(row.getRowNum(), cell.getCellValueRecord());
            }
    ...
    public void setAlternativeExpression(boolean b) {
        WSBoolRecord record = (WSBoolRecord) sheet.findFirstRecordBySid(WSBoolRecord.sid);
    ...
    protected void shiftMerged(int startRow, int endRow, int n, boolean isRow) {
        ...
        for (int i = 0; i < getNumMergedRegions(); i++) {
            Region merged = getMergedRegionAt(i);
     ...
     * @param resetOriginalRowHeight whether to set the original row's height to
     *            the default
     */
    public void shiftRows(int startRow, int endRow, int n, boolean copyRowHeight, boolean resetOriginalRowHeight) {
        ...
        if (endRow == lastrow || endRow + n > lastrow) {
            lastrow = Math.min(endRow + n, 65535);
        }
        if (startRow == firstrow || startRow + n < firstrow) {
