...
/**
 * The value range record defines the range of the value axis. NOTE: This source
...
public class ValueRangeRecord extends Record {
     ...
     *
     * @param id id must be 0x101f or an exception will be throw upon validation
    ...
    public String toString() {
        ...
        buffer.append("         .crossCategoryAxisAtMaximum     = ").append(isCrossCategoryAxisAtMaximum())
                .append('\n');
