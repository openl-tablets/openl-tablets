...
public class POIFSDocumentPath {
     ...
     *
     * @exception IllegalArgumentException if any of the Strings in components
     ...
     * POIFSFileSystem
     *
     * @param components the Strings making up the path to a document. The
     *            Strings must be ordered as they appear in the directory
     *            hierarchy of the the document -- the first string must be the
     *            name of a directory in the root of the POIFSFileSystem, and
     *            every Nth (for N > 1) string thereafter must be the name of a
     *            directory in the directory identified by the (N-1)th string.
     *            <p>
     ...
     *
     * @exception IllegalArgumentException if any of the elements in the
     *                components parameter are null or have zero length
     */
        ...
        if ((o != null) && (o.getClass() == this.getClass())) {
            if (this == o) {
                ...
                if (path.components.length == components.length) {
                    rval = true;
                    for (int j = 0; j < components.length; j++) {
                        if (!path.components[j].equals(components[j])) {
                            rval = false;
                            break;
                        }
                    }
