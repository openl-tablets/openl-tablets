 ...
 * as possible, with an eye toward minimal creation of objects
 *
 * the mimicry of List is as follows:
 * <ul>
 * <li> if possible, operations designated 'optional' in the List interface are
 * attempted
 * <li> wherever the List interface refers to an Object, substitute short
 * <li> wherever the List interface refers to a Collection or List, substitute
 * ShortList
 * </ul>
 *
 * the mimicry is not perfect, however:
 * <ul>
 * <li> operations involving Iterators or ListIterators are not supported
 * <li> remove(Object) becomes removeValue to distinguish it from remove(short
 * index)
...
public class ShortList {
    ...
    public void add(final int index, final short value) {
        if (index > _limit) {
            ...
            System.arraycopy(_array, index, _array, index + 1, _limit - index);
            _array[index] = value;
            _limit++;
        }
    }
    ...
    public boolean addAll(final int index, final ShortList c) {
        ...
        if (c._limit != 0) {
            ...
            // make a hole
            System.arraycopy(_array, index, _array, index + c._limit, _limit - index);
