 ...
 * <P>
 * Description: used for localization. Currently HSSF always sets this to 1 and
 * it seems to work fine even in Germany. (es geht's auch fuer Deutschland)
 * <P>
 *
...
public class CountryRecord extends Record {
    ...
    public int serialize(int offset, byte[] data) {
        ...
        LittleEndian.putShort(data, 2 + offset, ((short) 0x04)); // 4 bytes
                                                                    // (8 total)
