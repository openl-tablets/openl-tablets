 ...
 * <P>
 * Description: stores the encrypted password for a sheet or workbook (HSSF
 * doesn't support encryption) REFERENCE: PG 371 Microsoft Excel 97 Developer's
...
public class PasswordRecord extends Record {
    ...
    private short field_1_password; // not sure why this is only 2 bytes, but it
                                    // is... go figure
