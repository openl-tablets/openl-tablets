...
public class POIFSWriterEvent {
     ...
     * @param limit the limit, in bytes, that can be written to the stream
     */

    POIFSWriterEvent(final DocumentOutputStream stream, final POIFSDocumentPath path, final String documentName,
            final int limit) {
        this.stream = stream;
        this.path = path;
