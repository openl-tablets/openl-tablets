...
/**
 * The font index record indexes into the font table for the text record. NOTE:
...
public class FontIndexRecord extends Record {
     ...
     *
     * @param id id must be 0x1026 or an exception will be throw upon validation
    ...
    public String toString() {
        ...
        buffer.append("[FONTX]\n");
        buffer.append("    .fontIndex            = ").append("0x").append(HexDump.toHex(getFontIndex())).append(" (")
                .append(getFontIndex()).append(" )");
