 ...
 * them as unmodifiable, copy them and modifiy the copies.
 * </p>
 *
 * <p>
 * <strong>FIXME:</strong> Make the singletons unmodifiable. However, since
 * this requires to use a {@link HashMap} delegate instead of extending
 * {@link HashMap} and thus requires a lot of stupid typing. I won't do that for
 * the time being.
 * </p>
 *
...
public class PropertyIDMap extends HashMap {
    ...
    /*
     * The following definitions are for property IDs in the first (and only)
     * section of the Summary Information property set.
     */
    ...
    /*
     * The following definitions are for property IDs in the first section of
     ...
     * review, memo, etc. This is useful to find documents of same type.
     * </p>
     */
    ...
    /**
     * <p>
     * Target format for power point presentation, e.g. 35mm, printer, video
     * etc.
     * </p>
     */
     ...
     * Otherwise the thumbnail should be cropped.
     * </p>
     */
    ...
    /**
     * <p>
     * This entry denotes an internally used property. It is a vector of
     * variants consisting of pairs of a string (VT_LPSTR) and a number (VT_I4).
     * The string is a heading name, and the number tells how many document
     * parts are under that heading.
     * </p>
     */
    ...
    /**
     * <p>
     * This entry contains the names of document parts (word: names of the
     * documents in the master document, excel: sheet names, power point: slide
     * titles, binder: document names).
     * </p>
     */
     ...
     * strings. See the overall HPSF documentation for details!
     * </p>
     */
     ...
     * @return As specified by the {@link Map} interface, this method returns
     *         the previous value associated with the specified <var>id</var>,
