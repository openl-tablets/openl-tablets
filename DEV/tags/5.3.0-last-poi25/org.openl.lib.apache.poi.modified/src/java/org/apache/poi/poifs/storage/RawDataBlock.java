...
public class RawDataBlock implements ListManagedBlock {
     ...
     *
     * @exception IOException on I/O errors, and if an insufficient amount of
     *                data is read
     */
    ...
    public RawDataBlock(final InputStream stream) throws IOException {
        ...
        if (count == -1) {
            ...
            throw new IOException("Unable to read entire block; " + count + type + " read; expected "
     ...
     *
     * @return true if no data was read because we were at the end of the file,
     *         else false
     *
