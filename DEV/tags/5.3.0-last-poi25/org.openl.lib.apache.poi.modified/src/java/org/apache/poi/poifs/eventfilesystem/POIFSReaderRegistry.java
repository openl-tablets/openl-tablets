...
/**
 * A registry for POIFSReaderListeners and the DocumentDescriptors of the
 * documents those listeners are interested in
 *
...
class POIFSReaderRegistry {
    ...
    Iterator getListeners(final POIFSDocumentPath path, final String name) {
        ...
        Set selectiveListeners = (Set) chosenDocumentDescriptors.get(new DocumentDescriptor(path, name));
