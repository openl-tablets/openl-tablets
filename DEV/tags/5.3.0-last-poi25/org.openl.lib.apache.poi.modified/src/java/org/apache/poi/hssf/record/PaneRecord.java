...
/**
 * Describes the frozen and unfozen panes. NOTE: This source is automatically
...
public class PaneRecord extends Record {
     ...
     *
     * @param id id must be 0x41 or an exception will be throw upon validation
     ...
     *         ACTIVE_PANE_LOWER_LEFT ACTIVE_PANE_UPER_LEFT
     */
     ...
     *
     * @param field_5_activePane One of ACTIVE_PANE_LOWER_RIGHT
     *            ACTIVE_PANE_UPPER_RIGHT ACTIVE_PANE_LOWER_LEFT
    ...
    public String toString() {
        ...
        buffer.append("    .y                    = ").append("0x").append(HexDump.toHex(getY())).append(" (").append(
                getY()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .topRow               = ").append("0x").append(HexDump.toHex(getTopRow())).append(" (")
                .append(getTopRow()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .leftColumn           = ").append("0x").append(HexDump.toHex(getLeftColumn())).append(" (")
                .append(getLeftColumn()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .activePane           = ").append("0x").append(HexDump.toHex(getActivePane())).append(" (")
