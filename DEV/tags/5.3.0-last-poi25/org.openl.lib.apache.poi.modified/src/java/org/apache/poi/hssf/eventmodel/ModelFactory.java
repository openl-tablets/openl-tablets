...
/**
 * ModelFactory creates workbook and sheet models based upon events thrown by
 * them there events from the EventRecordFactory.
 *
...
public class ModelFactory implements ERFListener {
    ...
    /**
     * register a ModelFactoryListener so that it can receive Models as they are
     * created.
     */
