...
/**
 * FormulaViewer - finds formulas in a BIFF8 file and attempts to read
 * them/display data from them. Only works if Formulas are enabled in
 * "RecordFactory"
 *
 * @author andy
 * @author Avik
...
public class FormulaViewer {
    ...
    public static void main(String args[]) {
        if ((args == null) || (args.length > 2) || args[0].equals("--help")) {
            System.out
                    .println("FormulaViewer .8 proof that the devil lies in the details (or just in BIFF8 files in general)");
            System.out.println("usage: Give me a big fat file name");
        } else if (args[0].equals("--listFunctions")) { // undocumented
