...
/**
 * Escher array properties are the most wierd construction ever invented with
 * all sorts of special cases. I'm hopeful I've got them all.
 *
...
public class EscherArrayProperty extends EscherComplexProperty {
    ...
    /**
     * Sometimes the element size is stored as a negative number. We negate it
     * and shift it to get the real value.
     */
    ...
    /**
     * We have this method because the way in which arrays in escher works is
     * screwed for seemly arbitary reasons. While most properties are fairly
     * consistent and have a predictable array size, escher arrays have special
     * cases.
     *
    ...
    public void setSizeOfElements(int sizeOfElements) {
        ...
        int expectedArraySize = getNumberOfElementsInArray() * getActualSizeOfElements(getSizeOfElements())
                + FIXED_SIZE;
        if (expectedArraySize != complexData.length) {
    ...
    public String toString() {
        ...
        return "propNum: " + getPropertyNumber() + ", propName: "
                + EscherProperties.getPropertyName(getPropertyNumber()) + ", complex: " + isComplex() + ", blipId: "
                + isBlipId() + ", data: " + nl + results.toString();
    }
