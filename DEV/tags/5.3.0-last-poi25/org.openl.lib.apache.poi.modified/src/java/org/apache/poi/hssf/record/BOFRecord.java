 ...
 * records that have a particular pupose or subject. Used in sheets and
 * workbooks.
 * <P>
...
public class BOFRecord extends Record {
    ...
    /**
     * for BIFF8 files the BOF is 0x809. For earlier versions it was 0x09 or
     * 0x(biffversion)09
     */
    ...
    public int serialize(int offset, byte[] data) {
        ...
        LittleEndian.putShort(data, 2 + offset, ((short) 0x10)); // 16 byte
                                                                    // length
