...
/**
 * The bar record is used to define a bar chart. NOTE: This source is
...
public class BarRecord extends Record {
     ...
     *
     * @param id id must be 0x1017 or an exception will be throw upon validation
    ...
    /**
     * Sets the display as percentage field value. display chart values as a
     * percentage
     */
    ...
    /**
     * Sets the horizontal field value. true to display horizontal bar charts,
     * false for vertical
     */
    ...
    public String toString() {
        ...
        buffer.append("[BAR]\n");
        buffer.append("    .barSpace             = ").append("0x").append(HexDump.toHex(getBarSpace())).append(" (")
                .append(getBarSpace()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .categorySpace        = ").append("0x").append(HexDump.toHex(getCategorySpace())).append(
                " (").append(getCategorySpace()).append(" )");
        buffer.append(System.getProperty("line.separator"));
