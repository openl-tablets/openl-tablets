...
public class Area3DPtg extends Ptg {
    ...
    public boolean equals(Object o) {
        ...
        if (field_2_first_row != area3DPtg.field_2_first_row) {
            return false;
        }
        if (field_3_last_row != area3DPtg.field_3_last_row) {
            return false;
        }
        if (field_4_first_column != area3DPtg.field_4_first_column) {
            return false;
        }
        if (field_5_last_column != area3DPtg.field_5_last_column) {
            return false;
        }
    ...
    public int hashCode() {
        int result;
        result = field_1_index_extern_sheet;
        result = 29 * result + field_2_first_row;
        result = 29 * result + field_3_last_row;
        result = 29 * result + field_4_first_column;
        result = 29 * result + field_5_last_column;
        return result;
    }
    ...
    public void setArea(String ref) {
        ...
        setFirstColumn(ar.getCells()[0].getCol());
        setLastRow((short) ar.getCells()[1].getRow());
        setLastColumn(ar.getCells()[1].getCol());
    ...
    /*
     * public String getArea(){ RangeAddress ra = new RangeAddress(
     * getFirstColumn(),getFirstRow() + 1, getLastColumn(), getLastRow() + 1);
    ...
    public String toFormulaString(Workbook book) {
        ...
        if (refs != null) {
            retval.append(refs.getSheetName(field_1_index_extern_sheet));
            retval.append('!');
        }
        retval
                .append((new CellReference(getFirstRow(), getFirstColumn(), !isFirstRowRelative(),
                        !isFirstColRelative())).toString());
        retval.append(':');
        retval.append((new CellReference(getLastRow(), getLastColumn(), !isLastRowRelative(), !isLastColRelative()))
                .toString());
