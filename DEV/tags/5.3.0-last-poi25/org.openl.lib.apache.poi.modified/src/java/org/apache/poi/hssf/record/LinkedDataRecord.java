...
/**
 * Describes a linked data record. This record referes to the series data or
 * text. NOTE: This source is automatically generated please do not modify this
...
public class LinkedDataRecord extends Record {
     ...
     *
     * @param id id must be 0x1051 or an exception will be throw upon validation
     ...
     *
     * @param field_2_referenceType One of REFERENCE_TYPE_DEFAULT_CATEGORIES
     *            REFERENCE_TYPE_DIRECT REFERENCE_TYPE_WORKSHEET
     *            REFERENCE_TYPE_NOT_USED REFERENCE_TYPE_ERROR_REPORTED
     */
    ...
    public String toString() {
        ...
        buffer.append("[AI]\n");
        buffer.append("    .linkType             = ").append("0x").append(HexDump.toHex(getLinkType())).append(" (")
                .append(getLinkType()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .referenceType        = ").append("0x").append(HexDump.toHex(getReferenceType())).append(
                " (").append(getReferenceType()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        ...
        buffer.append("    .indexNumberFmtRecord = ").append("0x").append(HexDump.toHex(getIndexNumberFmtRecord()))
                .append(" (").append(getIndexNumberFmtRecord()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .formulaOfLink        = ").append(" (").append(getFormulaOfLink()).append(" )");
        buffer.append(System.getProperty("line.separator"));
