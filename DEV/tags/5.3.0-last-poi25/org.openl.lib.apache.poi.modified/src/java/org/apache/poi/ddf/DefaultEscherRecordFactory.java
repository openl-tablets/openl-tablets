...
public class DefaultEscherRecordFactory implements EscherRecordFactory {
    private static Class[] escherRecordClasses = { EscherBSERecord.class, EscherOptRecord.class,
            EscherClientAnchorRecord.class, EscherDgRecord.class, EscherSpgrRecord.class, EscherSpRecord.class,
            EscherClientDataRecord.class, EscherDggRecord.class, EscherSplitMenuColorsRecord.class,
            EscherChildAnchorRecord.class, EscherTextboxRecord.class };
    ...
    public EscherRecord createRecord(byte[] data, int offset) {
        ...
        if ((header.getOptions() & (short) 0x000F) == (short) 0x000F) {
            ...
            return r;
        } else if (header.getRecordId() >= EscherBlipRecord.RECORD_ID_START
