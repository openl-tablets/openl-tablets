...
/**
 * Defines a series name NOTE: This source is automatically generated please do
...
public class SeriesTextRecord extends Record {
     ...
     *
     * @param id id must be 0x100d or an exception will be throw upon validation
    ...
    public String toString() {
        ...
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .undocumented         = ").append("0x").append(HexDump.toHex(getUndocumented()))
