...
/**
 * This class embodies the Property Table for the filesystem; this is basically
 * the dsirectory for all of the documents in the filesystem.
 *
...
public class PropertyTable implements BATManaged, BlockWritable {
     ...
     *
     * @exception IOException if anything goes wrong (which should be a result
     *                of the input being NFG)
     */

    public PropertyTable(final int startBlock, final RawDataBlockList blockList) throws IOException {
        _start_block = POIFSConstants.END_OF_CHAIN;
        _blocks = null;
        _properties = PropertyFactory.convertToProperties(blockList.fetchBlocks(startBlock));
    ...
    public void preWrite() {
        Property[] properties = (Property[]) _properties.toArray(new Property[0]);
