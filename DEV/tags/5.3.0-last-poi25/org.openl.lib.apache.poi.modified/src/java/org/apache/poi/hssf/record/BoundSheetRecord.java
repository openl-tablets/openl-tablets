 ...
 * sheetname and tells where the Beginning of file record is within the HSSF
 * file.
 * <P>
...
public class BoundSheetRecord extends Record {
    ...
    /**
     * get whether or not to interperate the Sheetname as compressed unicode
     * (8/16 bit) (This is undocumented but can be found as Q187919 on the
     * Microsoft(tm) Support site)
     *
    ...
    /**
     * get the length of the raw sheetname in characters the length depends on
     * the unicode flag
     *
    ...
    public byte getRawSheetnameLength() {
        return (byte) (((field_4_compressed_unicode_flag & 0x01) == 1) ? 2 * field_3_sheetname_length
    ...
    public int serialize(int offset, byte[] data) {
        ...
        /*
         * byte[] fake = new byte[] { (byte)0x85, 0x00, // sid 0x1a, 0x00, //
         * length 0x3C, 0x09, 0x00, 0x00, // bof 0x00, 0x00, // flags 0x09, //
         * len( str ) 0x01, // unicode // <str> 0x21, 0x04, 0x42, 0x04, 0x40,
         * 0x04, 0x30, 0x04, 0x3D, 0x04, 0x38, 0x04, 0x47, 0x04, 0x3A, 0x04,
         * 0x30, 0x04 // </str> };
         *
         * sid + len + bof + flags + len(str) + unicode + str 2 + 2 + 4 + 2 + 1 +
         * 1 + len(str)
         *
    ...
    /**
     * set whether or not to interperate the Sheetname as compressed unicode
     * (8/16 bit) (This is undocumented but can be found as Q187919 on the
     * Microsoft(tm) Support site)
     *
    ...
    public void setSheetname(String sheetname) {
        ...
        if ((sheetname == null) || (sheetname.length() == 0) || (sheetname.length() > 31)
