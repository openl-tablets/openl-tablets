...
/**
 * Number Stores a String value in a formula value stored in the format <length
 * 2 bytes>char[]
 *
...
public class StringPtg extends Ptg {
    ...
    public StringPtg(String value) {
        ...
        field_2_options = 0;
        fHighByte.setBoolean(field_2_options, false);
        field_3_string = value;
        field_1_length = (byte) value.length(); // for the moment, we
                                                        // support only ASCII
                                                        // strings in formulas
                                                        // we create
    }
    ...
    /*
     * public void setValue(String value) { field_1_value = value; }
     */
