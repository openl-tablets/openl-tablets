 ...
 * <P>
 * Description: Stores print setup options -- bogus for HSSF (and marked as
 * such)
 * <P>
...
public class PrintSetupRecord extends Record {
    ...
    static final private BitField lefttoright = new BitField(0x01); // print
    // over then
                                                                    // down
    static final private BitField landscape = new BitField(0x02); // landscape
    // mode
    static final private BitField validsettings = new BitField(0x04); // if
                                                                        // papersize,
                                                                        // scale,
                                                                        // resolution,
                                                                        // copies,
    ...
    // mere bunk
    static final private BitField nocolor = new BitField(0x08); // print
    // mono/b&w,
                                                                // colorless
    static final private BitField draft = new BitField(0x10); // print draft
    // quality
    static final private BitField notes = new BitField(0x20); // print the
    // notes
    static final private BitField noOrientation = new BitField(0x40); // the
                                                                    // orientation
                                                                        // is
                                                                        // not
                                                                        // set
    static final private BitField usepage = new BitField(0x80); // use a user
