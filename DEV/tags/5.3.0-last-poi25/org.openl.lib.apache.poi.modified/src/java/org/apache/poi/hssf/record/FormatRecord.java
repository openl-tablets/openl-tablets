...
public class FormatRecord extends Record {
    ...
    private boolean field_3_unicode_flag; // it is not undocumented - it is
                                            // unicode flag
    ...
    public int serialize(int offset, byte[] data) {
        ...
        LittleEndian.putShort(data, 2 + offset, (short) (2 + 2 + 1 + ((field_3_unicode_flag) ? 2 * field_3_unicode_len
                : field_3_unicode_len)));
    ...
    public String toString() {
         ...
         * .append(Integer.toHexString(getFormatStringLength())) .append("\n");
         */
