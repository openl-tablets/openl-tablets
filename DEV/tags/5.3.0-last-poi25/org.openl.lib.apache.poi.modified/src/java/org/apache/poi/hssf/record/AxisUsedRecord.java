...
/**
 * The number of axes used on a chart. NOTE: This source is automatically
...
public class AxisUsedRecord extends Record {
     ...
     *
     * @param id id must be 0x1046 or an exception will be throw upon validation
    ...
    public String toString() {
        ...
        buffer.append("    .numAxis              = ").append("0x").append(HexDump.toHex(getNumAxis())).append(" (")
                .append(getNumAxis()).append(" )");
