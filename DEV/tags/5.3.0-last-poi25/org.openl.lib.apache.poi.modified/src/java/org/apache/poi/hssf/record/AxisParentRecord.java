...
/**
 * The axis size and location NOTE: This source is automatically generated
...
public class AxisParentRecord extends Record {
     ...
     *
     * @param id id must be 0x1041 or an exception will be throw upon validation
     ...
     *
     * @return One of AXIS_TYPE_MAIN AXIS_TYPE_SECONDARY
     */
     ...
     *
     * @param field_1_axisType One of AXIS_TYPE_MAIN AXIS_TYPE_SECONDARY
     */
    ...
    public String toString() {
        ...
        buffer.append("    .y                    = ").append("0x").append(HexDump.toHex(getY())).append(" (").append(
                getY()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .width                = ").append("0x").append(HexDump.toHex(getWidth())).append(" (")
                .append(getWidth()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .height               = ").append("0x").append(HexDump.toHex(getHeight())).append(" (")
