...
/**
 * The series list record defines the series displayed as an overlay to the main
 * chart record. NOTE: This source is automatically generated please do not
...
public class SeriesListRecord extends Record {
     ...
     *
     * @param id id must be 0x1016 or an exception will be throw upon validation
