...
public abstract class HSSFShape {
    ...
    public static final int LINESTYLE_DASHDOTSYS = 3; // PS_DASHDOT system
                                                        // dash style
    public static final int LINESTYLE_DASHDOTDOTSYS = 4; // PS_DASHDOTDOT
                                                            // system dash style
    ...
    public static final int LINESTYLE_LONGDASHDOTGEL = 9; // long dash short
                                                            // dash
    public static final int LINESTYLE_LONGDASHDOTDOTGEL = 10; // long dash
                                                                // short dash
                                                                // short dash
     ...
     * @throws IllegalArgumentException when the wrong anchor is used for this
     *             particular shape.
     *
     * @see HSSFChildAnchor
    ...
    public void setLineStyleColor(int red, int green, int blue) {
        lineStyleColor = ((blue) << 16) | ((green) << 8) | red;
    }
