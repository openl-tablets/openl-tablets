...
class SSTRecordHeader {
    ...
    /**
     * Writes out the SST record. This consists of the sid, the record size, the
     * number of strings and the number of unique strings.
     *
     * @param data The data buffer to write the header to.
     * @param bufferIndex The index into the data buffer where the header should
     *            be written.
