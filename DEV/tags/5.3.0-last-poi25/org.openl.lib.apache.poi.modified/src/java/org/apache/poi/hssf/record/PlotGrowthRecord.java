 ...
 * scaled. NOTE: This source is automatically generated please do not modify
 * this file. Either subclass or remove the record in src/records/definitions.
 *
...
public class PlotGrowthRecord extends Record {
     ...
     *
     * @param id id must be 0x1064 or an exception will be throw upon validation
    ...
    public String toString() {
        ...
        buffer.append("    .horizontalScale      = ").append("0x").append(HexDump.toHex(getHorizontalScale())).append(
                " (").append(getHorizontalScale()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .verticalScale        = ").append("0x").append(HexDump.toHex(getVerticalScale())).append(
                " (").append(getVerticalScale()).append(" )");
        buffer.append(System.getProperty("line.separator"));
