 ...
 * also. The following is a list of the formats as returned by this class.
 * <P>
 * <P>
 * 0, "General"<br>
 * 1, "0"<br>
 ...
 * 0x15, "h:mm:ss"<br>
 * 0x16, "m/d/yy h:mm"<br>
 * <P> // 0x17 - 0x24 reserved for international and undocumented 0x25,
 * "(#,##0_);(#,##0)"
 * <P>
 * 0x26, "(#,##0_);[Red](#,##0)"
 * <P>
...
public class HSSFDataFormat {
    ...
    /**
     * Construncts a new data formatter. It takes a workbook to have access to
     * the workbooks format records.
     *
    ...
    public String getFormat(short index) {
        if (movedBuiltins) {
            ...
            return (String) (builtinFormats.size() > index && builtinFormats.get(index) != null ? builtinFormats
                    .get(index) : formats.get(index));
        }
    }

    /**
     * get the format index that matches the given format string. Creates a new
     * format if one is not found. Aliases text to the proper format.
     *
     * @param format string matching a built in format
