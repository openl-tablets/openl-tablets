...
public class FuncPtg extends AbstractFunctionPtg {
    ...
    /**
     * FuncPtgs are defined to be 4 bytes but the actual FuncPtg uses only 2
     * bytes. If we have leftOvers that are read from the file we should
    ...
    public FuncPtg(byte[] data, int offset) {
         ...
         * leftOvers = new byte[2]; System.arraycopy(data, offset+1, leftOvers,
         * 0, leftOvers.length); }
         */
        try {
    ...
    public String toString() {
        ...
        buffer.append("<FunctionPtg>").append("\n").append("   numArgs(internal)=").append(numParams).append("\n")
    ...
    public void writeBytes(byte[] array, int offset) {
        ...
        /***********************************************************************
         * if (leftOvers != null) { System.arraycopy(leftOvers, 0, array,
         * offset+2, leftOvers.length); }
         **********************************************************************/
    }
}