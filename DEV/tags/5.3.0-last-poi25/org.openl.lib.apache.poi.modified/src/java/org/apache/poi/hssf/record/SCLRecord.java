...
/**
 * Specifies the window's zoom magnification. If this record isn't present then
 * the windows zoom is 100%. see p384 Excel Dev Kit NOTE: This source is
...
public class SCLRecord extends Record {
     ...
     *
     * @param id id must be 0xa0 or an exception will be throw upon validation
    ...
    public String toString() {
        ...
        buffer.append("[SCL]\n");
        buffer.append("    .numerator            = ").append("0x").append(HexDump.toHex(getNumerator())).append(" (")
                .append(getNumerator()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .denominator          = ").append("0x").append(HexDump.toHex(getDenominator())).append(" (")
