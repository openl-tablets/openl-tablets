...
public class BeanResultComparatorTest {
	...
	public void test() {
		...
		assertFalse(comparator1.compareResult(null, new SimpleDateFormat()));
		
		assertFalse(comparator1.compareResult(new SimpleDateFormat(), null));
		
		assertTrue(comparator1.compareResult(new SimpleDateFormat(), new SimpleDateFormat()));
	}
}
