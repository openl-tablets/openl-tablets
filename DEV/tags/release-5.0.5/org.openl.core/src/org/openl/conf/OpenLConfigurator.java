...
//    ClassLoaderFactory.setCurrentFactory(clFactory);
  ...
  IOpenLBuilder makeBuilderInstance(String builderClassName,
      String builderClassPath, IUserContext ucxt)
      throws Exception
    {
      ...
      if (builderClassPath != null)
      {
        cl =
            ...
            "builder.classloader:",
            builderClassPath,
            ClassLoaderFactory.getOpenlCoreLoader(ucxt.getUserClassLoader()),
            ucxt);
      }
