 ...
 * <code>IntArrayCards</code> becomes one to perform a policy of checking the number of occurences
 ...
 * (array is an IntExpArray to be controlled) so that it's i-th element define the cardinality
 * of i+array.min() value. In other words, the number of occurences must be within the
