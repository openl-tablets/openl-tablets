<%
	...
	%>
					<p>&nbsp;&nbsp;<a href="../runMethod.jsp?elementID=<%=s_id%>&testName=<%=tname%>&testID=<%=j%>&testDescr=<%=tdescrURL%>" title="Run"><img border=0 src="../../images/test.gif"/></a>
					...
					&nbsp;<a href="../runMethod.jsp?elementID=<%=s_id%>&testName=<%=tname%>&testID=<%=j%>&testDescr=<%=tdescrURL%>"><%=tdescrBody%></a>
