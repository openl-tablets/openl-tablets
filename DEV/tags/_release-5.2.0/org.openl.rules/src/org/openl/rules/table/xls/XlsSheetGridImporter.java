...
public class XlsSheetGridImporter implements IImporter {
    ...
    /**
     * Reads all subsections of a section identified by <code>parentSectionId</code>.
     *
     * @param parentSectionId id of section to read subsections of, or <code>null</code> for top level section
     ...
     *
     * @param parentSectionId id of section to read rows for, or <code>null</code> for top level section.
     * @return array of <code>String[]</code>, where each element represent a row of data.
     */
