...
public final class FloatCalc
{
  ...
  /**
   * Returns the expression: <code>min(1 / [min..max])</code>.
  ...
  /**
   * Returns the expression: <code>max(1 / [min..max])</code>.
   * Result may be finite number or +inf.
   */
  ...
  /**
   * Returns the expression: <code>min(1 / [v..v])</code>.
   * Result may be finite number or -inf.
   */
  ...
  /**
   * Returns the expression: <code>max(1 / [v..v])</code>.
   * Result may be finite number or +inf.
   */
