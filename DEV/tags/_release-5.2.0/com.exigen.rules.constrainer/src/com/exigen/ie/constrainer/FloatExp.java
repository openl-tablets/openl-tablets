...
public interface FloatExp extends Expression
{
  ...
  */
   ...
   * <pre>(max-min)/max(1,|min|) <= precision </pre>
   *
   * The floating-point expression is bound to the <b>mean value</b>
   * in the <code>[min..max]</code> interval associated with this expresion.
   *
