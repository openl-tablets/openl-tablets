...
public interface Constraint extends Goal
{
  ...
  /**
   * Returns a constraint: <code>(this AND constraint)</code>.
   * This constraint is satisfied only
   * when both the invoked constraint and the parameter-constraint are satisfied.
   * 'And' condition has straightforward implementation for the constraints even
   * in the minimal requirements to the interface Constraint.
   */
