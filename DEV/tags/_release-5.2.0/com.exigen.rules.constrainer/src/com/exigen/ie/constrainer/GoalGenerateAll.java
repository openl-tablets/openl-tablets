...
/**
 * An implementation of a {@link Goal} that finds and prints all solutions
 * for the problem with the unknown integer valiables.
 * <p>
 * This goal:
 * <ul>
 * <li>Selects the variable using {@link IntVarSelector}.
 * <li>Works with the domain of the variable using {@link IntValueSelector} or dichotomize algorithm.
 * </ul>
 */
public class GoalGenerateAll extends GoalImpl
{
   ...
   */
  GoalGenerateAll(IntExpArray intvars, IntVarSelector var_selector, IntValueSelector value_selector, boolean dichotomize)
  {
  ...
  {
    Goal goal = new GoalAnd(_search_goal,
                            _print_goal,
                            _fail_goal);
    return goal;
  }
