...
/**
 * Class EventOfInterest is a base class for different events used by
...
public abstract class EventOfInterest extends ReusableImpl implements EventOfInterestConstants
{
  ...
  /**
   * The constants for the EventOfInterest.
   * Temporary is not inner interface of the EventOfInterest
   * because of compilation problem with javac.
   */
