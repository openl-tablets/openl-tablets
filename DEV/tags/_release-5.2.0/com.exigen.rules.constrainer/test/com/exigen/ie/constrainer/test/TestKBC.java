...
//  static final int tolerancePercent = 2; // % of the totalCost
  ...
  static public void test1(String[] args) throws Exception
  {
    ...
    double totalCost = Integer.parseInt(arg); // total cost of the stock to be traded
    int qty = (int)Math.ceil(totalCost/costMin); // qty of the stock to be traded
...
//    IntValueSelector valueSelector = new IntValueSelectorMax();
    ...
    Goal solution = new GoalAnd(goalGenerate,
                                new GoalPrintObject(c,totalCostVar),
                                new GoalPrintObject(c,"\n"),
                                new GoalPrintObject(c,totalBrokersFee),
                                new GoalPrintObject(c,"\n")
                                );
