...
public class TestFloatVarImpl extends TestCase {
  ...
  public TestFloatVarImpl(String name) {super(name);}
  ...
  public void testAdd(){
    FloatVarImpl floatVar1 = new FloatVarImpl(C, -2, 5, ""),
                 floatVar2 = new FloatVarImpl(C, -5, 3, "");
    ...
    assertTrue(floatExp != null);
    assertTrue("FloatExpImpl.add(FloatExp) is to be retested: FloatExpImpl is bound", floatExp instanceof FloatExpAddValue);

    floatExp = floatConst.add(intVar1);
    assertTrue(floatExp != null);
    assertTrue("FloatExpImpl.add(IntExp) is to be retested: FloatExpImpl is bound", floatExp instanceof FloatExpAddValue);

    floatExp = floatConst.add(3.0);
    assertTrue("FloatExpImpl.add(double) is to be retested: FloatExpImpl is bound", floatExp instanceof FloatExpConst);
  ...
  public void testMul(){
    ...
    assertTrue(floatExp != null);
    assertTrue("FloatExpImpl.mul(FloatExp) is to be retested: FloatExpImpl is bound", floatExp instanceof FloatExpMultiplyPositive);

    floatExp = floatConst.mul(intVar1);
    assertTrue(floatExp != null);
    assertTrue("FloatExpImpl.mul(IntExp) is to be retested: FloatExpImpl is bound", floatExp instanceof FloatExpMultiplyPositive);

    floatExp = floatConst.mul(3.0);
    assertTrue("FloatExpImpl.mul(double) is to be retested: FloatExpImpl is bound", floatExp instanceof FloatExpConst);
    assertEquals(9*3, floatExp.max(), Constrainer.precision());
  }
  ...
  public void testDiv(){
    ...
    assertTrue(floatExp != null);
    assertTrue("FloatExpImpl.div(FloatExp) is to be retested: FloatExpImpl is bound", floatExp instanceof FloatExpMultiplyPositive);

    floatExp = floatConst.div(intVar1);
    assertTrue(floatExp != null);
    assertTrue("FloatExpImpl.div(IntExp) is to be retested: FloatExpImpl is bound", floatExp instanceof FloatExpMultiplyPositive);

    floatExp = floatConst.div(3.0);
    assertTrue("FloatExpImpl.div(double) is to be retested: FloatExpImpl is bound", floatExp instanceof FloatExpConst);
    assertEquals(9/3, floatExp.max(), Constrainer.precision());
  }
