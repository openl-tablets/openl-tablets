...
public class TestIntDomainHistory extends TestCase {
  ...
  public TestIntDomainHistory(String name) {super(name);}
  ...
  public void testSaveRestore()
  {
    ...
    IntDomainHistory history = intvar.history(); new IntDomainHistory(intvar);
    ...
    try{
      ...
      for (int i=0;i<maxVals.length-1;i++){
        ...
        for (int j = maxVals.length-1; j>i;j--){
          // ensure that all removed values are available after restoration
