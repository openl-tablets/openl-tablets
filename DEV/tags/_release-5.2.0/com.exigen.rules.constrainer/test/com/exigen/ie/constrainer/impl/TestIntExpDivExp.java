...
public class TestIntExpDivExp extends TestCase {
  ...
  public TestIntExpDivExp(String name){super(name);}
  public static void main(String[] args) {
    TestRunner.run(new TestSuite(TestIntExpDivExp.class));
  }

  private void curTestDiv(IntExp numerator,
                       IntExp denominator,
                       IntExp quotient,
                       IntBoolExp quotientConstraint,
                       IntBoolExp numeratorConstraint,
                       IntBoolExp denominatorConstraint){

    try{
      C.postConstraint(quotientConstraint);
    }catch(Failure f){fail("quotientConstraint posting failed");}
    try{
      C.postConstraint(numeratorConstraint);
    }catch(Failure f){fail("numeratorConstraint posting failed");}
    try{
      C.postConstraint(denominatorConstraint);
    }catch(Failure f){fail("denominatorConstraint posting failed");}
    ...
    }catch(Failure f){fail("test suddenly failed while attempting to get value of bound variable");}
  }

  public void testCase1(){
    //case 1 : numerator > 0 , denominator > 0
    IntVar numerator = C.addIntVar(1, 10),
    ...
    curTestDiv(numerator, denominator, quotient,
               quotient.eq(2), numerator.gt(4), denominator.lt(4));
  ...
  public void testCase2(){
    IntVar numerator = C.addIntVar(-9, 12),
           denominator = C.addIntVar(1, 8);
    IntExp quotient = null;
    ...
    quotient = new IntExpDivExp(numerator, denominator);
    curTestDiv(numerator, denominator, quotient,
               quotient.eq(-2), numerator.lt(-2), denominator.lt(6));
    // another implementation
    System.out.println("another implementation");
  ...
  public void testCase3(){
    IntVar numerator = C.addIntVar(-9, -1),
           denominator = C.addIntVar(1, 8);
    IntExp quotient = null;
  ...
  public void testCase4(){
    IntVar numerator = C.addIntVar(1, 22),
           denominator = C.addIntVar(-7, -3);
    IntExp quotient = null;
    ...
    curTestDiv(numerator, denominator, quotient,
               quotient.eq(-2), numerator.gt(7), denominator.lt(-4));
  }
  ...
  public void testCase5(){
    ...
    quotient = new IntExpDivExp(numerator, denominator);
    curTestDiv(numerator, denominator, quotient,
               quotient.eq(5), numerator.gt(7), denominator.gt(-5));
  ...
  public void testCase6(){
    IntVar numerator = C.addIntVar(-32, -4),
           denominator = C.addIntVar(-56, -14);
    IntExp quotient = null;
    ...
    curTestDiv(numerator, denominator, quotient,
               quotient.eq(2), numerator.lt(-7), denominator.gt(-23));

  }

  public void testCase7(){
    IntVar numerator = C.addIntVar(-32, 43),
           denominator = C.addIntVar(-32, 43);
    IntExp quotient = null;
    ...
    curTestDiv(numerator, denominator, quotient,
               quotient.eq(5), numerator.gt(-29), denominator.gt(-3));
