...
public class TestGoalOr extends TestCase {
  ...
  public TestGoalOr(String name) {super(name);}
  ...
  public void testExecute(){
    ...
    class GoalSuccess extends GoalImpl{
      GoalSuccess(){super(C, "GoalSuccess");}
    ...
    class GoalFailTest extends GoalImpl{
      ...
      GoalFailTest(String str){super(C, ""); _str = str;}
      public Goal execute() throws Failure{
        fail(_str);
        return null;
      }
    ...
    String[] errorString = {
     ...
     // the case when the first subgoal fails and the second is to be succeeded
