...
//      C.postConstraint(jcounts.sum().equals(demand[j]));
  ...
  /**
   * This goal instantiates bin types for all bins and then counts for all bins.
   */
  Goal searchGoal_1()
  {
