...
//
//
//		ModuleBindingContext moduleContext = new ModuleBindingContext(bindingContext);
//
...
//
//
//		MethodBindingContext[] methodContexts = new MethodBindingContext[nMethods];
//
...
//      
//      children[i] = new MethodNode(node.getChild(i), new IBoundNode[]{boundBodyNode}, 
//         methodContexts[i].getLocalVarFrameSize(), methodContexts[i].getParamFrameSize(), dm);
//    }
//    
...
//		
//		MethodParametersNode boundParametersNode = (MethodParametersNode)bindChildNode(parametersNode, methodBindingContext);
//
//		DeferredMethod dm =
//			new DeferredMethod(
//				methodName,
