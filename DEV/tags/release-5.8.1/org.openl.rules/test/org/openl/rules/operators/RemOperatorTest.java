...
public class RemOperatorTest {
    ...
    public void init() {
        if (instance == null) {
            ...
            TestHelper<RulesInterf> testHelper;
            testHelper = new TestHelper<RulesInterf>(xlsFile, RulesInterf.class);
    ...
    public void testFloatValue() {
        ...
        assertEquals("not passed", instance.testRemFloatValue(new FloatValue((float)5.57), new FloatValue((float)44)));
    }
