...
public class ObjectToDataConvertorFactoryTest {
    ...
    public void testInteger2Double() {
        ...
        Double value = (Double) convertor.convert(new Integer(2333), null);
        assertEquals(2333, value, 0);
    }
    
    @Test
    public void testDoublePrimitive2BigDecimal() {
        // when converting from double to BigDecimal, converter that uses BigDecimal.valueOf(double a) method will be used.
        //
    ...
    public void testDouble2BigDecimal() {
        ...
        Double valueToConvert = new Double(23.5666);
        
        BigDecimal value = (BigDecimal) convertor.convert(valueToConvert, null);
        assertEquals(valueToConvert.doubleValue(), value.doubleValue(), 0);
    }
