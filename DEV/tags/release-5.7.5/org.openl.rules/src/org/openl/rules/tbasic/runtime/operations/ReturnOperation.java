...
/**
 * The <code>ReturnOperation</code> class describes operation which finalizes
 * execution of some function or subroutine and returns some value if necessary.
 *
 * @author User
 *
 */
public class ReturnOperation<ResultValueType> extends OpenLEvaluationOperation {
     ...
     *
     * @param openLStatement Expression which result must be calculated and
     *            returned. If openLStatement is blank then operation just end
