...
public interface ITable<T extends ITable<T>> {
     ...
     * 
     * @param from
     * @return the columns represented as {@link ITable} from given index and till the right last column, 
     * including borders.
     */
     ...
     * 
     * @param from
     * @return the rows represented as {@link ITable} from given index and till the bottom row, 
     * including borders.
     */
    T getRows(int from);
