...
public abstract class CccExecutable extends CccObject
{
	...
	public CccExecutable(CccCore core, String name)
	{
		super(core, name);
		_executable = null;
		//    _check_solution_number = new GoalCheckSolutionNumber(core.constrainer(),1);
	}

	/*  public boolean getFail()  {    return _fail;  }
	  public void setFail(boolean b)  {
	//System.out.println("->> CccExecutable: fail("+b+"): "+this+" "+_activated);
	  _fail = b;  }
	*/
