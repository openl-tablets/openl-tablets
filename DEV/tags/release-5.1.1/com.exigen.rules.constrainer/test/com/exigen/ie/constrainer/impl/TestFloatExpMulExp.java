...
public class TestFloatExpMulExp extends TestCase {
  ...
  public TestFloatExpMulExp(String name) {super(name);}
  ...
  public void testMinMax(){
    // max1 < 0 && max2< 0
    FloatVar floatVar1 = C.addFloatVar(-5, -1, ""),
             floatVar2 = C.addFloatVar(-5, -2, "") ;
  ...
  public void testAscendingEventPropagation(){
    FloatVar floatVar1 = C.addFloatVar(-5, 3, ""),
             floatVar2 = C.addFloatVar(-4, 7, "");
    FloatExp floatExp = new FloatExpMulExp(floatVar1, floatVar2);
