...
public class TestIntExpImpl extends TestCase {
  ...
  public TestIntExpImpl(String name) {super(name);}
  ...
  public void testAdd(){
    ...
    }catch(Failure f){fail("IntExpImpl.add(double): test failed");}
  ...
  public void testMul(){
   ...
   //multiply positive constant
    ...
    }catch(Failure f){fail("test failed due to incorrect behaviour of IntExpImpl.setMax()");}
