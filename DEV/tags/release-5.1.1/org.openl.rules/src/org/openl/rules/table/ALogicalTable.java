...
public abstract class ALogicalTable implements ILogicalTable
{
	...
	public ILogicalTable getLogicalRegion(
		int column,
		int row,
		int width,
		int height)
	...
	/**
	 * 
	 * @return table with 1 column, if necessary transposed, caller is responsible to check that table is either 1xN or Nx1  
	 */
