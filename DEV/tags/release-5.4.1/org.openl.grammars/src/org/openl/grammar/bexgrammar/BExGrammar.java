...
public void parseTopNode(String type)
{
        ...
        catch (TokenMgrError err)
        {
                ...
                syntaxBuilder.addError(
                        new org.openl.syntax.impl.SyntaxError(loc, buf.toString(), null, syntaxBuilder.getModule()));
        }
        catch (Exception e)
        {
                syntaxBuilder.addError(new org.openl.syntax.impl.SyntaxError(pos(token), "", e, syntaxBuilder.getModule()));
        }
        catch (Throwable t)
        {
                syntaxBuilder.addError(new org.openl.syntax.impl.SyntaxError(pos(token), "", t, syntaxBuilder.getModule()));
        }
}
