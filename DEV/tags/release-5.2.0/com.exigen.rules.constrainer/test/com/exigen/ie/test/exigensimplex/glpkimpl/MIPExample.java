...
import com.exigen.ie.exigensimplex.glpkimpl.MIPAlgorithm;
...
public class MIPExample extends Object{
  ...
  static public void main(String[] argv){
   ...
   /**
    * When using GLPK library the command below allows to prevent
    * the solver from outputing intermediate results
    */
   lp.setIntParam(Parameters.MSG_LEV, 0);
    try{
      ...
      for (int r=0;r<nbResources;r++){
       ...
       /**
        * The result's code being equal to zero indicates that the problem is
        * successfully solved
        */
       if (status == 0){
         ...
         /**
          * Write a solution of the last MIP problem to the file specified
          */
