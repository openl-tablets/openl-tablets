...
public class TestIntExpAbs extends TestCase {
  ...
  public TestIntExpAbs(String name){super(name);}
  ...
  public void testMinMax(){
    IntVar intvar1 = C.addIntVar( 1, 10),
           intvar2 = C.addIntVar(-5,  3),
           intvar3 = C.addIntVar(-5, -2);

    IntExp absexp1 = new IntExpAbs(intvar1),
           absexp2 = new IntExpAbs(intvar2),
           absexp3 = new IntExpAbs(intvar3);
  ...
  public void testRemoveValue(){
    IntVar intvar1 = C.addIntVar( 1, 10, "intvar1", IntVar.DOMAIN_BIT_FAST),
           intvar2 = C.addIntVar(-5,  3, "intvar2", IntVar.DOMAIN_BIT_FAST),
           intvar3 = C.addIntVar(-5, -2, "intvar3", IntVar.DOMAIN_BIT_FAST);
  ...
  public void testSetValue(){
    IntVar intvar1 = C.addIntVar( 1, 10),
           intvar2 = C.addIntVar(-5,  3),
           intvar3 = C.addIntVar(-5, -2),
           intvar4 = C.addIntVar(-5, 5),
           intvar5 = C.addIntVar(-5, 5, "intvar5", IntVar.DOMAIN_BIT_FAST);

    IntExp absexp1 = new IntExpAbs(intvar1),
           absexp2 = new IntExpAbs(intvar2),
           absexp3 = new IntExpAbs(intvar3),
           absexp4 = new IntExpAbs(intvar4),
           absexp5 = new IntExpAbs(intvar5);
