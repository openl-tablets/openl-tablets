...
public class TestFloatExpAddExp extends TestCase {
  ...
  public TestFloatExpAddExp(String name) {super(name);}
  ...
  public void testSetMinSetMax(){
    ...
    }catch(Failure f){fail("test failed due to incorrect behaviour of setMin(double)");}
  }
  ...
  public void testCalcCoeffs(){
    ...
    }catch(NonLinearExpression e){fail("FloatExpAddExp treated as NonLinearExpression");}
