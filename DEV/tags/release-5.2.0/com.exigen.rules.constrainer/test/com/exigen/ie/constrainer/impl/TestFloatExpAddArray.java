...
public class TestFloatExpAddArray extends TestCase {
  ...
  public TestFloatExpAddArray(String name){super(name);}
  ...
  public void testMinMax(){
    double[] upperBounds = new double[100],
             lowerBounds = new double[upperBounds.length];
  ...
  public void testSetMinSetMax(){
    ...
    for (int i=0; i<array.size();i++)
      ...
      }catch(Failure f){fail("test failed due to incorrect work of Floatvar.setMin(double) or Floatvar.setMax(double)");}
