...
public class DualErrorCodes {
 /*status codes returned by getDualStatus() */
   ...
   */
  static public int  LPX_D_UNDEF  =  native_LPX_D_UNDEF();   /* dual status is undefined */
  /**
   * solution is dual feasible
   * @see LPX#getPrimStatus()
   */
  static public int  LPX_D_FEAS   =  native_LPX_D_FEAS();   /* solution is dual feasible */
  /**
   * solution is dual infeasible
   * @see LPX#getPrimStatus()
   */
  static public int  LPX_D_INFEAS =  native_LPX_D_INFEAS();  /* solution is dual infeasible */
  /**
   * no dual feasible solution exist
   * @see LPX#getPrimStatus()
   */
  static public int  LPX_D_NOFEAS =  native_LPX_D_NOFEAS();   /* no dual feasible solution exists */
