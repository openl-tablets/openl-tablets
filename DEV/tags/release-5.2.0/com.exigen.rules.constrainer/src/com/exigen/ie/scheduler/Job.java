...
/**
 * An interface for the representation of the different jobs (activities, tasks).
 * <p>
 * Job has a known duration and an unknown start/end (constrained int variables).
 * There are precedence constraints between jobs, and require-constraints between jobs and
 * resources.
 * <p>
 * Examples:<pre>
...
public interface Job
{
	 ...
	 * Creates resource requirement constraint
	 * @param res Required resoruce
	 * @param flag Expression (variable)to associate with the constraint,
	 * if it's satisfied expresson will be bound to 1, otherwise 0
	 * @param capacity Required resource capacity
	 * @return Resource requirement constraint
	 */
	//public ConstraintRequires requires(Resource res, IntExp flag, int capacity);
	 ...
	 * @return Resource requirement constraint
	 */
	//public ConstraintRequires requires(Resource res, IntExp flag); // duration = 1
