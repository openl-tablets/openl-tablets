...
/**
 * <p>Title: LPConstraint</p>
 * <p>Description: The class being designed for facilitating the storing and getting
 * access to the information about LP constraint</p>
...
public class LPConstraint extends VarType{
  ...
  /**
   * @param locs an array of locations of nonzero coefficients in the LP constraint
   * @param vals an array of values of non zero coefficients
   * <p> Note: the i'th coefficient standing at the locs[i] position
  ...
  /**
   * @return an array of locations of nonzero coefficients in the constraint concerned
   */
   ...
   * <p>Note: the position of the particular value in the array corresponding to the
   * ordinal number of the appropriate variable in the lp problem object
   */
