...
public class TableCellDescriptor extends TCAbstractType implements HDFType {
    ...
    /*
     * boolean _fFirstMerged; boolean _fMerged; boolean _fVertical; boolean
     * _fBackward; boolean _fRotateFont; boolean _fVertMerge; boolean
     * _fVertRestart; short _vertAlign; short[] _brcTop = new short[2]; short[]
     * _brcLeft = new short[2]; short[] _brcBottom = new short[2]; short[]
     * _brcRight = new short [2];
     */
