...
public abstract class DOPAbstractType implements HDFType {
     ...
     */
    public int getSize() {
        return 4 + 1 + 2 + 2 + 1 + 1 + 1 + 1 + 2 + 2 + 2 + 2 + 2 + 2 + 4 + 4 + 4 + 2 + 4 + 4 + 4 + 2 + 4 + 2 + 2 + 4
    ...
    public String toString() {
        ...
        buffer.append("0x");
        buffer.append(HexDump.toHex(getUnused2()));
        buffer.append(" (").append(getUnused2()).append(" )\n");

        buffer.append("    .footnoteInfo         = ");
        buffer.append("0x");
        buffer.append(HexDump.toHex(getFootnoteInfo()));
        ...
        buffer.append("0x");
        buffer.append(HexDump.toHex(getFOutlineDirtySave()));
        buffer.append(" (").append(getFOutlineDirtySave()).append(" )\n");

        buffer.append("    .docinfo              = ");
        buffer.append("0x");
        buffer.append(HexDump.toHex(getDocinfo()));
        ...
        buffer.append("0x");
        buffer.append(HexDump.toHex(getDocinfo1()));
        ...
        buffer.append("0x");
        buffer.append(HexDump.toHex(getDocinfo2()));
        ...
        buffer.append("0x");
        buffer.append(HexDump.toHex(getDocinfo3()));
        ...
        buffer.append("    .Edn1                 = ");
        buffer.append("0x");
        buffer.append(HexDump.toHex(getEdn1()));
        ...
        buffer.append("0x");
        buffer.append(HexDump.toHex(getDocinfo4()));
        ...
        buffer.append("    .adt                  = ");
        buffer.append("0x");
        buffer.append(HexDump.toHex(getAdt()));
        ...
        buffer.append("0x");
        buffer.append(HexDump.toHex(getDocinfo5()));
        ...
        buffer.append("0x");
        buffer.append(HexDump.toHex(getDocinfo6()));
