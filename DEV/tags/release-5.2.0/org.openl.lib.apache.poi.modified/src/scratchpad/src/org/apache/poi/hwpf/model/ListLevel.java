...
public class ListLevel {
    ...
    public ListLevel(int startAt, int numberFormatCode, int alignment, byte[] numberProperties, byte[] entryProperties,
            String numberText) {
        _iStartAt = startAt;
    ...
    public boolean equals(Object obj) {
        ...
        return _cbGrpprlChpx == lvl._cbGrpprlChpx && lvl._cbGrpprlPapx == _cbGrpprlPapx && lvl._dxaIndent == _dxaIndent
                && lvl._dxaSpace == _dxaSpace && Arrays.equals(lvl._grpprlChpx, _grpprlChpx)
                && Arrays.equals(lvl._grpprlPapx, _grpprlPapx) && lvl._info == _info && lvl._iStartAt == _iStartAt
                && lvl._ixchFollow == _ixchFollow && lvl._nfc == _nfc && Arrays.equals(lvl._numberText, _numberText)
    ...
    public int getSizeInBytes() {
        if (_numberText != null) {
            return 28 + _cbGrpprlChpx + _cbGrpprlPapx + (_numberText.length * LittleEndianConsts.SHORT_SIZE) + 2;
        } else {
