...
public class SectionTable {
    ...
    public void writeTo(HWPFFileSystem sys, int fcMin) throws IOException {
        ...
        for (int x = 0; x < len; x++) {
            ...
            // unable to observe any effect on our testcases when using this
            // code - piers
            GenericPropertyNode property = new GenericPropertyNode(FCtoCP(sepx.getStart()), FCtoCP(sepx.getEnd()), sed
                    .toByteArray());
