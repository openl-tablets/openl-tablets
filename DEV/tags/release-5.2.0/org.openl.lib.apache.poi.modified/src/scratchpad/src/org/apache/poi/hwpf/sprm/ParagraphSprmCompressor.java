...
public class ParagraphSprmCompressor {
    public static byte[] compressParagraphProperty(ParagraphProperties newPAP, ParagraphProperties oldPAP) {
        ...
        if (newPAP.getItbdMac() != oldPAP.getItbdMac() || !Arrays.equals(newPAP.getRgdxaTab(), oldPAP.getRgdxaTab())
        ...
        if (newPAP.isFBackward() != oldPAP.isFBackward() || newPAP.isFVertical() != oldPAP.isFVertical()
        ...
        if (newPAP.getFPropRMark() != oldPAP.getFPropRMark() || newPAP.getIbstPropRMark() != oldPAP.getIbstPropRMark()
