...
/**
 * Represents an textbox shape and converts between the highlevel records and
 * lowlevel records for an oval.
 *
...
public class TextboxShape extends AbstractShape {
    ...
    private TextObjectRecord createTextObjectRecord(HSSFTextbox hssfShape, int shapeId) {
        ...
        obj.setHorizontalTextAlignment(TextObjectBaseRecord.HORIZONTAL_TEXT_ALIGNMENT_LEFT_ALIGNED);
        obj.setVerticalTextAlignment(TextObjectBaseRecord.VERTICAL_TEXT_ALIGNMENT_TOP);
        obj.setTextLocked(true);
        obj.setTextOrientation(TextObjectBaseRecord.TEXT_ORIENTATION_NONE);
