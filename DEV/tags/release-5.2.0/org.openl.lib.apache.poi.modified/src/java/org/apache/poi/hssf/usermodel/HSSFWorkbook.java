...
public class HSSFWorkbook extends java.lang.Object {
     ...
     * filesystem around your inputstream.
     *
     * @param s the POI filesystem that contains the Workbook stream.
     * @param preserveNodes whether to preseve other nodes, such as macros. This
     *            takes more memory, so only say yes if you need to.
    ...
    public HSSFWorkbook(POIFSFileSystem fs, boolean preserveNodes) throws IOException {
        ...
        while (recOffset < records.size()) {
            ...
            sheet.convertLabelRecords(workbook); // convert all LabelRecord
                                                    // records to LabelSSTRecord
    ...
    public HSSFSheet cloneSheet(int sheetNum) {
        ...
        if (srcSheet != null) {
            ...
            WindowTwoRecord windowTwo = (WindowTwoRecord) clonedSheet.getSheet().findFirstRecordBySid(
                    WindowTwoRecord.sid);
     ...
     */
    private void copyNodes(POIFSFileSystem source, POIFSFileSystem target, List excepts) throws IOException {
    ...
    /*
     * get the sheet's index @param name sheet name @return sheet index or -1 if
     * it was not found.
     */
    ...
    public HSSFSheet createSheet() {
        ...
        // throw new RuntimeException("You cannot have more than three sheets in
        // HSSF 1.0");
     ...
     */
    public HSSFFont findFont(short boldWeight, short color, short fontHeight, String name, boolean italic,
            boolean strikeout, short typeOffset, byte underline) {
        // System.out.println( boldWeight + ", " + color + ", " + fontHeight +
        // ", " + name + ", " + italic + ", " + strikeout + ", " + typeOffset +
        // ", " + underline );
        for (short i = 0; i < workbook.getNumberOfFontRecords(); i++) {
            ...
            // System.out.println( hssfFont.getBoldweight() + ", " +
            // hssfFont.getColor() + ", " + hssfFont.getFontHeight() + ", " +
            // hssfFont.getFontName() + ", " + hssfFont.getItalic() + ", " +
            // hssfFont.getStrikeout() + ", " + hssfFont.getTypeOffset() + ", "
    ...
    public byte[] getBytes() {
        ...
        for (int k = 0; k < sheets.size(); k++) {
            ...
            pos += ((HSSFSheet) sheets.get(k)).getSheet().serialize(pos, retval); // sb.length;
        }
        /*
         * for (int k = pos; k < totalsize; k++) { retval[k] = 0; }
         */
        return retval;
    }
    ...
    public void insertChartRecord() {
        ...
        byte[] data = { (byte) 0x0F, (byte) 0x00, (byte) 0x00, (byte) 0xF0, (byte) 0x52, (byte) 0x00, (byte) 0x00,
                (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x06, (byte) 0xF0, (byte) 0x18, (byte) 0x00, (byte) 0x00,
                (byte) 0x00, (byte) 0x01, (byte) 0x08, (byte) 0x00, (byte) 0x00, (byte) 0x02, (byte) 0x00, (byte) 0x00,
                (byte) 0x00, (byte) 0x02, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x01, (byte) 0x00, (byte) 0x00,
                (byte) 0x00, (byte) 0x01, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x03, (byte) 0x00, (byte) 0x00,
                (byte) 0x00, (byte) 0x33, (byte) 0x00, (byte) 0x0B, (byte) 0xF0, (byte) 0x12, (byte) 0x00, (byte) 0x00,
                (byte) 0x00, (byte) 0xBF, (byte) 0x00, (byte) 0x08, (byte) 0x00, (byte) 0x08, (byte) 0x00, (byte) 0x81,
                (byte) 0x01, (byte) 0x09, (byte) 0x00, (byte) 0x00, (byte) 0x08, (byte) 0xC0, (byte) 0x01, (byte) 0x40,
                (byte) 0x00, (byte) 0x00, (byte) 0x08, (byte) 0x40, (byte) 0x00, (byte) 0x1E, (byte) 0xF1, (byte) 0x10,
                (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x0D, (byte) 0x00, (byte) 0x00, (byte) 0x08, (byte) 0x0C,
                (byte) 0x00, (byte) 0x00, (byte) 0x08, (byte) 0x17, (byte) 0x00, (byte) 0x00, (byte) 0x08, (byte) 0xF7,
    ...
    public void setRepeatingRowsAndColumns(int sheetIndex, int startColumn, int endColumn, int startRow, int endRow) {
        ...
        if (startColumn < -1 || startColumn >= 0xFF) {
            throw new IllegalArgumentException("Invalid column range specification");
        }
        if (endColumn < -1 || endColumn >= 0xFF) {
            throw new IllegalArgumentException("Invalid column range specification");
        }
        ...
        if (nameRecord == null) {
            ...
            // does a lot of the house keeping for builtin records, like setting
            // lengths to zero etc
            isNewRecord = true;
        }
    ...
    /**
     * set the sheet name. Will throw IllegalArgumentException if the name is
     * greater than 31 chars or contains /\?*[]
     *
    ...
    /**
     * Method write - write out this workbook to an Outputstream. Constructs a
     * new POI POIFSFileSystem, passes in the workbook binary representation and
     * writes it out.
     *
