...
/**
 * <p>
 * This exception is provided as a way for API users to throw exceptions from
 * their event handling code. By doing so they abort file processing by the
 * HSSFEventFactory and by catching it from outside the
 * HSSFEventFactory.processEvents method they can diagnose the cause for the
 * abort.
 * </p>
 *
 * <p>
 * The HSSFUserException supports a nested "reason" throwable, i.e. an exception
...
public class HSSFUserException extends Exception {
    ...
    /**
     * <p>
     * Creates a new {@link HSSFUserException} with a message string and a
     * reason.
     * </p>
     */
     ...
     * <code>null</code> if there was no such {@link Throwable}.
     * </p>
     */
