...
public class ValueRecordsAggregate extends Record {
    ...
    public Object clone() {
        ...
        for (Iterator valIter = getIterator(); valIter.hasNext();) {
            CellValueRecordInterface val = (CellValueRecordInterface) ((CellValueRecordInterface) valIter.next())
                    .clone();
            rec.insertCell(val);
        }
        return rec;
    ...
    public void insertCell(CellValueRecordInterface cell) {
        /*
         * if (records.get(cell) == null) { size += (( Record )
         * cell).getRecordSize(); } else { size += (( Record )
         * cell).getRecordSize() - (( Record )
         * records.get(cell)).getRecordSize(); }
         */
...
/*
 * class XYLocator implements Comparable { private int row = 0; private int col =
 * 0; public XYLocator(int row, int col) { this.row = row; this.col = col; }
 *
 * public int getRow() { return row; }
 *
 * public int getCol() { return col; }
 *
 * public int compareTo(Object obj) { XYLocator loc = (XYLocator)obj;
 *
 * if (this.getRow() == loc.getRow() && this.getCol() == loc.getCol() ) return
 * 0;
 *
 ...
 * if (this.getRow() > loc.getRow()) return 1;
 *
 * if (this.getCol() < loc.getCol()) return -1;
 *
 * if (this.getCol() > loc.getCol()) return 1;
 *
 * return -1;
 *  }
 *
 * public boolean equals(Object obj) { if (!(obj instanceof XYLocator)) return
 * false;
 *
 * XYLocator loc = (XYLocator)obj; if (this.getRow() == loc.getRow() &&
 * this.getCol() == loc.getCol() ) return true; return false; }
 *
 *  }
 */
