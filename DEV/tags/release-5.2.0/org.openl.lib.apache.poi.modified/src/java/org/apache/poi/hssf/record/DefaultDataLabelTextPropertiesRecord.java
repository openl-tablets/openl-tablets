 ...
 * characteristics of the preceeding text record. NOTE: This source is
...
public class DefaultDataLabelTextPropertiesRecord extends Record {
    ...
    /**
     * Constructs a DefaultDataLabelTextProperties record and sets its fields
     * appropriately.
     *
     * @param id id must be 0x1024 or an exception will be throw upon validation
     ...
     * record.
     *
     * @return One of CATEGORY_DATA_TYPE_SHOW_LABELS_CHARACTERISTIC
     ...
     * record.
     *
     * @param field_1_categoryDataType One of
