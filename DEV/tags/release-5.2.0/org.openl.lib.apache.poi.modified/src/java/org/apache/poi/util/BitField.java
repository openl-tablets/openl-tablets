...
public class BitField {
     ...
     * as a short. Many users of a BitField will want to treat the specified
     * bits as an int value, and will not want to be aware that the value is
     * stored as a BitField (and so shifted left so many bits)
     *
     * @param holder the short data containing the bits we're interested in
     *
    ...
    /**
     * Are all of the bits set or not? This is a stricter test than isSet, in
     * that all of the bits in a multi-bit set must be set for this method to
     * return true
     *
     * @param holder the int data containing the bits we're interested in
     *
    ...
    /**
     * Is the field set or not? This is most commonly used for a single-bit
     * field, which is often used to represent a boolean value; the results of
     * using it for a multi-bit field is to determine whether *any* of its bits
     * are set
     *
     * @param holder the int data containing the bits we're interested in
     *
     ...
     * Replace the bits with new values.
     *
     * @param holder the int data containint the bits we're interested in
     * @param value the new value for the specified bits
     *
     * @return the value of holder with the bits from the value parameter
     *         replacing the old bits
