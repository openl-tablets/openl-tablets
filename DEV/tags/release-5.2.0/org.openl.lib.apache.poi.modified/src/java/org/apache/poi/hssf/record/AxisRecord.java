...
/**
 * The axis record defines the type of an axis. NOTE: This source is
 * automatically generated please do not modify this file. Either subclass or
...
public class AxisRecord extends Record {
     ...
     *
     * @param id id must be 0x101d or an exception will be throw upon validation
     ...
     *
     * @return One of AXIS_TYPE_CATEGORY_OR_X_AXIS AXIS_TYPE_VALUE_AXIS
     ...
     *
     * @param field_1_axisType One of AXIS_TYPE_CATEGORY_OR_X_AXIS
     *            AXIS_TYPE_VALUE_AXIS AXIS_TYPE_SERIES_AXIS
     */
    ...
    public String toString() {
        ...
        buffer.append("[AXIS]\n");
        buffer.append("    .axisType             = ").append("0x").append(HexDump.toHex(getAxisType())).append(" (")
                .append(getAxisType()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .reserved1            = ").append("0x").append(HexDump.toHex(getReserved1())).append(" (")
                .append(getReserved1()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .reserved2            = ").append("0x").append(HexDump.toHex(getReserved2())).append(" (")
                .append(getReserved2()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .reserved3            = ").append("0x").append(HexDump.toHex(getReserved3())).append(" (")
