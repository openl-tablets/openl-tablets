...
public class POIFSDocument implements BATManaged, BlockWritable, POIFSViewable {
    private class BigBlockStore {
        ...
        BigBlockStore(final POIFSDocumentPath path, final String name, final int size, final POIFSWriterListener writer) {
        ...
        int countBlocks() {
            ...
            if (isValid()) {
                if (writer != null) {
                    rval = (size + POIFSConstants.BIG_BLOCK_SIZE - 1) / POIFSConstants.BIG_BLOCK_SIZE;
                } else {
    ...
    private class SmallBlockStore {
        ...
        SmallBlockStore(final POIFSDocumentPath path, final String name, final int size,
    ...
    public POIFSDocument(final String name, final InputStream stream) throws IOException {
        ...
        DocumentBlock[] bigBlocks = (DocumentBlock[]) blocks.toArray(new DocumentBlock[0]);
    ...
    public POIFSDocument(final String name, final int size, final POIFSDocumentPath path,
