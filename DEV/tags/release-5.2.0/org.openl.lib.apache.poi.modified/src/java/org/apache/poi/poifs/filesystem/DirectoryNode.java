...
public class DirectoryNode extends EntryNode implements DirectoryEntry, POIFSViewable {
    ...
    DirectoryNode(final DirectoryProperty property, final POIFSFileSystem filesystem, final DirectoryNode parent) {
        ...
        while (iter.hasNext()) {
            ...
            if (child.isDirectory()) {
                childNode = new DirectoryNode((DirectoryProperty) child, _filesystem, this);
            } else {
     ...
     *         DirectoryEntry
     *
     * @exception FileNotFoundException if no Entry with the specified name
     *                exists in this DirectoryEntry
     */
