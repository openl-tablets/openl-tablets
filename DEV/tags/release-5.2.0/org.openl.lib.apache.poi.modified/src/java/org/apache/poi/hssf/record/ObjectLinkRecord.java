...
/**
 * Links text to an object on the chart or identifies it as the title. NOTE:
...
public class ObjectLinkRecord extends Record {
     ...
     *
     * @param id id must be 0x1027 or an exception will be throw upon validation
     ...
     *
     * @return One of ANCHOR_ID_CHART_TITLE ANCHOR_ID_Y_AXIS ANCHOR_ID_X_AXIS
     *         ANCHOR_ID_SERIES_OR_POINT ANCHOR_ID_Z_AXIS
     */
     ...
     *
     * @param field_1_anchorId One of ANCHOR_ID_CHART_TITLE ANCHOR_ID_Y_AXIS
    ...
    public String toString() {
        ...
        buffer.append("    .anchorId             = ").append("0x").append(HexDump.toHex(getAnchorId())).append(" (")
                .append(getAnchorId()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .link1                = ").append("0x").append(HexDump.toHex(getLink1())).append(" (")
                .append(getLink1()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .link2                = ").append("0x").append(HexDump.toHex(getLink2())).append(" (")
                .append(getLink2()).append(" )");
        buffer.append(System.getProperty("line.separator"));
