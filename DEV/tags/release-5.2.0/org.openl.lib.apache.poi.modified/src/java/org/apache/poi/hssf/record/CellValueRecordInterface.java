...
/**
 * The cell value record interface is implemented by all classes of type Record
 * that contain cell values. It allows the containing sheet to move through them
 * and compare them.
 *
