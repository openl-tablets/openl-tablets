...
/**
 * The units record describes units. NOTE: This source is automatically
...
public class UnitsRecord extends Record {
     ...
     *
     * @param id id must be 0x1001 or an exception will be throw upon validation
    ...
    public String toString() {
        ...
        buffer.append("[UNITS]\n");
        buffer.append("    .units                = ").append("0x").append(HexDump.toHex(getUnits())).append(" (")
                .append(getUnits()).append(" )");
