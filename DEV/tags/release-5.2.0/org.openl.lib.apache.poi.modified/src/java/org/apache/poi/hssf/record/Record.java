...
/**
 * Title: Record Description: All HSSF Records inherit from this class. It
 * populates the fields common to all records (id, size and data). Subclasses
 * should be sure to validate the id, Company:
 *
...
public abstract class Record {
    ...
    /**
     * Process a continuation record; default handling is to ignore it -- TODO
     * add logging
     *
