...
/**
 * The area record is used to define a area chart. NOTE: This source is
...
public class AreaRecord extends Record {
     ...
     *
     * @param id id must be 0x101A or an exception will be throw upon validation
    ...
    /**
     * Sets the display as percentage field value. results displayed as
     * percentages
     */
