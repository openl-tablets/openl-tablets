...
/**
 * This class provides a wrapper over an OutputStream so that Document writers
 * can't accidently go over their size limits
 *
...
public class DocumentOutputStream extends OutputStream {
     ...
     *
     * @param stream the OutputStream to which the data is actually read
     ...
     *                IOException</code> is thrown if the output stream is
     *                closed or if the writer tries to write too many bytes.
     */
     ...
     *                closed, or if the writer tries to write too much data.
     */
     ...
     *
     * @param totalLimit the actual number of bytes the corresponding document
     *            must fill
