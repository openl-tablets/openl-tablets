...
/**
 * Title: Font Record - descrbes a font in the workbook (index = 0-3,5-infinity -
 * skip 4)
 * <P>
...
public class FontRecord extends Record {
    ...
    static final private BitField italic = new BitField(0x02); // is this font
                                                                // in italics
    // 2 0x04 - reserved bit must be 0
    static final private BitField strikeout = new BitField(0x08); // is this
    ...
    // font has
                                                                    ...
                                                                    // the
                                                                    // center
    static final private BitField macoutline = new BitField(0x10); // some
    ...
    // weird
                                                                    ...
                                                                    // people
                                                                    // anyhow
    static final private BitField macshadow = new BitField(0x20); // some
                                                                    // weird
                                                                    // macintosh
                                                                    // thing....but
                                                                    // who
    ...
    private byte field_7_family; // ?? defined by windows api logfont
                                    // structure?
     ...
     *
     * @param id id must be 0x31 (NOT 0x231 see MSKB #Q184647 for an
    ...
    protected void fillFields(byte[] data, short size, int offset) {
        ...
        if (field_10_font_name_len > 0) {
            if (data[15] == 0) { // is compressed unicode
                field_11_font_name = StringUtil.getFromCompressedUnicode(data, 16, LittleEndian
                        .ubyteToInt(field_10_font_name_len));
            } else { // is not compressed unicode
                field_11_font_name = StringUtil.getFromUnicodeHigh(data, 16, field_10_font_name_len);
            }
        }
    }
    ...
    public int serialize(int offset, byte[] data) {
        ...
        LittleEndian.putShort(data, 2 + offset, (short) (15 + realflen + 1)); // 19 -
                                                                                // 4
                                                                                // (sid/len)
                                                                                // +
                                                                                // font
