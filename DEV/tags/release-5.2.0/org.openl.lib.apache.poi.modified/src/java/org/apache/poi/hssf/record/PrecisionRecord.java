 ...
 * <P>
 * Description: defines whether to store with full precision or what's displayed
 * by the gui (meaning have really screwed up and skewed figures or only think
 * you do!)
 * <P>
...
public class PrecisionRecord extends Record {
    ...
    /**
     * get whether to use full precision or just skew all you figures all to
     * hell.
     *
    ...
    /**
     * set whether to use full precision or just skew all you figures all to
     * hell.
     *
