...
public class SSTRecord extends Record {
     ...
     *
     * @param id must be 0xfc or an exception will be throw upon validation
    ...
    public SSTRecord(final short id, final short size, final byte[] data, int offset) {
        super(id, size, data, offset);
    }

    /**
     * Add a string. Determines whether 8-bit encoding can be used, or whether
     * 16-bit encoding must be used.
     * <p>
     * THIS IS THE PREFERRED METHOD OF ADDING A STRING. IF YOU USE THE OTHER
     * ,code>addString</code> METHOD AND FORCE 8-BIT ENCODING ON A STRING THAT
     * SHOULD USE 16-BIT ENCODING, YOU WILL CORRUPT THE STRING; IF YOU USE THAT
     * METHOD AND FORCE 16-BIT ENCODING, YOU ARE WASTING SPACE WHEN THE WORKBOOK
     * IS WRITTEN OUT.
     *
     ...
     * <P>
     * USE THIS METHOD AT YOUR OWN RISK. IF YOU FORCE 8-BIT ENCODING, YOU MAY
     * CORRUPT YOUR STRING. IF YOU FORCE 16-BIT ENCODING AND IT ISN'T NECESSARY,
     * YOU WILL WASTE SPACE WHEN THIS RECORD IS WRITTEN OUT.
     *
     * @param string string to be added
     * @param useUTF16 if true, forces 16-bit encoding. If false, forces 8-bit
     *            encoding
     *
     * @return the index of that string in the table
     */
    ...
    public boolean equals(Object o) {
        ...
        return ((field_1_num_strings == other.field_1_num_strings)
                && (field_2_num_unique_strings == other.field_2_num_unique_strings) && field_3_strings
    ...
    @Override
    protected void fillFields(final byte[] data, final short size, int offset) {
    ...
    public int serialize(int offset, byte[] data) {
        SSTSerializer serializer = new SSTSerializer(_record_lengths, field_3_strings, getNumStrings(),
                getNumUniqueStrings());
    ...
    /**
     * USE THIS METHOD AT YOUR OWN PERIL: THE <code>addString</code> METHODS
     * MANIPULATE THE NUMBER OF STRINGS AS A SIDE EFFECT; YOUR ATTEMPTS AT
     * MANIPULATING THE STRING COUNT IS LIKELY TO BE VERY WRONG AND WILL RESULT
     * IN BAD BEHAVIOR WHEN THIS RECORD IS WRITTEN OUT AND ANOTHER PROCESS
     * ATTEMPTS TO READ THE RECORD
     *
    ...
    /**
     * USE THIS METHOD AT YOUR OWN PERIL: THE <code>addString</code> METHODS
     * MANIPULATE THE NUMBER OF UNIQUE STRINGS AS A SIDE EFFECT; YOUR ATTEMPTS
     * AT MANIPULATING THE UNIQUE STRING COUNT IS LIKELY TO BE VERY WRONG AND
     * WILL RESULT IN BAD BEHAVIOR WHEN THIS RECORD IS WRITTEN OUT AND ANOTHER
     * PROCESS ATTEMPTS TO READ THE RECORD
     *
     * @param count number of strings
     */
    ...
    public String toString() {
        ...
        for (int k = 0; k < field_3_strings.size(); k++) {
            buffer.append("    .string_" + k + "      = ").append((field_3_strings.get(new Integer(k))).toString())
                    .append("\n");
        }
        buffer.append("[/SST]\n");
    ...
    @Override
    protected void validateSid(final short id) throws RecordFormatException {
        if (id != sid) {
