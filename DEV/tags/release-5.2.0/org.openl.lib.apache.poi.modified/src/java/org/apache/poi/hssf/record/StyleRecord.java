...
public class StyleRecord extends Record {
    ...
    /**
     * get the entire index field (including the type) (see bit getters that
    ...
    public int serialize(int offset, byte[] data) {
        ...
        if (getType() == STYLE_BUILT_IN) {
            LittleEndian.putShort(data, 2 + offset, ((short) 0x04)); // 4
                                                                        // bytes
                                                                        // (8
                                                                        // total)
        } else {
        ...
        if (getType() == STYLE_BUILT_IN) {
            ...
            data[8 + offset] = field_3_string_options;
    ...
    /**
     * set the entire index field (including the type) (see bit setters that
     * reference this method)
     *
     * @param index bitmask
     */
    ...
    public String toString() {
        ...
        if (getType() == STYLE_BUILT_IN) {
            buffer.append("    .builtin_style   = ").append(Integer.toHexString(getBuiltin())).append("\n");
            buffer.append("    .outline_level   = ").append(Integer.toHexString(getOutlineStyleLevel())).append("\n");
        } else if (getType() == STYLE_USER_DEFINED) {
            buffer.append("    .name_length     = ").append(Integer.toHexString(getNameLength())).append("\n");
