 ...
 * so the gui knows how big to make the window holding the spreadsheet document.
 * <P>
...
public class WindowOneRecord extends Record {
    ...
    static final private BitField hidden = new BitField(0x01); // is this
    // window is
                                                                // hidden
    static final private BitField iconic = new BitField(0x02); // is this
    // window is an
                                                                // icon
    static final private BitField reserved = new BitField(0x04); // reserved
    static final private BitField hscroll = new BitField(0x08); // display
    // horizontal
                                                                // scrollbar
    static final private BitField vscroll = new BitField(0x10); // display
    // vertical
                                                                // scrollbar
    static final private BitField tabs = new BitField(0x20); // display tabs
                                                                // at the bottom
    ...
    public int serialize(int offset, byte[] data) {
        ...
        LittleEndian.putShort(data, 2 + offset, ((short) 0x12)); // 18 bytes
                                                                    // (22
                                                                    // total)
