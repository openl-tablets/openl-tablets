 ...
 * text of a chart. NOTE: This source is automatically generated please do not
...
public class FrameRecord extends Record {
     ...
     *
     * @param id id must be 0x1032 or an exception will be throw upon validation
     ...
     *
     * @return One of BORDER_TYPE_REGULAR BORDER_TYPE_SHADOW
     */
    ...
    /**
     * Sets the auto position field value. excel calculates the position
     * automatically
     */
    ...
    /**
     * Sets the auto size field value. excel calculates the size automatically
     * if true
     */
     ...
     *
     * @param field_1_borderType One of BORDER_TYPE_REGULAR BORDER_TYPE_SHADOW
     */
    ...
    public String toString() {
        ...
        buffer.append("[FRAME]\n");
        buffer.append("    .borderType           = ").append("0x").append(HexDump.toHex(getBorderType())).append(" (")
                .append(getBorderType()).append(" )");
