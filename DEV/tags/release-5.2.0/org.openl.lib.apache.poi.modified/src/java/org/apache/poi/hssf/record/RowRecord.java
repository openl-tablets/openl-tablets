...
public class RowRecord extends Record implements Comparable {
    ...
    private short field_5_optimize; // hint field for gui, can/should be set to
                                    // zero
    ...
    public int compareTo(Object obj) {
        ...
        if (getRowNumber() == loc.getRowNumber()) {
            return 0;
        }
        if (getRowNumber() < loc.getRowNumber()) {
            return -1;
    ...
    /**
     * gets the option bitmask. (use the individual bit setters that refer to
     * this method)
     *
     ...
     * @return index to the XF record or bogus value (undefined) if isn't
     *         formatted
     */
    ...
    public void setBadFontHeight(boolean f) {
        field_7_option_flags = badFontHeight.setShortBoolean(field_7_option_flags, f);
    }
    ...
    public void setColapsed(boolean c) {
        field_7_option_flags = colapsed.setShortBoolean(field_7_option_flags, c);
    }
    ...
    public void setFormatted(boolean f) {
        field_7_option_flags = formatted.setShortBoolean(field_7_option_flags, f);
    }
    ...
    /**
     * sets the option bitmask. (use the individual bit setters that refer to
     * this method)
     *
    ...
    public void setOutlineLevel(short ol) {
        field_7_option_flags = outlineLevel.setShortValue(field_7_option_flags, ol);
    }
    ...
    public void setZeroHeight(boolean z) {
        field_7_option_flags = zeroHeight.setShortBoolean(field_7_option_flags, z);
    }
