...
/**
 * The text record is used to define text stored on a chart. NOTE: This source
...
public class TextRecord extends Record {
     ...
     *
     * @param id id must be 0x1025 or an exception will be throw upon validation
     ...
     *
     * @return One of DISPLAY_MODE_TRANSPARENT DISPLAY_MODE_OPAQUE
     */
     ...
     *
     * @return One of HORIZONTAL_ALIGNMENT_LEFT HORIZONTAL_ALIGNMENT_CENTER
     ...
     *
     * @return One of VERTICAL_ALIGNMENT_TOP VERTICAL_ALIGNMENT_CENTER
    ...
    /**
     * Sets the auto color field value. true = automaticly selected colour,
     * false = user-selected
     */
     ...
     *
     * @param field_3_displayMode One of DISPLAY_MODE_TRANSPARENT
     *            DISPLAY_MODE_OPAQUE
     */
     ...
     *
     * @param field_1_horizontalAlignment One of HORIZONTAL_ALIGNMENT_LEFT
     *            HORIZONTAL_ALIGNMENT_CENTER HORIZONTAL_ALIGNMENT_BOTTOM
     ...
     *
     * @param field_2_verticalAlignment One of VERTICAL_ALIGNMENT_TOP
    ...
    public String toString() {
        ...
        buffer.append("[TEXT]\n");
        buffer.append("    .horizontalAlignment  = ").append("0x").append(HexDump.toHex(getHorizontalAlignment()))
                .append(" (").append(getHorizontalAlignment()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .verticalAlignment    = ").append("0x").append(HexDump.toHex(getVerticalAlignment()))
                .append(" (").append(getVerticalAlignment()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .displayMode          = ").append("0x").append(HexDump.toHex(getDisplayMode())).append(" (")
                .append(getDisplayMode()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .rgbColor             = ").append("0x").append(HexDump.toHex(getRgbColor())).append(" (")
                .append(getRgbColor()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        ...
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .options1             = ").append("0x").append(HexDump.toHex(getOptions1())).append(" (")
                .append(getOptions1()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        ...
        buffer.append("         .showCategoryLabelAsPercentage     = ").append(isShowCategoryLabelAsPercentage())
                .append('\n');
        ...
        buffer.append("    .indexOfColorValue    = ").append("0x").append(HexDump.toHex(getIndexOfColorValue()))
                .append(" (").append(getIndexOfColorValue()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .options2             = ").append("0x").append(HexDump.toHex(getOptions2())).append(" (")
                .append(getOptions2()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("         .dataLabelPlacement       = ").append(getDataLabelPlacement()).append('\n');
        buffer.append("    .textRotation         = ").append("0x").append(HexDump.toHex(getTextRotation()))
