...
/**
 * Describes a chart sheet properties record. NOTE: This source is automatically
 * generated please do not modify this file. Either subclass or remove the
 * record in src/records/definitions.
 *
...
public class SheetPropertiesRecord extends Record {
     ...
     *
     * @param id id must be 0x1044 or an exception will be throw upon validation
    ...
    /**
     * Sets the chart type manually formatted field value. Has the chart type
     * been manually formatted?
     */
    ...
    /**
     * Sets the default plot dimensions field value. Indicates that the default
     * area dimensions should be used.
     */
    ...
    /**
     * Sets the do not size with window field value. Do not size the chart when
     ...
     *
     * @param field_2_empty One of EMPTY_NOT_PLOTTED EMPTY_ZERO
     *            EMPTY_INTERPOLATED
     */
    ...
    /**
     * Sets the plot visible only field value. Only show visible cells on the
     * chart.
     */
    ...
    public String toString() {
        ...
        buffer.append("    .flags                = ").append("0x").append(HexDump.toHex(getFlags())).append(" (")
                .append(getFlags()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("         .chartTypeManuallyFormatted     = ").append(isChartTypeManuallyFormatted())
                .append('\n');
        ...
        buffer.append("    .empty                = ").append("0x").append(HexDump.toHex(getEmpty())).append(" (")
                .append(getEmpty()).append(" )");
        buffer.append(System.getProperty("line.separator"));
