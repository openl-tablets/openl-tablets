...
public class ByteField implements FixedField {
     ...
     *
     * @exception ArrayIndexOutOfBoundsException if the offset is not within the
     *                range of 0..(data.length - 1)
     */
     ...
     *
     * @exception ArrayIndexOutOfBoundsException if the offset is out of range
     *                of the bte array
     */
     ...
     *
     * @exception BufferUnderrunException if there is not enough data available
     *                from the InputStream
     * @exception IOException if an IOException is thrown from reading the
     *                InputStream
     */

    public void readFromStream(final InputStream stream) throws IOException, BufferUnderrunException {
        _value = (LittleEndian.readFromStream(stream, LittleEndianConsts.BYTE_SIZE))[0];
    }
     ...
     * @param data the byte array to write the value to
     *
     * @exception ArrayIndexOutOfBoundsException if the offset is out of the
     *                byte array's range
     */
