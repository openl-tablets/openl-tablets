 ...
 * styling. In this release we have read-only support for this record type. The
 * RecordFactory converts this to a set of BlankRecord objects.
 * <P>
...
public class MulBlankRecord extends Record {
    ...
    protected void fillFields(byte[] data, short size, int offset) {
        ...
        field_4_last_col = LittleEndian.getShort(data, (field_3_xfs.length * 2) + 4 + offset);
    }
