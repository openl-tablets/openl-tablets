...
/**
 * Not implemented yet. May commit it anyway just so people can see where I'm
 * heading.
 *
...
public class LinkedDataFormulaField implements CustomField {
    ...
    public Stack getFormulaTokens() {
        return (Stack) formulaTokens.clone();
    }
    ...
    public void toString(StringBuffer buffer) {
        for (int k = 0; k < formulaTokens.size(); k++) {
            buffer.append("Formula ").append(k).append("=").append(formulaTokens.get(k).toString()).append("\n")
