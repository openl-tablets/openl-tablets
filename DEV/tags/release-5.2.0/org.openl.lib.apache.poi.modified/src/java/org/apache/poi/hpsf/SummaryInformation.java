...
public class SummaryInformation extends SpecialPropertySet {
    ...
    /**
     * <p>
     * Returns the stream's application name (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the stream's author (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the stream's character count or 0 if the {@link
    ...
    /**
     * <p>
     * Returns the stream's comments (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the stream's creation time (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the stream's edit time (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the stream's keywords (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the stream's last author (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the stream's last printed time (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the stream's last save time (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the stream's revision number (or <code>null</code>).
     * </p>
     *
     ...
     * if there is no security on the document. Use {@link #wasNull} to
    ...
    /**
     * <p>
     * Returns the stream's subject (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the stream's template (or <code>null</code>).
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the stream's thumbnail (or <code>null</code>) <strong>when
     * this method is implemented. Please note that the return type is likely to
     * change!</strong>
     * </p>
     *
     * <p>
     ...
     * </a>. However, we won't do any conversion into any image type but instead
    ...
    /**
     * <p>
     * Returns the stream's title (or <code>null</code>).
     * </p>
     *
