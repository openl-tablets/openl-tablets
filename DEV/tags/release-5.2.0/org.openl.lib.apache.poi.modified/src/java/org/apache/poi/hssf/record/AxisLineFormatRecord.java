...
/**
 * The axis line format record defines the axis type details. NOTE: This source
...
public class AxisLineFormatRecord extends Record {
     ...
     *
     * @param id id must be 0x1021 or an exception will be throw upon validation
     ...
     *
     * @return One of AXIS_TYPE_AXIS_LINE AXIS_TYPE_MAJOR_GRID_LINE
     *         AXIS_TYPE_MINOR_GRID_LINE AXIS_TYPE_WALLS_OR_FLOOR
     */
     ...
     *
     * @param field_1_axisType One of AXIS_TYPE_AXIS_LINE
     *            AXIS_TYPE_MAJOR_GRID_LINE AXIS_TYPE_MINOR_GRID_LINE
