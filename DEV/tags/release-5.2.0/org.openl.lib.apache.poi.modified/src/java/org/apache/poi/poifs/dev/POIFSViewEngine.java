...
public class POIFSViewEngine {
     ...
     * @param drilldown if true, and the object implements POIFSViewable,
     *            inspect the objects' contents (recursively)
    ...
    public static List inspectViewable(final Object viewable, final boolean drilldown, final int indentLevel,
