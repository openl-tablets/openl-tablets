...
public class NameRecord extends Record {
    ...
    public NameRecord(byte builtin, short index) {
        this();
        field_12_builtIn_name = builtin;
        setOptionFlag((short) (getOptionFlag() | OPT_BUILTIN));
        setNameTextLength((byte) 1);
        setEqualsToIndexToSheet(index); // the extern sheets are set
                                                // through references
    ...
    protected void fillFields(byte[] data, short size, int offset) {
        ...
        /*
         * temp: gjs if (isBuiltInName()) { // DEBUG // System.out.println(
         * "Built-in name" );
         *
         ...
         *  // DEBUG // System.out.println( field_12_name_text );
         *
         * field_13_raw_name_definition = new byte[
         * field_4_length_name_definition ]; System.arraycopy( data, 16 +
         * offset, field_13_raw_name_definition, 0,
         * field_13_raw_name_definition.length );
         *  // DEBUG // System.out.println( HexDump.toHex(
         * field_13_raw_name_definition ) ); } } else {
         */
        ...
        field_12_name_text = StringUtil.getFromCompressedUnicode(data, 15 + offset, LittleEndian
                .ubyteToInt(field_3_length_name_text));

        int start_of_name_definition = 15 + field_3_length_name_text;
        field_13_name_definition = getParsedExpressionTokens(data, field_4_length_name_definition, offset,
    ...
    private Stack getParsedExpressionTokens(byte[] data, short size, int offset, int start_of_expression) {
        ...
        try {
            ...
            // + uoe.getMessage() );
            log.log(POILogger.WARN, "Unknown Ptg " + uoe.getMessage());
            field_13_raw_name_definition = new byte[size];
            System.arraycopy(data, offset, field_13_raw_name_definition, 0, size);
            return null;
        }
    ...
    public int getTextsLength() {
        ...
        result = getNameTextLength() + getDefinitionTextLength() + getDescriptionTextLength() + getHelpTopicLength()
                + getStatusBarLength();
    ...
    public boolean isBuiltInName() {
        return ((getOptionFlag() & OPT_BUILTIN) != 0);
    }
    ...
    public int serialize(int offset, byte[] data) {
        ...
        /*
         * temp: gjs if (isBuiltInName()) { LittleEndian.putShort( data, 2 +
         * offset, (short) ( 16 + field_13_raw_name_definition.length ) );
         *
         * data[19 + offset] = field_12_builtIn_name; System.arraycopy(
         * field_13_raw_name_definition, 0, data, 20 + offset,
         * field_13_raw_name_definition.length );
         *
         * return 20 + field_13_raw_name_definition.length; } else {
         */
        ...
        if (field_13_name_definition != null) {
            ...
            System.arraycopy(field_13_raw_name_definition, 0, data, start_of_name_definition + offset,
                    field_13_raw_name_definition.length);
        }
    ...
    public void setAreaReference(String ref) {
        ...
        if (ra.hasRange()) {
            ...
            setDefinitionTextLength((short) ptg.getSize());
        } else {
            ptg = new Ref3DPtg();
    ...
    /**
     * sets the index number to the extern sheet (thats is what writen in
     * documentation but as i saw , it works differently)
     *
    ...
    public String toString() {
        ...
        buffer.append("    .Formula data (RPN token array without size field)      = ").append(
                HexDump.toHex(((field_13_raw_name_definition != null) ? field_13_raw_name_definition : new byte[0])))
                .append("\n");

        buffer.append("    .Menu text (Unicode string without length field)        = ").append(
                field_14_custom_menu_text).append("\n");
        buffer.append("    .Description text (Unicode string without length field) = ").append(
                field_15_description_text).append("\n");
        buffer.append("    .Help topic text (Unicode string without length field)  = ")
        ...
        if (field_13_raw_name_definition != null) {
            buffer.append(org.apache.poi.util.HexDump.dump(field_13_raw_name_definition, 0, 0));
        }
        buffer.append("[/NAME]\n");
