...
public class HexDump {
     ...
     *
     * @exception ArrayIndexOutOfBoundsException if the index is outside the
     *                data array's bounds
     ...
     * @param index initial index into the byte array
     *
     * @exception IOException is thrown if anything goes wrong writing the data
     *                to stream
     * @exception ArrayIndexOutOfBoundsException if the index is outside the
     *                data array's bounds
    ...
    public synchronized static void dump(final byte[] data, final long offset, final OutputStream stream,
            final int index) throws IOException, ArrayIndexOutOfBoundsException, IllegalArgumentException {
     ...
     */
    public synchronized static void dump(final byte[] data, final long offset, final OutputStream stream,
            final int index, final int length) throws IOException, ArrayIndexOutOfBoundsException,
     ...
     * @param start The index to use as the starting position for the left hand
     *            side label
     * @param bytesToDump The number of bytes to output. Use -1 to read until
     *            the end of file.
     */
