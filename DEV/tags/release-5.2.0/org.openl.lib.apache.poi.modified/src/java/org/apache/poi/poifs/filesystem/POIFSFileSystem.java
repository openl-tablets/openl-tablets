...
public class POIFSFileSystem implements POIFSViewable {
    ...
    public POIFSFileSystem(final InputStream stream) throws IOException {
        ...
        processProperties(SmallBlockTableReader.getSmallDocumentBlocks(data_blocks, properties.getRoot(),
                header_block_reader.getSBATStart()), data_blocks, properties.getRoot().getChildren(), null);
    }
     ...
     *
     * @exception IOException if the document does not exist or the name is that
     *                of a DirectoryEntry
     */
    ...
    private void processProperties(final BlockList small_blocks, final BlockList big_blocks, final Iterator properties,
            final DirectoryNode dir) throws IOException {
        while (properties.hasNext()) {
            ...
            if (property.isDirectory()) {
                ...
                processProperties(small_blocks, big_blocks, ((DirectoryProperty) property).getChildren(), new_dir);
            } else {
    ...
    public void writeFilesystem(final OutputStream stream) throws IOException {
        ...
        SmallBlockTableWriter sbtw = new SmallBlockTableWriter(_documents, _property_table.getRoot());
