...
public class StringRecord extends Record {
    ...
    public Object clone() {
        ...
        rec.field_1_string_length = field_1_string_length;
        rec.field_2_unicode_flag = field_2_unicode_flag;
        rec.field_3_string = field_3_string;
        return rec;
    ...
    public void setCompressedFlag(byte unicode_flag) {
        field_2_unicode_flag = unicode_flag;
    }
    ...
    public void setString(String string) {
        field_1_string_length = string.length();
    ...
    /**
     * Throw a runtime exception in the event of a record passed with a
     * differing ID.
     *
