...
public class TypeReader {
     ...
     * @see Variant
     */
    public static Object read(final byte[] src, int offset, int length, final int type) {
        /*
         * FIXME: Support reading more types and clean up this code!
         */
        Object value;
        length = length - LittleEndianConsts.INT_SIZE;
        switch (type) {
            ...
            case Variant.VT_I2: {
                /*
                 * Read a short. In Java it is represented as an Integer object.
                 */
            ...
            case Variant.VT_I4: {
                /*
                 * Read a word. In Java it is represented as a Long object.
                 */
            ...
            case Variant.VT_FILETIME: {
                /*
                 * Read a FILETIME object. In Java it is represented as a Date
                 * object.
                 */
            ...
            case Variant.VT_LPSTR: {
                /*
                 * Read a byte string. In Java it is represented as a String
                 * object. The 0x00 bytes at the end must be stripped.
                 *
                 * FIXME: Reading an 8-bit string should pay attention to the
                 * codepage. Currently the byte making out the property's value
                 * are interpreted according to the platform's default character
                 * set.
                 */
                ...
                value = new String(src, first, (int) (last - first + 1));
                break;
            }
            case Variant.VT_LPWSTR: {
                /*
                 * Read a Unicode string. In Java it is represented as a String
                 * object. The 0x00 bytes at the end must be stripped.
                 */
                final int first = offset + LittleEndianConsts.INT_SIZE;
                long last = first + LittleEndian.getUInt(src, offset) - 1;
            ...
            case Variant.VT_BOOL: {
                /*
                 * The first four bytes in src, from src[offset] to src[offset +
                 * 3] contain the DWord for VT_BOOL, so skip it, we don't need
                 * it.
                 */
