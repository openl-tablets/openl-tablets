 ...
 * label/tickmark frequency. NOTE: This source is automatically generated please
...
public class CategorySeriesAxisRecord extends Record {
     ...
     *
     * @param id id must be 0x1020 or an exception will be throw upon validation
    ...
    /**
     * set true to indicate axis crosses between categories and false to cross
     * axis midway
     *
    ...
    /**
     * Sets the value axis crossing field value. set true to indicate axis
     * crosses between categories and false to cross axis midway
     */
    ...
    public String toString() {
        ...
        buffer.append("    .labelFrequency       = ").append("0x").append(HexDump.toHex(getLabelFrequency())).append(
                " (").append(getLabelFrequency()).append(" )");
        buffer.append(System.getProperty("line.separator"));
        buffer.append("    .tickMarkFrequency    = ").append("0x").append(HexDump.toHex(getTickMarkFrequency()))
