...
public class IdMap
{
	...
	/**
	 * Returns index of either next available empty slot or slot with object.id == id
	 * 
	 * In a rare case when all slots are busy and no object is found it returns -1. It may happen if ratio == 1 (generally bad idea) 
	 *  
	 * @param id
	 * @return
	 */
