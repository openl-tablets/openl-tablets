...
public class StringTransformer {
	...
	public StringTransformer(boolean processBackslash,
	...
	public StringBuilder transform(String src, Map<String, String> map,
			StringBuilder buf) {
	...
	public StringBuilder transform(String src, IVarHolder vars,
			StringBuilder buf) {
				...
				if (c == '}') {
					...
					if (subst == null)
						if (reportNotFoundVarException)
							throw new RuntimeException("Can not find var:"
									+ name);
						else
