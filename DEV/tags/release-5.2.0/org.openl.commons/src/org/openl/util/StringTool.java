...
public class StringTool
{
	...
	public static final String replaceCharsWithStrings(
		String sourceStr,
		char[] replaceFrom,
		String[] replaceTo)
	{
	...
	public static final void replaceCharsWithStrings(
		StringBuffer result,
		String sourceStr,
		CharToStringConverter converter)
	{
	...
	public static final StringBuffer replaceCharsWithStrings(
		StringBuffer result,
		String sourceStr,
		char[] replaceFrom,
		String[] replaceTo)
	...
	public static StringBuffer xmlProperty(
		String key,
		String value,
		StringBuffer buf)
	{
	...
	public static StringBuffer prepareXMLAttributeValue(
		String attrValue,
		StringBuffer buf)
	{
		return replaceCharsWithStrings(
			buf,
			attrValue,
			STRING_TO_XML_REPLACE_FROM,
			STRING_TO_XML_REPLACE_TO);
	}
	...
	public static StringBuffer prepareXMLBodyValue(
			String attrValue,
			StringBuffer buf)
		{
			return replaceCharsWithStrings(
				buf,
				attrValue,
				STRING_TO_XML_BODY_REPLACE_FROM,
				STRING_TO_XML_BODY_REPLACE_TO);
		}
	
	/**
	 * See examples below
	 * Assert.assertEquals("url", StringTool.decapitalizeName("URL", "_"));
	 * Assert.assertEquals("driver", StringTool.decapitalizeName("Driver", "_"));
	 * Assert.assertEquals("test_url", StringTool.decapitalizeName("TestURL", "_"));
	 * Assert.assertEquals("testurl", StringTool.decapitalizeName("testURL", null));
	 * Assert.assertEquals("test_url_code", StringTool.decapitalizeName("TestURLCode", "_"));
	 * Assert.assertEquals("url_code", StringTool.decapitalizeName("URLCode", "_"));
	 */

	public static String decapitalizeName(String capitalized, String separator)
	{
		return decapitalizeName(capitalized, separator, new StringBuffer())
			.toString();
	}
	...
	public static StringBuffer decapitalizeName(
		String capitalized,
		String separator,
		StringBuffer buf)
	{
	...
	/**
	 * Transforms String using the following rule: if c is not selected, convertor is called
	 * to transform it, otherwise c is put into output
	 */
	 ...
	 * to transform it, otherwise c is put into output
	 */
	public static StringBuffer filter(
		String src,
		Selector sel,
		Convertor conv,
		StringBuffer buf)
	...
	public static StringBuffer propetyToLabel(
		String propertyName,
		StringBuffer sb)
	{
	...
	public static String macroSubst(
		String src,
		Map macros,
		char macroDelim,
		MacroKeyHandler mkh)
	{
		return macroSubst(src, macros, macroDelim, mkh, new StringBuffer())
			.toString();
	}

	public static StringBuffer macroSubst(
		String src,
		Map macros,
		char macroDelim,
		MacroKeyHandler mkh,
	...
	{
		return replace(src, toFind, toReplace, true, false, new StringBuffer())
			.toString();
	}
	...
	//  static public String transform(String src, Selector ignore, Convertor append)
	//  {
	//
	//  }
	//
	...
	/**
	 * Create hexadecimal string representation of a specified
	 * number of bytes from array (padded with 0s)
