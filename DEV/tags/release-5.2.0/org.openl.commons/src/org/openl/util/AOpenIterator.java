...
public abstract class AOpenIterator<T> implements IOpenIterator<T>
{
    ...
    public static <T> IOpenIterator<T> merge(IOpenIterator<T> it1,
	    IOpenIterator<T> it2)
    {
	if (isEmpty(it1))
	{
    ...
    static public <E, T> IOpenIterator<E> extend(Iterator<T> it,
	    IOpenIteratorExtender<E, T> mod)
    {
    ...
    static public <T, C> IOpenIterator<C> collect(Iterator<T> it,
	    IConvertor<T, C> ic)
    {
	...
	ModifierIterator(Iterator<T> baseIterator,
		IOpenIteratorExtender<E, T> modifier)
	{
