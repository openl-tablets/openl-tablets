...
public class Version implements Comparable<Version>
{
	...
	public static int findVersionStart(
		String s,
		IVersionStartPatternFinder finder, String pattern)
	{
		int idx = -1;
		int loopProtector = 0;
	...
	static public Version extractVersion(
		String s,
		IVersionStartPatternFinder finder, String pattern)
		throws Exception
	{
	...
	static public class StandardVersionStartPatternFinder
