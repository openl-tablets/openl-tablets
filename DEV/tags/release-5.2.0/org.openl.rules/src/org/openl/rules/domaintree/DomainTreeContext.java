...
/**
 * A context against which dot-path expressions are computed in <code>DomainTree</code>. E.g. if the context
 * contains an object <i>driver</i> of type <code>Driver</code>, a user can construct expressions like
 * <code>driver.age</code>, <code>driver.address.zipcode</code> provided the corresponding classes contain
 * required properties.
 *
