...
public interface ITypeLibrary
{
	 ...
	 * Usually this method will be used in edit mode, not in run-time. But even in edit mode we want to avoid
	 * loading all the classes, especially if we talk about Java classes, so we provide Iterator of Strings,
	 * not the actual IOpenClasses.    
	 * 
