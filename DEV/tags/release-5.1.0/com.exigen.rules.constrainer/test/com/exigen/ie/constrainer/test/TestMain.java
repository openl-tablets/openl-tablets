...
import com.exigen.ie.constrainer.GoalAllSolutions;
...
import com.exigen.ie.constrainer.GoalFloatMinimize;
...
import com.exigen.ie.constrainer.IntValueSelectorMinMax;
...
import com.exigen.ie.constrainer.impl.FloatExpAddExp;
...
//    c.traceExecution();
  ...
  static void mainFromConstrainer(String args[])
  {
   ...
   /*
      (x.more(3)).execute();
      System.out.println(x + " " + y + " " + " " + z + " after x>3");

      Constraint c1 = x.less(y); //c1.name("x<y");

      System.out.println(x + " " + y + " " + " " + z + " before " + c1);
      ...
      (y.less(9)).execute();
      System.out.println(x + " " + y + " " + " " + z + " after y<9");

      (y.lessOrEqual(7)).execute();
      System.out.println(x + " " + y + " " + " " + z + " after y<=7");

      IntVar sum = C.sum(x,y); //sum.name("x+y");
      Constraint c2 = z.equals(sum); //c2.name("z=x+y");
      c2.execute();
  ...
  */
      ...
      Goal solution = new GoalAnd(card.equals(1),
...
//    ConstraintExpLessValue ct = (ConstraintExpLessValue)exp.lessOrEqual(0);
//    ct.post();
...
//    c.trace(vars);
  ...
  static void testGoalFloatMinimize(String args[]) throws Exception
  {
    ...
    System.out.println(fx + " " + fy + " " + " " + fz + " after instantiate fx & fy");
    */
