...
/**
 * An implementation of the IntValueSelector interface that
 * interchanges the selection of the minimal and maximal values
...
public class IntValueSelectorMinMax implements IntValueSelector
{
  ...
  /**
   * Default constructor initializes first selection of the
   * minimum value from the domain of the variable
   */
