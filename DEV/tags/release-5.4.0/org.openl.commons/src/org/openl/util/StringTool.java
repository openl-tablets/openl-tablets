...
public class StringTool {
     ...
     * 
     * @param stringToEscape String to escape values in, may be null
     * @return String with escaped values, <code>null</code> if null string input
     */
    public static String encodeJavaScriptString(String stringToEscape) {
        if (stringToEscape == null) {
            return null;
        }
        
        return encodeJavaStyleString(stringToEscape, true).toString();
    }
     ...
     * @return String with escaped values, <code>null</code> if null string input
     */
    public static String escapeJava(String stringToEscape) {
        if (stringToEscape == null) {
            return null;
        }
        
        return encodeJavaStyleString(stringToEscape, false).toString();
    }
    
    /**
     * <p> Method is copied from <code>org.apache.commons.lang.StringEscapeUtils </code> with
     * bug fix of wrong Java string escaping for forward slash and JavaScript ampersand escaping.
     * </p>
     * 
     ...
     * @return
     */
    public static StringBuffer encodeJavaStyleString(String stringToEscape, boolean isJavaScript) {
        int len = stringToEscape.length();
        StringBuffer buf = new StringBuffer(stringToEscape.length() + 100);

        for (int i = 0; i < len; i++) {
            char ch = stringToEscape.charAt(i);
