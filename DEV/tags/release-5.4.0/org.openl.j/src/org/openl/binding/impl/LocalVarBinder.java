...
public class LocalVarBinder extends ANodeBinder {
    ...
    static public final IBoundNode createLocalVarDeclarationNode(ISyntaxNode node, String name,
            ISyntaxNode initializationNode, IOpenClass varType, IBindingContext bindingContext,
