...
public class OpenlTest
{
  ...
  static public void aTestEvaluateMethod(
    String moduleCode,
    String openl,
    String methodName,
    Object[] params,
    ...
    throws Exception
  {
    ...
    Object res =
      op.evaluateMethod2(
        new StringSourceCodeModule( moduleCode, null),
        methodName,
        JavaOpenClass.getOpenClasses(cc),
        params);
  ...
  public static Object evaluate(String code, String openl)
  ...
  public static Object evaluateFile(String filename, String openl)
    throws Exception
  {
    ...
    throws Exception
  {
    ...
    return evaluate(
      new FileSourceCodeModule(new File(filename), null),
      openl,
      methodName,
      params);
  ...
  public static Object evaluate(
    IOpenSourceCodeModule moduleCode,
    String openl,
    String methodName,
    Object[] params)
    throws Exception
  ...
  public static void aTestEvaluateFile(
    String filename,
    Object result,
    String openl)
    throws Exception
  ...
  public static void aTestEvaluate(String code, Object result, String openl)
    throws Exception
  {
    OpenL op = OpenL.getInstance(openl);
  ...
  static public void aTestMethodFile(
    String moduleFile,
    String openl,
    String methodName,
    Object[] params,
  ...
  public static int aTestOpenlParse(String fileName, String openlName)
    throws Exception
  {
