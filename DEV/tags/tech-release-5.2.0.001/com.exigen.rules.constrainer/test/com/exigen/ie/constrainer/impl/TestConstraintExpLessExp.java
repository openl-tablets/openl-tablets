...
public class TestConstraintExpLessExp extends TestCase {
  ...
  public TestConstraintExpLessExp(String name) {super(name);}
  public static void main(String[] args) {
    TestRunner.run(new TestSuite(TestConstraintExpLessExp.class));
  }

  public void testExecute(){
    IntVar var = C.addIntVar(0, 10, "var1", IntVar.DOMAIN_BIT_FAST),
           var2= C.addIntVar(-2, -1, "var2"),
    ...
    catch(Failure f){fail("test failed due to incorrect work of setMin(int) or setMax(int)");}
