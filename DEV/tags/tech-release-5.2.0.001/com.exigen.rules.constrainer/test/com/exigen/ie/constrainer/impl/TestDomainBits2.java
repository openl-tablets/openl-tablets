...
private Constrainer C = new Constrainer("TestDomainBits2");
  ...
  public TestDomainBits2(String name) {super(name);}
  ...
  public void testRemoveValue()
  {
    ...
    try{
      assertTrue(!di.removeRange(start_min-3, start_min-1)); //nothing is to be done
    }catch(Failure f){fail("it wouldn't ever happen");}
    //intersection of range to be removed and the domain equals to the domain
    try{
    ...
    //intersection is a part of a domain (less than the whole) including left end
    ...
    //intersection is a part of a domain (less than the whole) including right end
    ...
    // intersection is a part of a domain (less than the whole) that doesn't include
  ...
  public void testSetMax()
  {
    ...
    db.forceBits(bitsToBits2(new boolean[]{true, true, true, true, true, false, false, true, false, true, true}));
    try{
      db.setMax(8);
