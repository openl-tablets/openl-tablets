...
public final class TopoSort<T>
{
     ...
     * @return
     */
    static public <T> List<T> sort(List<T> roots, List<T> leaves)
	    throws TopoSortCycleException
    {
	int len = roots.size();
     ...
     * @return
     */
    static public <T> List<T> sort(T[] aryRoots, T[] aryLeaves)
	    throws TopoSortCycleException
    {
     ...
     * @return
     */
    static public <T> List<T> sort(IPair<T>[] pairs)
	    throws TopoSortCycleException
    {
