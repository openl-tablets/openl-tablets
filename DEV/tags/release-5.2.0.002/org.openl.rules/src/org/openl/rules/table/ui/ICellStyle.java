...
/**
 * @author snshor
 * Temporary we copy POI constants in here, we will provide more complicated mapping 
 * once we start using other libraries, if ever
 */
public interface ICellStyle 
{
	...
	/**
	 * 
	 * @return String[12] containing border types [0-3], widths[4-7] and colors [8-11]
	 */
//	String[] cssBorders();
