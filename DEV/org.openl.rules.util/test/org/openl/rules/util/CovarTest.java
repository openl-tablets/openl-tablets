...
public class CovarTest {
    ...
    public void testSampleCovariance() {
        ...
        Assertions.assertEquals(4.0, Covar.covarS(new Float[]{3f, 4f, 8f}, new Float[]{3f, 10f, 8f}));
    ...
    public void testPopulationCovariance() {
        ...
        Assertions.assertEquals(2.6666666666666665, Covar.covarP(new Float[]{3f, 4f, 8f}, new Float[]{3f, 10f, 8f}));
