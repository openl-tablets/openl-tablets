...
class StdDevTest {
    ...
    @Test
    void testStandardPopulationDeviation() {
        ...
        assertEquals(2.160246899469287f, stdevP(3f, 4f, 8f));
        ...
        assertEquals(26.054558142482477, stdevP(1345, 1301, 1368, 1322, 1310, 1370, 1318, 1350, 1303, 1299));
    }
    ...
    public void testSampleStandardDeviation() {
        ...
        assertEquals(2.6457513110645907f, stdevS(3f, 4f, 8f));
        ...
        assertEquals(27.46391571984349, stdevS(1345, 1301, 1368, 1322, 1310, 1370, 1318, 1350, 1303, 1299));
    }
}
