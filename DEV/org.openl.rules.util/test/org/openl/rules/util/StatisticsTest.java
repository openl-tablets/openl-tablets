...
public class StatisticsTest {
    ...
    public void testSampleStandardDeviation() {
        ...
        assertEquals(new BigDecimal("0.707106781186547524400844362104849"), stdevS(BigDecimal.valueOf(3), BigDecimal.valueOf(4)));
    ...
    public void testSampleCovariance() {
        assertNull(covarS((Number[])null, null));
        ...
        assertEquals(0.0, covarS(new Integer[]{10, 4, 8}, new Integer[]{3, 4, 8}), DELTA);
        ...
        assertEquals(new BigDecimal("0.50"), covarS(new BigDecimal[]{BigDecimal.valueOf(3), BigDecimal.valueOf(4)}, new BigDecimal[]{BigDecimal.valueOf(3), BigDecimal.valueOf(4)}));

    }

    @Test
    public void testPopulationCovariance() {
        assertNull(covarP((Number[])null, null));
        ...
        assertEquals(new BigDecimal("0E-33"),
                covarP(new BigInteger[]{BigInteger.valueOf(10), BigInteger.valueOf(4), BigInteger.valueOf(8)},
                        new BigInteger[]{BigInteger.valueOf(3), BigInteger.valueOf(4), BigInteger.valueOf(8)}));
        assertEquals(new BigDecimal("0.25"), covarP(new BigDecimal[]{BigDecimal.valueOf(3), BigDecimal.valueOf(4)}, new BigDecimal[]{BigDecimal.valueOf(3), BigDecimal.valueOf(4)}));

    }

    @Test
    public void testCorrelationCoefficient() {
        assertNull(correl((Number[]) null, null));
        ...
        assertEquals(new BigDecimal("0E+32"),
                correl(new BigInteger[]{BigInteger.valueOf(10), BigInteger.valueOf(4), BigInteger.valueOf(8)},
                        new BigInteger[]{BigInteger.valueOf(3), BigInteger.valueOf(4), BigInteger.valueOf(8)}));
        assertEquals(new BigDecimal("1.000000000000000000000000000000000"), correl(new BigDecimal[]{BigDecimal.valueOf(3), BigDecimal.valueOf(4)}, new BigDecimal[]{BigDecimal.valueOf(3), BigDecimal.valueOf(4)}));
    }

    @Test
    public void testRSQ() {
        assertNull(rsq((Number[])null, null));
        ...
        assertEquals(new BigDecimal("0E+64"),
                rsq(new BigInteger[]{BigInteger.valueOf(10), BigInteger.valueOf(4), BigInteger.valueOf(8)},
                        new BigInteger[]{BigInteger.valueOf(3), BigInteger.valueOf(4), BigInteger.valueOf(8)}));
        assertEquals(new BigDecimal("1.000000000000000000000000000000000"), rsq(new BigDecimal[]{BigDecimal.valueOf(3), BigDecimal.valueOf(4)}, new BigDecimal[]{BigDecimal.valueOf(3), BigDecimal.valueOf(4)}));
    }
    ...
    public void testSlope() {
        ...
        assertEquals(new BigDecimal("0E-33"),
                slope(new BigInteger[] { BigInteger.valueOf(10), BigInteger.valueOf(4), BigInteger.valueOf(8) },
                        new BigInteger[] { BigInteger.valueOf(3), BigInteger.valueOf(4), BigInteger.valueOf(8) }));
        assertEquals(new BigDecimal("1"), slope(new BigDecimal[]{BigDecimal.valueOf(3), BigDecimal.valueOf(4)}, new BigDecimal[]{BigDecimal.valueOf(3), BigDecimal.valueOf(4)}));
    }
    ...
    public void testIntercept() {
        ...
        assertEquals(new BigDecimal("7.333333333333333333333333333333333"),
                intercept(new BigInteger[]{BigInteger.valueOf(10), BigInteger.valueOf(4), BigInteger.valueOf(8)},
                        new BigInteger[]{BigInteger.valueOf(3), BigInteger.valueOf(4), BigInteger.valueOf(8)}));
        assertEquals(new BigDecimal("0.0"), intercept(new BigDecimal[]{BigDecimal.valueOf(3), BigDecimal.valueOf(4)}, new BigDecimal[]{BigDecimal.valueOf(3), BigDecimal.valueOf(4)}));
    }
    ...
    public void testForecast() {
        ...
        assertEquals(new BigDecimal("7.333333333333333333333333333333333"),
                forecast(BigInteger.valueOf(3), new BigInteger[]{BigInteger.valueOf(10), BigInteger.valueOf(4), BigInteger.valueOf(8)},
                        new BigInteger[]{BigInteger.valueOf(3), BigInteger.valueOf(4), BigInteger.valueOf(8)}));
        assertEquals(new BigDecimal("3.0"), forecast(BigDecimal.valueOf(3), new BigDecimal[]{BigDecimal.valueOf(3), BigDecimal.valueOf(4)}, new BigDecimal[]{BigDecimal.valueOf(3), BigDecimal.valueOf(4)}));
    }
}
