...
# 2. Build OpenL Tablets (quick mode)
mvn -DskipTests -T 1C
...
- See [AGENTS.md](AGENTS.md) for AI-assisted development tips
...
4. **Ensure the test suite passes** (`mvn`)
...
```
Add support for Excel table validation
