...
public final class WorkbookEvaluator {
	...
	private ValueEval evaluateAny(EvaluationCell srcCell, int sheetIndex,
		...
		if (srcCell == null || srcCell.getCellType() != Cell.CELL_TYPE_FORMULA) {
            ValueEval result = getValueFromNonFormulaCell(_workbookIx,sheetIndex,srcCell,tracker);
...
//			logDebug("push " + opResult);
     ...
     */
    public CollaboratingWorkbooksEnvironment get_collaboratingWorkbookEnvironment() {
        return _collaboratingWorkbookEnvironment;
    }
    /**
     * @param workbookEnvironment the _collaboratingWorkbookEnvironment to set
     */
    public void set_collaboratingWorkbookEnvironment(
            CollaboratingWorkbooksEnvironment workbookEnvironment) {
        _collaboratingWorkbookEnvironment = workbookEnvironment;
    }
    /**
     * @return the resolver
     */
    public IExternalWorkbookResolver getResolver() {
        return resolver;
    }
    /**
     * @param resolver the resolver to set
     */
    public void setResolver(IExternalWorkbookResolver resolver) {
