...
public class XSSFCellStyle implements CellStyle {
     ...
     */
    public XSSFCellStyle(int cellXfId, int cellStyleXfId, StylesTable stylesSource, XSSFTheme theme) {
        _cellXfId = cellXfId;
    ...
    public XSSFColor getFillBackgroundXSSFColor() {
        ...
        if(fillBackgroundColor.getCTColor().isSetTheme() && _theme != null){
    ...
    public XSSFColor getFillForegroundXSSFColor() {
        ...
        if(fillForegroundColor.getCTColor().isSetTheme() && _theme != null){
