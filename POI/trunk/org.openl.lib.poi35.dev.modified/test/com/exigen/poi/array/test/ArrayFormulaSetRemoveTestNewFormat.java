 ...
 */
public class ArrayFormulaSetRemoveTestNewFormat {
	
	private static TestHelper th;
	private static XSSFWorkbook wb;
	static Log log = LogFactory.getLog(ArrayFormulaSetRemoveTestNewFormat.class);
	
	@BeforeClass
	public  static void readWorkbook(){

			URL url = ArrayFormulaSetRemoveTestNewFormat.class.getClassLoader().getResource("ArrayFormula.xlsm");
			Workbook wb;
			try {
	...
	public static junit.framework.Test suite() {  
		return new JUnit4TestAdapter(ArrayFormulaSetRemoveTestNewFormat.class);
	}
	@Test
