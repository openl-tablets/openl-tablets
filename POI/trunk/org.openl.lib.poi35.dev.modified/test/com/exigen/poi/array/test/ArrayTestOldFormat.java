 ...
 */
public class ArrayTestOldFormat {
	
	private static TestHelper th;
	static Log log = LogFactory.getLog(ArrayTestOldFormat.class);
	
	@BeforeClass
	public  static void readWorkbook(){

		URL url = ArrayTestOldFormat.class.getClassLoader().getResource("ConstantArray.xls");
		Workbook wb;
		try {
