 ...
 */
public class ArrayFormulaEvalTestNewFormat {
	
	private static TestHelper th;
	static Log log = LogFactory.getLog(ArrayFormulaEvalTestNewFormat.class);
	...
	public static junit.framework.Test suite() {  
		return new JUnit4TestAdapter(ArrayFormulaEvalTestNewFormat.class);
	}
