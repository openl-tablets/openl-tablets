...
Each major module has its own `CLAUDE.md` file with specific conventions:
- `/DEV/CLAUDE.md` - Core engine conventions
- `/STUDIO/CLAUDE.md` - Studio conventions (when created)
- `/STUDIO/studio-ui/CLAUDE.md` - React/TypeScript conventions (when created)
- `/WSFrontend/CLAUDE.md` - Web services conventions (when created)

**Always check module-specific CLAUDE.md files before making changes.**
...
1. **Check module-specific CLAUDE.md** - More specific guidance
