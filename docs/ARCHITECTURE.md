...
**Location**: `/WSFrontend/`
**Purpose**: Deploy rules as REST/SOAP web services
...
| **Apache CXF** | 4.1.0 | SOAP web services |
...
**Use Case**: Rules deployed as REST/SOAP services
...
spec:
  ...
  template:
    ...
    spec:
      containers:
      - name: rule-service
        image: openltablets/rule-service:6.0.0
        ports:
        - containerPort: 8080
        env:
