...
- `itest.webservice.rest` - REST services
- `itest.webservice.soap` - SOAP services

**Security Tests**:
- `itest.security` - Authentication/authorization
- `itest.security.cas` - CAS integration
- `itest.security.saml` - SAML integration
