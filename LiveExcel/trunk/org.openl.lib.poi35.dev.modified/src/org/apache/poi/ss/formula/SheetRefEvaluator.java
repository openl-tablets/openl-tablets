...
final class SheetRefEvaluator {
    ...
    public void recalculate(int rowIndex, int columnIndex) {
        _bookEvaluator.evaluate(_sheet.getCell(rowIndex, columnIndex));
    }

    public void setValue(int rowIndex, int columnIndex, ValueEval value) {
        _sheet.getCell(rowIndex, columnIndex).setValue(value);
    }
