...
![](openl-studio-images/0ed3e90037fbfab31576872e5d9b58d7.jpeg)
...
1.  To set up a secure connection for connecting to remote or database-located repositories, select the **Secure connection** check box and fill in the login and password fields.
    ...
    ![](openl-studio-images/05b0bc614e21e2e705d0e76d7518be08.jpeg)
...
2.  To add design or deployment repositories, click **Add** **Repository** and enter required information.
    ...
    ![](openl-studio-images/522f9b767a9ec8f404d460bf60bcf6ef.jpeg)
...
1.  In the **ADMIN** tab, click **Groups & Privileges**.
    ...
    ![](openl-studio-images/57a30f5b0d7de4ae821098ab307a52e0.jpeg)
...
3.  In the **Privilege** area, define the privileges as needed.
    ...
    ![](openl-studio-images/b3f34ff98d6e111209332e0252ed93fb.png)
...
1.  In the list of groups, locate the group that needs to be changed and click the **Edit** icon ![](openl-studio-images/d3ea5213930b8049e191654119114d07.png).
...
1.  Locate the group to be deleted and click the red cross on the right: ![](openl-studio-images/0fda9cdfad6951b6b2345913d0045c36.png).
...
-   If an external group cannot be matched with the OpenL Studio group, that is, no group with such name exists in OpenL Studio, the group is displayed as a collapsed number, for example, +1, and when the value is expanded, the group is highlighted grey.
    ...
    ![](openl-studio-images/ee4a2bedc13ee312f08f2b364d1c3af3.png)
...
-   If an external group is matched with the OpenL Studio group but it does not have the Administrator privilege assigned, the group is highlighted green.
    ...
    ![](openl-studio-images/baeffab9dc6ae249ccc19093751707a5.png)
...
-   If a group has the Administrator privilege, the group is highlighted red in the user table.
    ...
    ![](openl-studio-images/6d6a6bca6559eacb1c0e413629e717cf.png)
...
1.  Click the **Add New User** link.
    ...
    ![](openl-studio-images/2a82416bdc26b5badb9f4f0257104a6d.png)
...
![](openl-studio-images/6d47073a836f7c46f45a187e9211751d.png)
...
1.  In the **Users** list, locate the user for deletion and click the **Delete** icon: ![](openl-studio-images/0fda9cdfad6951b6b2345913d0045c36.png).
2.  Click **OK** in the confirmation dialog.
...
![](openl-studio-images/d6cc06b1b16257286a870e26923da933.jpeg)
...
1.  In the **ADMIN** tab, click **Tags** on the left.
    ...
    ![](openl-studio-images/d2f7222f460ee0e300160cd30bc2e2d2.jpeg)
...
1.  To add a tag type, in the **New Tag Type** field, enter the tag type name and press **Enter** or Tab.
    ...
    ![](openl-studio-images/42641ef9498fcf79828ccd5e3d40d751.jpeg)
...
4.  To edit a tag, click the menu icon ![](openl-studio-images/f2996d868400e9a96780f9111861cfa7.png), select **Edit,** modify the tag, and press **Enter** or click outside the field.
5.  To delete a tag, click the menu icon ![](openl-studio-images/f2996d868400e9a96780f9111861cfa7.png)and select **Delete.**
...
![](openl-studio-images/288b7d29e213832eb063e5b0814defc3.png)
...
4.  Click **Apply All and Restart.**
    ...
    ![](openl-studio-images/0fb7500bee79ff665441b5e318d69fb1.png)
    ...
    *Defining verification emails sender*
    ...
    ![](openl-studio-images/f2cadb07631751bf665a582465aa0486.png)
...
![](openl-studio-images/32efcc3b25c8c305afeb092129199861.png)
...
![](openl-studio-images/a307bbf12b79c2c3869d6f487123e739.png)

*A user initiating verification email resending*

The verification email resembles the following:

![](openl-studio-images/1a395078ab9e92f23d671d175dfe6c67.png)
