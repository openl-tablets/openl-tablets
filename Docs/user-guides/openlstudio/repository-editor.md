...
| Icon                                                             | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| ![](openl-studio-images/8e2af296adafbac75872d0fab66dda6b.png) | Project is closed. It is available only in Design repository and must be opened to copy it to user's workspace.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| ![](openl-studio-images/cf865a109e2be06a20865e2e72d28c8b.png) | Project is opened for viewing. It is copied to user's workspace and can be modified. <br/>If the product is restored from the previous revision, its status is set to **Viewing Revision,** otherwise its status is set to **No Changes.**                                                                                                                                                                                                                                                                                                                                                                 |
| ![](openl-studio-images/2612691cc1108289c7fafbdefb85bdb9.png) | Project is edited by the current user. It is copied to user's workspace and is modified. Other users cannot edit the project. <br/>To save changes, the project must be saved.                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ![](openl-studio-images/92724abe4cfd4fd2ef78a6586a595ba0.png) | Project is closed by the current user but edited by another user (Closed – Locked). Current user cannot edit the project.                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ![](openl-studio-images/0911850e55e28478fb5a39990c19ba03.png) | Project is opened for viewing by the current user but edited by another user (Viewing Revision - Locked). <br/>Current user cannot edit the project but can browse the project in Rules Editor.                                                                                                                                                                                                                                                                                                                                                                                                            |
| ![](openl-studio-images/2c331509e4c7655949ad8055eb387d98.png) | Project exists only in user's workspace but not in Design repository (Local). Other users do not see this project. <Br/>User can delete the project or import it into Design repository as described in the [Creating Projects in Design Repository](#creating-projects-in-design-repository).                                                                                                                                                                                                                                                                                                             |
| ![](openl-studio-images/4d37af564602b82442d8138a551c3229.png) | Project is marked for deletion. In OpenL Studio, deletion of a project takes place in the following phases: <br/>- Deleting a project: Project is removed from user's workspace and marked for deletion. <br/>In this phase, the project can be restored using the undelete function. <br/>For information on deleting a project, see [Deleting a Project](#deleting-a-project). <br/><br/>- Erasing a project: Deleted project is permanently removed from Design repository. <Br/>After this phase, the project cannot be restored. <br/>For information on erasing a project, see [Erasing a Project](#erasing-a-project). |
...
To group projects by repository or tag types, click the **Group Projects** icon ![](openl-studio-images/f418655e8c30ace7c19b27edcce5d992.png)and select the required values. Please note that values of tags for grouping are taken from the most recent version of a project. If user has changed project tags in an opened project, a project is required to be saved in order for a change to be reflected in a tree. For more information on tag definition for a project, see [Managing Tags](#managing-tags).

![](openl-studio-images/6591bdf7659bde341a89431f286763f5.jpeg)

*Grouping projects by tags*

To expand or collapse the repository tree, use the expand and collapse icons ![](openl-studio-images/70ea87784e324e0c231ea3cc4cad4bef.png).

To view archived deleted projects, click the advanced filter icon ![](openl-studio-images/2ad8c5cb644cb4a787c63fa8252298ec.png)and clear that the **Hide deleted projects** option.
...
1.  Navigate to the required template and click its name.
    ...
    ![](openl-studio-images/378491ed832403ed3b92dbde1f8ee639.jpeg)
...
1.  For project templates that store files with project rules, create subfolders.
    ...
    ![](openl-studio-images/2dad049ecf5a852d113b0f8c9410636b.jpeg)
...
4.  If required, repeat the previous step to add more files for the project.
    ...
    ![](openl-studio-images/1ee3493194983039dc558e5868ccdf91.jpeg)
...
4.  To remove an uploaded file, click **Clear**.
    ...
    ![](openl-studio-images/a95a35530e08fe3a9c233f5bfa430bdc.png)
...
3.  Click the **Add** button, locate the necessary zip archive and click **Open**.
    ...
    ![](openl-studio-images/f0f5790682bf45cfc5361e3d73dec561.jpeg)
...
2.  In the **Create Project from** dialog, click the **Workspace** tab.
    ...
    ![](openl-studio-images/1669f8514ccf7c91f556df66ef3272f7.jpeg)
...
![](openl-studio-images/4ead93a992dcee3b4f8047f2ca2be884.jpeg)
...
![](openl-studio-images/9188d1765621c994c526b6f5bc3ac4cf477854b2.png)
...
![](openl-studio-images/f760348e2e6acd823dd72a04b9841f40.jpeg)
...
2.  In the **Project Revisions** field, select the required revision.
    ...
    ![](openl-studio-images/1d03e5defebfa102b32e946799ba24f0.png)
...
2.  Click the **Revisions** tab.
    ...
    ![](openl-studio-images/900b1b5325f41510b5214427d81320f5.jpeg)
...
1.  In the project tree, select the project, and, in the right pane, click **Save**.
    ...
    ![](openl-studio-images/a0454a137ca0961bb3048aabafcdc453.jpeg)
...
![](openl-studio-images/261485d1d65f649a6c119254b97a1fbf.jpeg)
...
1.  In the right pane, click **Upload File**.
    ...
    ![](openl-studio-images/11c044d881e270ea6f5b83f7171a6bca.png)
...
1.  Perform one of the following steps as required:
    ...
    ![](openl-studio-images/6362ea02fd15e637fa016cc13ea4fa9f.png)
    
    *Deleting a project element*
    
    -   To delete an element inside the parent folder, select that folder, click **Elements** to expand the folder and then click **Delete** ![](openl-studio-images/b3283d9b02e8eafc5dfac475347f0c88.png)at the right of the item to be deleted.
    
    ![](openl-studio-images/fbc10c0636ac762909f8bf7c611af605.png)
...
2.  In the upper left corner of the page, click **Copy file** ![](openl-studio-images/26296206519d54461c96e40f613604dc.png).
...
5.  In the **New File Name** field, enter the file name.
    ...
    ![](openl-studio-images/5f5774680d54bc0b7b9f1a626f1beb5e.png)
...
1.  Perform one of the following steps as required:
    ...
    -   Click **Projects** in Navigator to get a list of projects, navigate to the project you want to copy and click the corresponding **Copy** item **![](openl-studio-images/d2a06016b3a5f28c837d524b8f20f8fa.png)** on the right.
...
1.  Perform one of the following steps as required:
    ...
    -   Click **Projects** in Navigator to get a list of projects, navigate to the project you want to remove and click the corresponding **Delete** item **![](openl-studio-images/b3283d9b02e8eafc5dfac475347f0c88.png)** on the right.
...
1.  In the **Deploy Configurations** tree, select the deploy configuration and, in the right pane, select the **Projects to Deploy** tab.
    ...
    ![](openl-studio-images/8c27bc98646284c2e73349402468d445.png)
...
1.  To add a new project to deploy, click **Add** and specify the repository, project name, branch, and revision to be included in the deploy configuration.
    ...
    ![](openl-studio-images/70ed8c6681d4577de2c20b772582d2cd.jpeg)
...
![](openl-studio-images/752a0bdd9ba60a9ad00a1f09abd1c33e.png)
...
![](openl-studio-images/704ba6cdd0eb6b0a3dd811706c9cdfcd.png)
...
2.  In the right pane, click **Deploy**.
    ...
    **Note:** The **Deploy** button is disabled if the selected project has the Local status or if it is edited.
    ...
    ![](openl-studio-images/568c1427aaa0589680b223a5234bae17.png)
...
![](openl-studio-images/c02fb4bd07921f53f8b0f1010aa04d18.png)
...
1.  Click **Save Configuration**.
    ...
    ![](openl-studio-images/cb56c11b5d220dbe316410763acd311d.png)
...
![](openl-studio-images/a509cab9401acecd82d157e44ebaf70c.png)
...
2.  In the scroll list, select the services version.
    ...
    ![](openl-studio-images/051ff8dd63dc3613e9d8ba08404bcfba.png)
...
2.  In the right pane, click **Compare**.
    ...
    ![](openl-studio-images/a06d3841680295798c7a25bfdb6af501.png)
...
![](openl-studio-images/dfdde8607313b1f7db276af495834e3f.png)
...
1.  Perform one of the following steps as required:
    ...
    -   Click **Projects** in Navigator to get a list of projects, navigate to the project that needs to be removed and click the corresponding **Unlock** item ![](openl-studio-images/db81abb8713c03cc7413fc20bf951cbb.png) on the right.
1.  In the confirmation window, click **OK**.
...
2.  In the project tree, select the deployment repository to be browsed (repositories are marked by ![](openl-studio-images/55814fc7139e046c446b4c3e39762201.png) icon).
...
![](openl-studio-images/c9186ff78edf3757eaba4fb1492cfa88.png)
