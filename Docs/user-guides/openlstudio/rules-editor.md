...
![](openl-studio-images/e157a7677f40ede17006495ee0d22c16.png)
...
![](openl-studio-images/4fc34f40b2046e82254cff4c11c44b04.jpeg)
...
![](openl-studio-images/f84cc5d3c3896a414e52678b54291295.jpeg)
...
1.  To save the edited project, click **Save** ![](openl-studio-images/065a365a7725869b00c56a0709886a2e.png).
...
![](openl-studio-images/d1ec1ce13567b835cd0af2ac8e60671d.png)
...
![](openl-studio-images/971b9e39f9b504f6f2e6068dc53dfb13.png)
...
![](openl-studio-images/6b03d1b84a9d8ba45eaee2013001c312.jpeg)
...
1.  To modify module configuration, such as module name, path, and included or excluded methods, in the **Module** page place the mouse cursor over the module name and click **Edit** ![](openl-studio-images/a7e355d8941719d3c854bc573f7b5e57.png).
    
    ![](openl-studio-images/10843000fe9311158adc8206237ae958.png)
    
    *Initiating module editing*
    
    ![](openl-studio-images/97bcd40ba7866874989f723a25f51534.png)
    
    *Editing module information*
    
1.  To save the changes, click **Save** ![](openl-studio-images/065a365a7725869b00c56a0709886a2e.png).
...
2.  In the top line menu, select **More** **\>** **Local** **Changes**.
    ...
    ![](openl-studio-images/1a554098a1f584fa7f6d0b6922d05b8b.jpeg)
    
    *Displaying the Changes window*
    
    When a project is modified, upon clicking the **Save** icon ![](openl-studio-images/7cb3dcd35c8672b10e5c931de331b408.png), a temporary version of the module is created, and it appears in the list of local changes. When project update is complete, clicking **Save** removes all temporary versions from Local Changes, and a new version is added to the list of revisions.
    
    ![](openl-studio-images/be93798eadb10fd4553148886ad8012d.jpeg)
...
1. To compare the changes, select check boxes for two required versions and click **Compare**.
    ...
    ![](openl-studio-images/6e36755fc51d6b93b3a7d9632c5a36dc.jpeg)
    ...
    *Comparing module versions*
    ...
    ![](openl-studio-images/9140048a2c374acb80aa5246c9f03de6.jpeg)
...
1. To view the changes, click the required table.
    ...
    ![](openl-studio-images/3356efaccc4fc27518b62adbd2f70379.jpeg)
...
1.  Do one of the following:
    -   To create a copy of a module using the **Project** page, in the project tree, select a project which module must be copied, in the modules list, put the mouse cursor over the selected module name, and click **Copy Module** ![](openl-studio-images/01c68072b080e6fc98abdeaf4d55020c.png).
    -   To create a copy of a module using the **Module** page, in the project tree, select a module to be copied, put the mouse cursor over the module name, and click **Copy Module** ![](openl-studio-images/01c68072b080e6fc98abdeaf4d55020c.png).
...
![](openl-studio-images/d037bbf438749fbad9509e1f977335ee.png)
...
1.  Do one of the following:
    -   To create a copy of a module using the **Project** page, put the mouse cursor over multiple modules, click **Copy Module** ![](openl-studio-images/01c68072b080e6fc98abdeaf4d55020c.png), in the window that appears, click **Select module,** and in the **File Path** drop-down list, select the name of the module to copy.
    -   To create a copy of a module using the **Module** page, in the project tree, select a module to copy, put the mouse cursor over the module name, and click **Copy Module** ![](openl-studio-images/01c68072b080e6fc98abdeaf4d55020c.png).
...
![](openl-studio-images/5be694816c896cc8d727493c5bdf2738.png)
...
3.  Put the mouse cursor over the **Dependencies** label and click **Manage Dependencies** ![](openl-studio-images/a7e355d8941719d3c854bc573f7b5e57.png) .
4.  In the window that appears, update information as required and click **Save**.

![](openl-studio-images/c100aa6a4ed53a17fe232c2a83d820fe.png)
...
| Icon                                                             | Table type                                                                           |
|------------------------------------------------------------------|--------------------------------------------------------------------------------------|
| ![](openl-studio-images/addf20fe8e0cb28afd74fc8b07709933.png) | Decision table.                                                                      |
| ![](openl-studio-images/0871b3ba511933c19e83ccb9a3ceead5.png) | Decision table with unit tests.                                                      |
| ![](openl-studio-images/99b625f9f4b96684375f87c9222b6587.png) | Column match table.                                                                  |
| ![](openl-studio-images/82aa2454028e7fca9530156d56d57910.png) | Column match table with unit tests.                                                  |
| ![](openl-studio-images/409461d40e46b5ada7f90053fefe7271.png) | Tbasic table.                                                                        |
| ![](openl-studio-images/7a5382921ca4c9ebf92e7143b88d4698.png) | Tbasic table with unit tests.                                                        |
| ![](openl-studio-images/5a849e452c0675f14dc1ece015603e3a.png) | Data table.                                                                          |
| ![](openl-studio-images/463a0c232c78123525d2ca20723adb9f.png) | Datatype table.                                                                      |
| ![](openl-studio-images/61fe16bb498a3465544df36be6eed15a.png) | Method table.                                                                        |
| ![](openl-studio-images/4443ef45bf879803759ef413590f52e5.png) | Unit test table.                                                                     |
| ![](openl-studio-images/ad615071b0fc21923ff85aa93e239faf.png) | Run method table.                                                                    |
| ![](openl-studio-images/a3b08852e2becc41e47eb6a8e69011bf.png) | Environment table.                                                                   |
| ![](openl-studio-images/8fbbd353411228d87f1a4229e893ddb5.png) | Property table.                                                                      |
| ![](openl-studio-images/68dc4948dbd4c8482b80fd5e6b4784d8.png) | Table not corresponding to any preceding types. Such tables are considered comments. |
| ![](openl-studio-images/ba46e66267834235c3ad9244cf2924bc.png) | Spreadsheet table, Constants table.                                                  |
...
1.  In the module tree, select the required table.
    ...
    ![](openl-studio-images/58be1b760b04808e8744445b19341d1e.png)
...
2.  To switch the table to the edit mode, perform one of the following steps:
    ...
    ![](openl-studio-images/23b8fc70e8af17b2a2e789750dd31557.png)
    ...
    *Table in the edit mode*
    ...
    | Button                                                           | Description                                             |
    |------------------------------------------------------------------|---------------------------------------------------------|
    | ![](openl-studio-images/d8c95f4dcb60bd3fb575f1b12ecace96.png) | Saves changes in table.                                 |
    | ![](openl-studio-images/04ac7759c44374e90e413dc2fd217f5b.png) | Reverses last changes.                                  |
    | ![](openl-studio-images/225b46e5d5a80065fcc332f22e1e5140.png) | Reapplies reversed changes.                             |
    | ![](openl-studio-images/2b0484ad327df2659d21f31e5b7ab595.png) | Inserts a row.                                          |
    | ![](openl-studio-images/848196d133a9067249f07a16602a64c4.png) | Deletes a row.                                          |
    | ![](openl-studio-images/b060076776efca7ffd3020a7ceb07b37.png) | Inserts a column.                                       |
    | ![](openl-studio-images/d2e889488d2236d03b9f4b7d8de3d38e.png) | Deletes a column.                                       |
    | ![](openl-studio-images/e417a6a5c7848ad41cb079683eef7332.png) | Aligns text in currently selected cell with left edge.  |
    | ![](openl-studio-images/b0373d015cd2a67cca7bf335c5429a48.png) | Centers text in currently selected cell.                |
    | ![](openl-studio-images/960cc5b05fb167ba3ad1351de5cb7530.png) | Aligns text in currently selected cell with right edge. |
    | ![](openl-studio-images/b08d515ccfe8607bc5e5e61704f2c7ae.png) | Make the text font **bold**.                            |
    | ![](openl-studio-images/3431a1b839f979aecc47dc528ac78cf8.png) | Applies *italics* to the cell text.                     |
    | ![](openl-studio-images/33b8ec973f2a791d1adff82bc943b72d.png) | Underlines the cell text.                               |
    | ![](openl-studio-images/fbe95646e37bb452bdf33c83d016b7ce.png) | Sets the fill color.                                    |
    | ![](openl-studio-images/069066ebe2c7e5132e9e4d3807e8d3ac.png) | Sets the font color.                                    |
    | ![](openl-studio-images/a42383f84cfac3f73c1a13be01afae72.png) | Decreases indent.                                       |
    | ![](openl-studio-images/4ab19634e2840ef5dc3487e13a935ef3.png) | Increases indent.                                       |
...
1.  To save changes, click **Save** ![](openl-studio-images/d8c95f4dcb60bd3fb575f1b12ecace96.png).
    
    If a table contains an error, the appropriate message is displayed.
    
    ![](openl-studio-images/2f31884fc61a15b01c31a3a6a48b10a0.png)
    
    *Example of an error in a table*
    
    The arrow under the message allows viewing all stack trace for this error.
    
    ![](openl-studio-images/4ae30d4d267b3669a0db34507004d66a.png)
...
![](openl-studio-images/be17a7b133234d35936a0acd42f9a517.jpeg)
...
![](openl-studio-images/0cbde5698b690b1c3a9661fb2f2d75fd.png)
...
![](openl-studio-images/d41e56df8884b92092a3f1a0bc6a0701.png)
...
![](openl-studio-images/35139e023741aaed3100495bf6d2ac1e.png)
...
1.  Double click the cell to be edited.
    ...
    ![](openl-studio-images/98662bef33f0aeeae129dc052be8b6b5.png)
...
2.  Click **Done** to complete.
    ...
    ![](openl-studio-images/ebc70e182e94de0d5ff4b5cb7ad638fc.png)
...
1.  To modify the range in Range Editor, double click the cell with the [22-23) range.
    ...
    ![](openl-studio-images/aac1251fcc154839730f9c216b011783.png)
...
2.  Click **Done** to save the work.
    ...
    ![](openl-studio-images/e67b81800fa38f0c47f6955fb4649d90.png)
...
2.  Click the **Copy Table** icon ![](openl-studio-images/42a58d83f10d78964b87c3a1efadd92b.png).
    The system displays the **Copy Table** form with **New Table** selected by default.
    
    ![](openl-studio-images/c325ec08c39fe56d3c8df7a33ff7ac63.png)
...
![](openl-studio-images/7fa01db8589e92f2ef054e15a86be21c.png)
...
![](openl-studio-images/5419dbed08d7b6086179295a8e07bcb2.png)
...
1.  To launch an advanced search, click the arrow to the right of the search window.
    ...
    ![](openl-studio-images/614dc76daa751a30bd43a633a830e3cc.png)
...
1.  In the **Search** field on the top, select whether search must be performed within the current module, or within the project, or within the current project and its dependent projects.
    ...
    ![](openl-studio-images/ad19dceb5bf472f91f290e5afb6883de.png)
...
3.  To remove a property, click the cross icon to the right of the property.
    ...
    ![](openl-studio-images/bba2ff05d014679939d8b822b0fcaa39.png)
...
![](openl-studio-images/2db8c71d7acd6671d5d2a9be6af19862.png)
...
2.  In the list of table types, select **Datatype Table** and click **Next**.
    ...
    ![](openl-studio-images/9ca72d99ad66b8bb821f8238d444cef9.png)
...
1.  Enter the data type name and if necessary, select the existing data type as a parent.  
    ...
    ![](openl-studio-images/a7dc6f519d39b98e1c58470ba125806b.png)
...
1.  To define data type fields, click **Add parameter**, specify values as required, and then click **Next**.
    ...
    ![](openl-studio-images/caca6cab092c8498fea98e1896d13408.png)
...
1.  To indicate the new datatype table location, in the **Select destination** window, select an existing sheet, or in the **New** field, enter the new sheet name.
    ...
    ![](openl-studio-images/961137f64696a6b67a41c59a5b4678b9.png)
...
2.  Select the **Data Table** item and click **Next**.
    ...
    ![](openl-studio-images/3dba085b0981250107ed82677e8f485a.png)
    
    *Initiating data table creation*
    
1.  Select the table type, enter the table name, and click **Next**.
    
    ![](openl-studio-images/540b45c84fba045b2ff255ddb7be274b.png)
...
1.  Define the table columns configuration.
    ...
    ![](openl-studio-images/5d6090603e9b5d711dba74616dcb2f2e.png)
...
1.  To indicate new data table location, in the **Select destination** window, select an existing sheet, or in the **New** field, enter the new sheet name.
    ...
    ![](openl-studio-images/eef90b784fd45397c68a302adc74fd30.png)
...
2.  Select **Test Table** and click **Next**.
    ...
    ![](openl-studio-images/969e2826ecb4728150476fe6f5c40eb5.png)
    
    *Creating a test table*
    
1.  In the **Select table** window, select the rule table and click **Next**.
    
    ![](openl-studio-images/8206cc985b31891b6cdbe9cf5842a0f1.png)
...
1.  In the **Input name** window, if necessary, modify the generated test table name and click **Next**.
    ...
    ![](openl-studio-images/c1ee4957624b94f72f8cdde69a3d91fe.png)
...
1.  To define the test table location, in the **Select destination** window, select an existing sheet, or in the **New** field, enter the new sheet name.
    ...
    ![](openl-studio-images/5be60ad6f55676120ba0114712f827dd.png)
...
![](openl-studio-images/d6a1ce96702007aa08406d3be7e12e93.png)
...
![](openl-studio-images/80cce53b8b6655496217bca8bfc164de.png)
...
![](openl-studio-images/e3b6e1047d06dfb174d440f91adbe9b6.png)
...
2.  Select **Simple Rules Table** and click **Next**.
    ...
    ![](openl-studio-images/e44390622ef2d348d05b9763480569d0.png)
...
2.  Click **Add Input Parameters** and specify values as required.
    ...
    ![](openl-studio-images/8ff257223a07802fed34b30e0c83ec0f.png)
...
1.  When finished, click **Next**.
    ...
    ![](openl-studio-images/dd77d39d70eb8d48dd2b32a980c135c4.png)
    
    *Adding data to a table*
    
    Now the table can be filled with data.
    
    ![](openl-studio-images/65462d7abdd264cfdaf7e00c9ab2e202.png)
...
1.  Right click any cell and select one of the following actions:
    ...
    | **Add Rule**                                             | Allows entering data. An example is as follows: <br/>![](openl-studio-images/d507cf888bc177a035f2f9d0df48418c.png) <br/>*Entering table data* <br/>This action can be repeated as many times as required.                                    |
    | **Insert Condition Before** <br/>/ **Insert Condition After** | Adds a condition column to the specified position. An example of the added **DriverOccupation** condition column is as follows: <br/>![](openl-studio-images/30a25a53f40dd15c0a98cb861ede558e.png) <br/>*Adding a condition column* |
...
1.  In OpenL Studio Rules Editor, in the top line menu, select **More \> Compare Excel Files.**
    ...
    ![](openl-studio-images/f4dc285d2cfd850149ee33a4146b5a35.png)
...
2.  Click **Upload** and wait until file status is changed to **Done.**
    ...
    ![](openl-studio-images/c6ddede80c436a2da27bc49ecaa1ab38.png)
...
1.  To display tables and other Excel file elements that differ in the selected Excel files, click **Compare.**
    ...
    ![](openl-studio-images/a5a113dd2485add8924c817988fd9ed4.jpeg)
    
    *Excel file comparison results*
    
    Elements and tables that changed the location or contents are marked with the asterisk icon ![](openl-studio-images/2fa6082304b71636adcd5d0aeb872641.png). Added elements are marked with the plus sign icon ![](openl-studio-images/bd04610a773ff9db7e14dd8d2151dea2.png). Removed elements or tables are marked with the deletion icon ![](openl-studio-images/e0e42e29e021404ff525b226ed35c59b.png).
...
![](openl-studio-images/e74be11d559d97523688c560a9fd8ccc.png)
...
2.  Click the **OpenAPI** section.
    ...
    ![](openl-studio-images/21df39652489e7898bc8c21ccf2c7d3b.png)
...
1.  If an OpenAPI file does not exist, ensure that the **Generate from Rules and Datatype tables** and **Reconciliation** options are selected.
    ...
    ![](openl-studio-images/3f8ac8f625297a57ead86355d96a8c1f.jpeg)
...
![](openl-studio-images/e5178ddae9f590500e1feb5b380c5f18.png)
...
2.  In Rules Editor, click **Click to Import OpenAPI File.**
    ...
    ![](openl-studio-images/530e59c521ce7cb1f6747ee861eaf447.png)
...
2.  Select the **Tables generation** mode.
    ...
    ![](openl-studio-images/8b169ca659da3c159634211cd9434453.png)
...
2.  If no module with the entered name is found, set up the path to the generated file and click **Import.**
    ...
    ![](openl-studio-images/8ddc985b1b122f47b307ee4f8df90507.png)
    ...
    *Module settings window, both modules are new*
    ...
    ![](openl-studio-images/ff3b997c2baca85a51cbbce28fddc2e6.png)
...
1.  Ensure that the OpenAPI file is uploaded to the project via the **Repository** tab.
2.  In Rules Editor, click **OpenAPI Import icon ![](openl-studio-images/2e0ac2477a2ef46417855fcfad305c36.png).**
    
    ![](openl-studio-images/5ecf6f1a839b5fba461ce1f14e9ee2cf.jpeg)
...
1.  In the Import OpenAPI File window, enter the OpenAPI file location, select **Reconciliation,** and click **Import**.
    ...
    ![](openl-studio-images/7d0efb8da20e3bea5f75f2e0154813f3.png)
    
    *Selecting an OpenAPI file for reconciliation*

The project is validated using the newly imported file.

![](openl-studio-images/43a70316fd78de31918534d49f428dfb.png)
