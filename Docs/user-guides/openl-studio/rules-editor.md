...
2.  In the top line menu, select **More** **\>** **Local** **Changes**.
    ...
    ![Displaying the Changes window](images/local-changes-window.png)
...
For more information on table types, see [OpenL Tablets Reference Guide](../reference-guide/index.md). If a table contains an error, a small red cross is displayed in the corner of the icon.
