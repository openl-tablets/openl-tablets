...
![Vertical merging of table parts](../../../ref-guide-images/verticalMergingTableParts.png)

*Vertical merging of table parts*

![Horizontal merging of table parts](../../../ref-guide-images/horizontalMergingTableParts.png)
...
![Table Parts example. Vertical splitting part 1](../../../ref-guide-images/tablePartsExampleVerticalSplittingPart.png)

*Table Parts example. Vertical splitting part 1*

![Table Parts example. Vertical splitting part2](../../../ref-guide-images/tablePartsExampleVerticalSplittingPart2.png)

*Table Parts example. Vertical splitting part2*

![Table Part example. Horizontal splitting part 1](../../../ref-guide-images/tablePartExampleHorizontalSplittingPart.png)

*Table Part example. Horizontal splitting part 1*

![Table Parts example. Horizontal splitting part 2](../../../ref-guide-images/tablePartsExampleHorizontalSplittingPart.png)
