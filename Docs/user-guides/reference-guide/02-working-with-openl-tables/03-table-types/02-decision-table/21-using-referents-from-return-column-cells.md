...
![A Decision table with referents inside the Return column](../../../ref-guide-images/decisionTableReferentsInsideReturnColumn.png)

*A Decision table with referents inside the Return column*

![Tracing Decision table with referents](../../../ref-guide-images/tracingDecisionTableReferents.png)
...
![Accessing a condition parameter from a return expression by simplified syntax](../../../ref-guide-images/accessingConditionParameterFromReturnExpression.png)
