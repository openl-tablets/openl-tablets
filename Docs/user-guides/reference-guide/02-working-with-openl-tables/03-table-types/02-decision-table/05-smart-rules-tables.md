...
![Smart rules table with simple return value](../../../ref-guide-images/smartRulesTableSimpleReturnValue.png)
...
![Smart rules table with object-input](../../../ref-guide-images/smartRulesTableObject-input.png)
...
**Note:** To ensure the system checks a condition with an appropriate input parameter, the user can "hover" with a mouse over the column title and see the hint with this information in OpenL Studio.
...
![Comma within a string value in a Smart table](../../../ref-guide-images/commaWithinStringValueSmartTable.png)
...
![Using min and max values for a range in the condition column](../../../ref-guide-images/usingMinMaxValuesRangeCondition.jpeg)
...
![Example of a condition that is a Boolean expression](../../../ref-guide-images/exampleConditionThatBooleanExpression.png)
