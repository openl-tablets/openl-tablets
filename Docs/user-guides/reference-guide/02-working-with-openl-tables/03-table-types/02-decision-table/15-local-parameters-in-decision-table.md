...
![Decision table requiring an expression and simple equal operation for condition declaration](../../../ref-guide-images/decisionTableRequiringExpressionSimpleEqual.png)
...
![Simplified decision table](../../../ref-guide-images/simplifiedDecisionTable.png)
...
![Simplified condition declaration](../../../ref-guide-images/simplifiedConditionDeclaration.png)
...
![The Greeting rule](../../../ref-guide-images/greetingRule.png)
...
![Simplified Greeting rule](../../../ref-guide-images/simplifiedGreetingRule.png)
...
![Simple condition location](../../../ref-guide-images/simpleConditionLocation.png)
...
For test tables, to test the rule table performance, a business analyst uses the Benchmark functionality. For more information on this functionality, see [OpenL Studio Guide](../../../../openl-studio/index.md).
