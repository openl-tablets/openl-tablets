...
![Example of a smart rules table with multiple return columns](../../../ref-guide-images/exampleSmartRulesTableMultipleReturn.jpeg)
...
![Example of the test table for a rule table with multiple return columns](../../../ref-guide-images/exampleTestTableRuleTableMultiple.png)
