...
In the example below, the rule **VehicleDiscount** determines the vehicle's discount type and rate depending on air bags type and alarm indicator:

![Smart rules table with compound return value](../../../ref-guide-images/smartRulesTableCompoundReturnValue.png)

*Smart rules table with compound return value*

**Note:** To ensure the system matches the return column with an appropriate return object field, the user can "hover" over the column title and see the hint with this information in OpenL Studio.
...
![Return object fields automatically filled in with input values](../../../ref-guide-images/returnObjectFieldsAutomaticallyFilledInput.png)
...
![Smart rules tables with compound return value](../../../ref-guide-images/smartRulesTablesCompoundReturnValue.png)
