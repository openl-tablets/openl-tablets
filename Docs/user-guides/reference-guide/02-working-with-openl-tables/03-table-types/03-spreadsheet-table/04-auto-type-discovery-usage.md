...
![Auto Type Discovery Property Usage inside Spreadsheet table](../../../ref-guide-images/autoTypeDiscoveryPropertyUsageInside.png)
...
![Defining the value type as SpreadsheetResult](../../../ref-guide-images/definingValueTypeSpreadsheetresult.jpeg)
...
-   A user explicitly defines the return type of other Rules tables, such as Decision tables, as common SpreadsheetResult as follows:
    ...
    ![Explicitly defining the return type of other rules tables](../../../ref-guide-images/autoTypeDiscoveryUsage_1.png)
...
-   There is a circular dependency in a spreadsheet table calling the same spreadsheet rule itself in a cell. This cell type must be explicitly defined to allow correct auto type discovering of the whole spreadsheet table as follows:
    ...
    ![Defining a cell type explicitly](../../../ref-guide-images/autoTypeDiscoveryUsage_2.png)
