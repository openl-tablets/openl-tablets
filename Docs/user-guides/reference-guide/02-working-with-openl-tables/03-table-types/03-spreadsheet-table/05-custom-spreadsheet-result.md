...
![An example of a spreadsheet](../../../ref-guide-images/exampleSpreadsheet.png)
...
![Calling Spreadsheet cell](../../../ref-guide-images/callingSpreadsheetCell.png)
...
![Example of calling a spreadsheet to be used as input](../../../ref-guide-images/exampleCallingSpreadsheetUsedInput.jpeg)

*Example of calling a spreadsheet to be used as input*

![Using a custom spreadsheet as an input parameter](../../../ref-guide-images/usingCustomSpreadsheetInputParameter.jpeg)
...
-   Different spreadsheets are called in a ternary operation.
    ...
    For more information on ternary operations, see [Ternary Operator](../../../03-functions-and-data-types/03-working-with-functions.md#ternary-operator).

-   The array of SpreadsheetResult is created by united spreadsheet cells (\$Step1:\$Step10).

![Example of a rule returning a united spreadsheet result](../../../ref-guide-images/exampleRuleReturningUnitedSpreadsheetResult.png)
