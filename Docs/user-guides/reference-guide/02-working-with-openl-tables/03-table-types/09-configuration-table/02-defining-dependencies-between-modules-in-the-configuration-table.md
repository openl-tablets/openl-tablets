...
![Configuration table with dependency modules added by their name](../../../ref-guide-images/configurationTableDependencyModulesAddedBy.png)

*Configuration table with dependency modules added by their name*

![Configuration table with link to all dependency modules](../../../ref-guide-images/configurationTableLinkAllDependencyModules.png)
...
![Rule with the algorithm to calculate the Vehicle premium](../../../ref-guide-images/ruleAlgorithmCalculateVehiclePremium.png)
...
![Configuration table in the Auto-Rating Algorithm.xlsx file](../../../ref-guide-images/configurationTableAuto-ratingAlgorithmxlsxFile.png)
