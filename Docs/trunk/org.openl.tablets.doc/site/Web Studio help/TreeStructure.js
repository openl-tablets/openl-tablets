...
insDoc(aux1, gLnk("R", "Uploading a Project", "User_UploadingAProject.html#uploading_a_project32"));
insDoc(aux1, gLnk("R", "Creating a Project", "User_CreatingAProject.html#creating_a_project33"));
insDoc(aux1, gLnk("R", "Opening a Project", "User_OpeningAProject.html#opening_a_project34"));
insDoc(aux1, gLnk("R", "Closing a Project", "User_ClosingAProject.html#closing_a_project35"));
insDoc(aux1, gLnk("R", "Checking Out a Project", "User_CheckingOutAProject.html#checking_out_a_project36"));
insDoc(aux1, gLnk("R", "Checking In a Project", "User_CheckingInAProject.html#checking_in_a_project37"));
insDoc(aux1, gLnk("R", "Defining Project Dependencies", "User_DefiningProjectDependencies.html#defining_project_dependencies38"));
aux2 = insFld(aux1, gFld("Modifying a Project", "User_ModifyingAProject.html#modifying_a_project39"));
insDoc(aux2, gLnk("R", "Modifying Project Properties", "User_ModifyingProjectProperties.html#modifying_project_properties40"));
insDoc(aux2, gLnk("R", "Modifying Project Contents", "User_ModifyingProjectContents.html#modifying_project_contents41"));
insDoc(aux1, gLnk("R", "Copying a Project", "User_CopyingAProject.html#copying_a_project45"));
aux2 = insFld(aux1, gFld("Removing a Project", "User_RemovingAProject.html#removing_a_project46"));
insDoc(aux2, gLnk("R", "Deleting a Project", "User_DeletingAProject.html#deleting_a_project47"));
insDoc(aux2, gLnk("R", "Erasing a Project", "User_ErasingAProject.html#erasing_a_project48"));
aux2 = insFld(aux1, gFld("Deploying Projects", "User_DeployingProjects.html#deploying_projects49"));
insDoc(aux2, gLnk("R", "Creating a Deployment Project", "User_CreatingADeploymentProject.html#creating_a_deployment_project50"));
insDoc(aux2, gLnk("R", "Defining Deployment Project Descriptors", "User_DefiningDeploymentProjectDescriptors.html#defining_deployment_project_descriptors51"));
insDoc(aux2, gLnk("R", "Deploying a Deployment Project", "User_DeployingADeploymentProject.html#deploying_a_deployment_project52"));
insDoc(aux2, gLnk("R", "Opening Deployed Projects", "User_OpeningDeployedProjects.html#opening_deployed_projects53"));
aux1 = insFld(foldersTree, gFld("Chapter 5: Advanced Functionality", "User_AdvancedFunctionality.html#chapter_5_advanced_functionality54"));
insDoc(aux1, gLnk("R", "Unit Tests", "User_UnitTests.html#unit_tests55"));
insDoc(aux1, gLnk("R", "Tracing", "User_Tracing.html#tracing56"));
insDoc(aux1, gLnk("R", "Benchmarking", "User_Benchmarking.html#benchmarking57"));
