...
This chapter describes creating an OpenL Tablets project. For more information on projects, see [Projects](Introducing_OpenL_Tablets.md#projects).
...
1.  To add a dependency to a module, add the instruction to a configuration table as described in [Configuration Table](Creating_Tables_for_OpenL_Tablets.md#configuration-table) using the **dependency** command and the name of the module to be added.
...
Import configuration is defined using the **Environment** table as described in [Configuration Table](Creating_Tables_for_OpenL_Tablets.md#configuration-table). Configuration can be made for any user mode, single-user mode or multi-user mode. For proper import configuration, classpath must be registered in project sources as described in [Project Sources](#project-sources).
...
-   Rules in rule tables as described in [Decision Table](Creating_Tables_for_OpenL_Tablets.md#decision-table), [Spreadsheet Table](Creating_Tables_for_OpenL_Tablets.md#spreadsheet-table), [Method Table](Creating_Tables_for_OpenL_Tablets.md#method-table), [TBasic Table](Creating_Tables_for_OpenL_Tablets.md#tbasic-table).
-   Data in data tables as described in [Data table](Creating_Tables_for_OpenL_Tablets.md#data-table).
-   Data types in data type tables as described in [Datatype Table](Creating_Tables_for_OpenL_Tablets.md#datatype-table).
