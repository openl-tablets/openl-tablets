...
1.  To add a dependency to a module, add the instruction to a configuration table as described in [Configuration Table](../../working-with-openl-tables/table-types/configuration-table/configuration-table-description.md#configuration-table) using the **dependency** command and the name of the module to be added.
...
Import configuration is defined using the **Environment** table as described in [Configuration Table](../../working-with-openl-tables/table-types/configuration-table/configuration-table-description.md#configuration-table). Configuration can be made for any user mode, single-user mode or multi-user mode. For proper import configuration, classpath must be registered in project sources as described in [Project Sources](project-structure.md#project-sources).
...
-   Rules in rule tables as described in [Decision Table](../../working-with-openl-tables/table-types/decision-table/decision-table-overview-and-structure.md#decision-table), [Spreadsheet Table](../../working-with-openl-tables/table-types/spreadsheet-table/parsing-a-spreadsheet-table.md#spreadsheet-table), [Method Table](../../working-with-openl-tables/table-types/method-table.md#method-table), [TBasic Table](../../working-with-openl-tables/table-types/tbasic-table.md#tbasic-table).
-   Data in data tables as described in [Data table](../../working-with-openl-tables/table-types/data-table/using-simple-data-tables.md#data-table).
-   Data types in data type tables as described in [Datatype Table](../../working-with-openl-tables/table-types/datatype-table/introducing-datatype-tables.md#datatype-table).
