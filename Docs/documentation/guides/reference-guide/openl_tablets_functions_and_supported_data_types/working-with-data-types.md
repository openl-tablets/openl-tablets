...
| Custom data types and vocabularies | Types created by a user as described in the [Datatype Table](../../working-with-openl-tables/table-types/datatype-table/introducing-datatype-tables.md#datatype-table) section. |
