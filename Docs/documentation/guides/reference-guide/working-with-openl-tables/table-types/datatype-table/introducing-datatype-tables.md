...
-   [Inheritance in Data Types](inheritance-in-data-types.md#inheritance-in-data-types)
-   [Vocabulary Data Types](vocabulary-data-types.md#vocabulary-data-types)
...
For more information on creating vocabulary for data elements, see [Vocabulary Data Types](vocabulary-data-types.md#vocabulary-data-types).
...
**Note for experienced users:** Java beans can be used as custom data types in OpenL Tablets. If a Java bean is used, the package where the Java bean is located must be imported using a configuration table as described in [Configuration Table](../configuration-table/configuration-table-description.md#configuration-table).
...
For more information on using runtime context properties in Datatype tables, see [Runtime Context Properties in Datatype Tables](../../../table-properties/rule-versioning.md#runtime-context-properties-in-datatype-tables).

Datatype table output results can be customized the same way as spreadsheets as described in [Spreadsheet Result Output Customization](../spreadsheet-table/spreadsheet-result-output-customization.md#spreadsheet-result-output-customization).
