...
For more information on how property values relate to runtime context values and what rule table is executed, see [Business Dimension Properties](../../../table-properties/rule-versioning.md#business-dimension-properties) and [Rules Runtime Context](../../../table-properties/rule-versioning.md#rules-runtime-context).
