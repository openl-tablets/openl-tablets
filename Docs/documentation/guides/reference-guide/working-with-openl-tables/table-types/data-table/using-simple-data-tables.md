...
Data tables can contain data types supported by OpenL Tablets or types loaded in OpenL Tablets from other sources. For more information on data types, see [Datatype Table](../datatype-table/introducing-datatype-tables.md#datatype-table) and [Working with Data Types](OpenL_Tablets_Functions_and_Supported_Data_Types.md#working-with-data-types).
