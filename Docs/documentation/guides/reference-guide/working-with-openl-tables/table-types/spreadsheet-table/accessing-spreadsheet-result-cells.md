...
The same functionality is available in test tables as described in [Testing Spreadsheet Result](testing-spreadsheet-result.md#testing-spreadsheet-result).
