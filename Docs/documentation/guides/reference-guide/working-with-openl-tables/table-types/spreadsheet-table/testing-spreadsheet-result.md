...
For this purpose, the same syntax described in [Specifying Data for Aggregated Objects](../data-table/specifying-data-for-aggregated-objects.md#specifying-data-for-aggregated-objects) can be used. It also includes simplified options.
