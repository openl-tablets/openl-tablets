...
For more information on how to specify values of input parameters which have complex constructions, see [Specifying Data for Aggregated Objects](data-table/specifying-data-for-aggregated-objects.md#specifying-data-for-aggregated-objects) and [Ensuring Data Integrity](data-table/ensuring-data-integrity.md#ensuring-data-integrity).
