...
To use the feature, define the **Properties** pattern for a file name as described in [Properties Defined in the File Name](../../table-properties/properties-defined-in-the-file-name.md#properties-defined-in-the-file-name).
