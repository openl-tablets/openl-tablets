...
In OpenL Tablets, business rules can be versioned in different ways using properties as described in [Table Properties](../../table-properties/category-and-module-level-properties.md#table-properties). This section describes the most popular versioning properties:

| Property                                                        | Description                                                                                                                                                                     |
|-----------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Business Dimension Properties](../../table-properties/rule-versioning.md#business-dimension-properties) | Targets advanced rules usage when several rule sets are used simultaneously. <br/>This versioning mechanism is more extendable and flexible.                                         |
| [Active Table](../../table-properties/rule-versioning.md#active-table)                                | Is more suitable for “what-if” analysis. <br/>It allows storing the previous versions of rule tables in an inactive status in a project to track changes or for any other reference. |
...
-   [Introducing Business Dimension Properties](../../table-properties/rule-versioning.md#introducing-business-dimension-properties)
-   [Using Effective and Expiration Date](../../table-properties/rule-versioning.md#using-effective-and-expiration-date)
-   [Using a Request Date](../../table-properties/rule-versioning.md#using-a-request-date)
-   [Using an Origin Property](../../table-properties/rule-versioning.md#using-an-origin-property)
-   [Overlapping of Properties Values for Versioned Rule Tables](../../table-properties/rule-versioning.md#overlapping-of-properties-values-for-versioned-rule-tables)
-   [Rules Runtime Context](../../table-properties/rule-versioning.md#rules-runtime-context)
-   [Runtime Context Properties in Datatype Tables](../../table-properties/rule-versioning.md#runtime-context-properties-in-datatype-tables)
...
**Note for experienced users:** A particular rule can be called directly regardless of its dimension properties and current runtime context in OpenL Tablets. This feature is supported by setting the ID property as described in [Dev Properties](../../table-properties/dev-properties.md#dev-properties), in a specific rule, and using this ID as the name of the function to call. During runtime, direct rule is executed avoiding the mechanism of dispatching between overloaded rules.

For more information on using attributes for runtime context definition, see [Runtime Context Properties in Datatype Tables](../../table-properties/rule-versioning.md#runtime-context-properties-in-datatype-tables).
...
For more information on the context variable name, see [Introducing Business Dimension Properties](../../table-properties/rule-versioning.md#introducing-business-dimension-properties), the **Name to be used in context** column in the **Business Dimension properties list** table.
