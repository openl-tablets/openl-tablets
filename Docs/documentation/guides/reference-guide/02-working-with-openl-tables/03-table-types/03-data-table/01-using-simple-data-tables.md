...
Data tables can contain data types supported by OpenL Tablets or types loaded in OpenL Tablets from other sources. For more information on data types, see [Datatype Table](../02-datatype-table/01-introducing-datatype-tables.md#datatype-table) and [Working with Data Types](../../../03-openl-tablets-functions-and-supported-data-types/01-working-with-data-types.md#working-with-data-types).
