...
1.  The engine reads text in the top left cell of a recognized logical table to determine its type.
    ...
    | Data                | [Data Table](03-table-types/03-data-table/01-using-simple-data-tables.md#data-table)                  |
    | Datatype            | [Datatype Table](03-table-types/02-datatype-table/01-introducing-datatype-tables.md#datatype-table)           |
    | Environment         | [Configuration Table](03-table-types/05-configuration-table/01-configuration-table-description.md#configuration-table) |
    ...
    | Rules               | [Decision Table](03-table-types/01-decision-table/01-decision-table-overview-and-structure.md#decision-table)           |
    | Run                 | [Run Table](03-table-types/10-run-table.md#run-table)                    |
    | SimpleLookup        | [Simple Lookup Table](03-table-types/01-decision-table/09-simple-lookup-tables.md#simple-lookup-table) |
    | SimpleRules         | [Simple Rules Table](03-table-types/01-decision-table/04-simple-rules-tables.md#simple-rules-table)   |
    | SmartLookup         | [Smart Lookup Table](03-table-types/01-decision-table/10-smart-lookup-tables.md#smart-lookup-table)   |
    | SmartRules          | [Smart Rules Table](03-table-types/01-decision-table/05-smart-rules-tables.md#smart-rules-table)    |
    | Spreadsheet         | [Spreadsheet Table](03-table-types/06-spreadsheet-table/01-parsing-a-spreadsheet-table.md#spreadsheet-table)     |
    ...
    | Test                | [Test Table](03-table-types/04-test-table/01-understanding-test-tables.md#test-table)                  |
