...
Different types of tables serve different purposes. For more information on table types, see [Table Types](Creating_Tables_for_OpenL_Tablets.md#table-types).
