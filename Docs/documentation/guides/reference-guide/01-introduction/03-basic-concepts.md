...
Different types of tables serve different purposes. For more information on table types, see [Table Types](../02-working-with-openl-tables/04-table-types/02-decision-tab../02-decision-table-overview-and-structure.md#decision-table).
