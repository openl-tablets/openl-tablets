...
Different types of tables serve different purposes. For more information on table types, see [Table Types](../02-working-with-openl-tables/03-table-types/01-decision-table/01-decision-table-overview-and-structure.md#decision-table).
