...
| Custom data types and vocabularies | Types created by a user as described in the [Datatype Table](../../02-working-with-openl-tables/03-table-types/02-datatype-table/01-introducing-datatype-tables.md#datatype-table) section. |
