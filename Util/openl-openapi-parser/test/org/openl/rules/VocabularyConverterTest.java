...
class VocabularyConverterTest {
    ...
    @Test
    void declaresAVocabularyPerDistinctEnum() throws IOException {
        ...
        assertEquals(List.of("Bean"), projectModel.getDatatypeModels().stream().map(dt -> dt.getName()).toList());
    }

    @Test
    void typesTheFieldsByTheVocabularies() throws IOException {
    ...
    @Test
    void passesTheVocabulariesThroughTheSpreadsheets() throws IOException {
        var projectModel = extract();
    ...
    @Test
    void keepsTheNameOfEveryNamedSchema() throws IOException {
    ...
    @Test
    void leavesOutTheValuesATableCannotHold() throws IOException {
     ...
     */
    @Test
    void keepsTheDefaultOfAVocabularyField() throws IOException {
    ...
    @Test
    void passesOverDanglingReferences() throws IOException {
    ...
    @Test
    void namesTheEnumsBehindComponentReferences() throws IOException {
        var projectModel = extract("vocabulary-references");
    ...
    private static ProjectModel extract() throws IOException {
        return extract("vocabulary");
    }

    private static ProjectModel extract(String specification) throws IOException {
