...
public class OpenAPIScaffoldingConverter implements OpenAPIModelConverter {
    ...
    public ProjectModel extractProjectModel(String pathTo) {
        ...
        final Consumer<MethodModel> applyInclude = method -> method
            .setInclude(openAPI.getPaths().get(method.getPathInfo().getOriginalPath()) != null);
    ...
    private void extractSpreadsheets(OpenAPI openAPI,
        ...
        for (String path : pathWithPotentialSprResult) {
            ...
            if (pathItem != null) {
                List<SpreadsheetParserModel> spr = extractSpreadsheetModel(openAPI,
                    jxPathContext,
                    pathItem,
                    path,
                    refsToExpand,
    ...
    private List<SpreadsheetParserModel> extractSpreadsheetModel(OpenAPI openAPI,
            JXPathContext jxPathContext,
            PathItem pathItem,
            String path,
            Set<String> refsToExpand,
