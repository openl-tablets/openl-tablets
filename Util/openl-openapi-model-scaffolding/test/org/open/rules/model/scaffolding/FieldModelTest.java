...
class FieldModelTest {
    ...
    void testFieldModelCreation() {
        ...
        var weightFieldString = new FieldModel("weight", "String", "10");
        var weightFieldInteger = new FieldModel("weight", "Integer", 0);
        ...
        var heightModel = new FieldModel("height", "String", "193");
        var heightModelLow = new FieldModel("height", "String", "-134");
