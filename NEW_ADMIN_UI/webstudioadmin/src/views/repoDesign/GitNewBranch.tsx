...
export const GitNewBranch = () => {
    ...
    const DefaultBranchModal = <InfoFieldModal
        text={
            <>
    ...
    return (<div>
        ...
        <Form
            ...
            <Form.Item tooltip={{ title: 'Details', icon: InvalidBranchModal }}
                label={
                    <span>
                        Invalid branch name<br></br> message hint &nbsp;
                    </span>
                }
            >
                <Input />
