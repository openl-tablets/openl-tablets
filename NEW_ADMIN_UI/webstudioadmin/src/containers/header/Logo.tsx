export default () => (
    <svg fill="none" height="24" viewBox="-1066 -1200 2132 2400" width="24" xmlns="http://www.w3.org/2000/svg">
        <path d="M0 1000 866 500 866-500 0-1000-866-500-866 500Z" stroke="#062261" strokeWidth="400" strokeLinejoin="round" />
