import { Card, Input, Divider, Button, Col, Row } from 'antd'
    ...
    <DefaultLayout>
        <Card style={{ margin: 20, width: 900 }}>
            ...
            <p>
                <b>Tag type</b>
                {' '}
                is a category that includes tag values of the same group. For example, the Product tag type can include tags Auto, Life, and Home.
            </p>
            <p>Proceed as follows:</p>
            <ul>
                <li>
                    To add a tag type, in the
                    {' '}
                    <b>New Tag Type</b>
                    {' '}
                    field, enter the tag type name and press
                    {' '}
                    <b>Enter</b>
                    {' '}
                    or
                    ...
                    <b>Tab</b>
                    {/**/}
                    . The tag type is added, and fields for tag values appear.
                </li>
                <li>
                    To add a tag value, in the
                    {' '}
                    <b>New Tag</b>
                    {' '}
                    field, enter the tag name and press
                    {' '}
                    <b>Enter</b>
                    {/**/}
                    .
            ...
            <Input placeholder="New Tag Type" style={{ width: 400 }} />
            <Divider />
            <h2>Tags from a Project Name</h2>
            ...
            <p>
                ...
                template, for the
                {' '}
                <b>Policy-L&A-rules</b>
                {' '}
                project, the tags are
                {' '}
                <b>Policy</b>
                {' '}
                for the
            ...
            <Col>
                ...
                <Row>
                    ...
                    <Button style={{ marginTop: 20, marginRight: 15 }}>Fill tags for projects</Button>
                </Row>
            </Col>
        </Card>
    </DefaultLayout>
