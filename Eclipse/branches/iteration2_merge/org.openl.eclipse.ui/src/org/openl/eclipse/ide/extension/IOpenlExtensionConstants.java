...
{
  static public final String EXTENSION_POINT_OPENL_LANGUAGE =
    OPENL_PLUGIN_ID + ".languageConfiguration";

  static public final String EXTENSION_POINT_OPENL_BUILDER =
    OPENL_PLUGIN_ID + ".builderConfiguration";
