...
public class OpenlMarkers
    ...
    public static void addMarker(IResource resource, ISyntaxError error, String openl, int severity) {
        ...
        addMarker(resource, error.getLocation(), error.getModule(), openl, message,
                severity);
    }

    public static void addMarker(IResource resource, ILocation location, IOpenSourceCodeModule module,
            String openl, String message, int severity) {
...
//        }
    ...
    public static void addMarker(IResource resource, String url, String message,
            int severity, String start, String end, String line) {
        try {
    ...
    protected static IMarker createMarker(IResource resource, String type,
    ...
    public static void removeAllOpenlMarkers(IResource resource) {
        ...
        try {
            resource.deleteMarkers(
                    IOpenlModelConstants.OPENL_MODEL_PROBLEM_MARKER,
...
//    }
     ...
     * Returns new CoreException with a given parameters.
     */
    static public Throwable unwrapInvocationTargetException(
