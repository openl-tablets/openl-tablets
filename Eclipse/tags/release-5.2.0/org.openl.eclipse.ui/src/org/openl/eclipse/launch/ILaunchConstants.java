...
//  static final String MSG_CREATING_SOURCE_LOCATOR = "Creating_source_locator...";
  ...
  /**
   * Message of the dialog 'Launch configuration selection'. 
   * Parameter: launchMode: run, debug 
   */
  static final String MSG_LAUNCH_CONFIG_SELECTION_MESSAGE =
    "Choose_launch_configuration_to_{0}";
  ...
  /**
   * Message of the dialog 'Launch target selection'. 
   * Parameter: launchMode: run, debug 
   */
