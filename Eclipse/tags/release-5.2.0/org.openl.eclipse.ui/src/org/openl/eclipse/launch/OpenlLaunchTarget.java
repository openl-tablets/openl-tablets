...
public class OpenlLaunchTarget extends ALaunchTarget
{
  ...
  /**
   * Launching determinators:
   *  - attrProject is my Project
   *  - attrMain is OpenlMain
   *  - attrArgs contains sourceUrl
   */
    ...
    try
    {
      ...
      String attrMain =
        c.getAttribute(
          ...
          "");
      String attrProject =
        c.getAttribute(IJavaLaunchConfigurationConstants.ATTR_PROJECT_NAME, "");
      String attrArgs =
        c.getAttribute(
          IJavaLaunchConfigurationConstants.ATTR_PROGRAM_ARGUMENTS,
          "");

      return project.equals(attrProject)
        && OpenlMain.class.getName().equals(attrMain)
