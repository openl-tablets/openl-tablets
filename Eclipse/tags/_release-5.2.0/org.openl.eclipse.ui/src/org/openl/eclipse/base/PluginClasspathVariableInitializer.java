...
public class PluginClasspathVariableInitializer extends ClasspathVariableInitializer {
    ...
    public void initialize(String variable) {
        try {
            ...
            if (value != null) {
                JavaCore.setClasspathVariable(variable, value,
                        getProgressMonitor());
            } else {
                JavaCore
                        .removeClasspathVariable(variable, getProgressMonitor());
            }

        } catch (Throwable t) {
            System.err
                    .println("Exception is ClasspathVariableInitializerProxy.initialize("
                            + variable + "): " + t.getMessage());
        }
    }
    ...
    public PluginVariable decodeVariable(String encodedVariable)
            throws Exception {
