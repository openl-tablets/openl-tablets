 ...
 *  
 */
public class OpenlPluginConfiguration 
   extends UtilBase 
   {
...
//    ClassLoader getProjectClassLoader(IEProject project, IPluginDescriptor[] pds) {
//
//        return new URLClassLoader(UrlUtil.toUrl(project.getProjectClasspathEntries()));
//
//    }
