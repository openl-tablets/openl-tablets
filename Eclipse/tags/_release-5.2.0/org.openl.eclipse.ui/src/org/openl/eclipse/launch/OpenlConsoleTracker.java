...
public class OpenlConsoleTracker
  implements IConsoleLineTracker, IHyperlinkFactory, SourceCodeURLConstants
{
  IConsole console;
  ...
  public synchronized void init(IConsole console)
  {
    ...
    if(!isRegistered)
    {
      ConsoleLineTrackerTool.register(this,getIncludeMatchString(),getExcludeMatchString(), ConsoleLineTrackerTool.DEFAULT_PRIORITY);
      isRegistered=true;
    }
