...
public record CurrentLocation(LocationKind kind, int row, int column, @Nullable String ref, @Nullable String label,
    ...
    /** Breakpoint ref for a fired-rule step: none when no rule fired, the single rule, else the any-rule key. */
    private static @Nullable String dtRuleRef(List<String> ruleNames) {
