...
/**
 * Reusable service for parsing table input JSON.
 * Auto-detects format and parses accordingly:
 * <ul>
 *   <li>Structured: {"params": {...}, "runtimeContext": {...}}</li>
 *   <li>Raw user input: {"paramName": value, ...} or plain value for single param</li>
 * </ul>
 */
@Service
public class TableInputParserService {
    ...
    /**
     * Parse JSON input for method execution.
     * Auto-detects structured vs raw format.
     *
     * @param inputJson JSON string to parse
     * @param method    the method being executed (for parameter types)
     * @param mapper    ObjectMapper configured for the project
     * @return parsed parameters and optional runtime context
     */
    ...
    /**
     * Parse structured format: {"params": {...}, "runtimeContext": {...}}
     */
    ...
    /**
     * Parse raw user format like InputArgsBean.getParams() does:
     * <ul>
     *   <li>{"paramName": value, ...} with optional runtime context</li>
     *   <li>Or plain value for single parameter</li>
     * </ul>
     */
