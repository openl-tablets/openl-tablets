 ...
 * @param instance       zero-based execution index of this table in the run, so a specific loop iteration is reachable
...
public record CallNodeView(
        ...
        @Schema(description = "trace.field.call-node.instance.desc")
        int instance,
        ...
        @Parameter(description = "trace.field.call-node.dispatch.desc")
