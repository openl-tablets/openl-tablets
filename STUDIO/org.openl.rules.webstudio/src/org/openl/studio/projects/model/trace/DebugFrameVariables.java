...
public record DebugFrameVariables(
        ...
        @Parameter(description = "trace.field.variables.context.desc")
        @Nullable ParameterValue context,

        @Parameter(description = "trace.field.variables.result.desc")
        ...
        @Parameter(description = "trace.field.variables.decision.desc")
