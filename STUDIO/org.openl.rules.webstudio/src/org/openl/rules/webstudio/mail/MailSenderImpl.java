...
public class MailSenderImpl implements MailSender {
    ...
    public MailSenderImpl(MailSenderProperties mailSenderProperties,
    ...
    public boolean sendVerificationMail(User user, HttpServletRequest httpServletRequest) {
        ...
        try {
            if (settings.isValidEmailSettings()) {
                ...
                var emailContent = template
                        ...
                        .replace("${from}", settings.getUsername())
                ...
                // Send email
                try (Transport transport = getTransport(settings.getUrl(), settings.getUsername(), settings.getPassword())) {
