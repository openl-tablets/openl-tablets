 ...
 * doesn't override hasCode() and equals() methods, then cloned object and original one always will be not equal. So
 * original object can be safely modified, it doesn't break logic. If equal object isn't found in the cache then it will
 ...
 *
 * Clones can't be changed! If cloned object can be changed in future, this cloner can't be used. For example, in the
