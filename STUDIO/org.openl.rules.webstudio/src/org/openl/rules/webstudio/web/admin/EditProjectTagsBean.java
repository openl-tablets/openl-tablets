        ...
        if (selectedProject != null) {
            ...
            tags = project.getTags().entrySet().stream()
                    .map(entry -> {
                        ...
                        return new TagInfo(entry.getKey(), entry.getValue(), tag, tagType != null);
    ...
    private void fillAbsentTags() {
        ...
        tagTypes.forEach(type -> {
            if (tags.stream().noneMatch(tag -> tag.getTypeName().equals(type.getName()))) {
                final TagInfo t = new TagInfo(type.getName(), NONE_NAME, null, true);
                tags.add(t);
            }
        });
    }
        ...
        try {
            ...
            if (repoId != null && realPath != null) {
                ...
                if (rulesProjectOptional.isPresent()) {
                    ...
                    var currentTags = new HashMap<>(rulesProject.getTags());
