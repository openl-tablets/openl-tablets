...
public class OAuth2AttributesSettings implements SettingsHolder {

    private static final String ATTR_USERNAME = "security.oauth2.attribute.username";
    private static final String ATTR_FIRST_NAME = "security.oauth2.attribute.first-name";
    private static final String ATTR_LAST_NAME = "security.oauth2.attribute.last-name";
    private static final String ATTR_DISPLAY_NAME = "security.oauth2.attribute.display-name";
