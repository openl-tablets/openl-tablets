...
public abstract class RepositorySettings implements ConfigPrefixSettingsHolder {
    ...
    @Parameter(description = "This message is shown to user if user message is not matched to regular expression that is used in validation pattern.")
    ...
    @JsonView({Views.Design.class, Views.DeployConfig.class})
