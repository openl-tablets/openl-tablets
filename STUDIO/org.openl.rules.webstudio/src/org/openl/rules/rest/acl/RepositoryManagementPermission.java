...
@PreAuthorize("hasAuthority(T(org.openl.rules.security.Privileges).ADMIN.getAuthority()) or @aclRepositoriesHelper.hasPermission(#aclRepoId, T(org.openl.security.acl.permission.AclPermission).ADMINISTRATION)")
