...
public class ExplainTreeRenderer extends DTreeRenderer {
    static String[][] icons = {
            {
                "value", "images/value.gif", "images/value.gif", "images/value.gif",
                "images/value.gif",
            },
            {
                "formula.+", "images/operator-plus.gif", "images/operator-plus.gif",
                "images/operator-plus.gif", "images/operator-plus.gif"
            },
            {
                "formula.*", "images/operator-mul.gif", "images/operator-mul.gif",
                "images/operator-mul.gif", "images/operator-mul.gif",
            },
            {
                "formula./", "images/operator-div.gif", "images/operator-div.gif",
                "images/operator-div.gif", "images/operator-div.gif",
            },
            {
                "formula.-", "images/operator-min.gif", "images/operator-min.gif",
                "images/operator-min.gif", "images/operator-min.gif",
            },
            {
                "formula", "images/operator.gif", "images/operator.gif",
                "images/operator.gif", "images/operator.gif"
            },
            {
                "function", "images/method.gif", "images/method.gif", "images/method.gif",
                "images/method.gif"
            }
        };
