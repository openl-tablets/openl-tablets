...
public class TraceHelper {
    ...
    public String showTrace(int id, ProjectModel model, String view) {
        ...
        TableModel tableModel = ProjectModel.buildModel(gt,
                new IGridFilter[] { makeFilter(rtt, model) });
...
//		return ColorGridFilter.makeTransparentFilter(new RegionGridSelector(regions, true), 0.7, 0x00ff00);
        return new ColorGridFilter(new RegionGridSelector(regions, true),
            model.getFilterHolder().makeFilter());
...
//		}
//	}
    public String printTraceMethod(IOpenMethodHeader header, Object[] params,
        StringBuffer buf) {
