 ...
 */
public class TableInstanceSorter extends ATableTreeSorter implements IProjectTypes,
    ITableNodeTypes
{
    ...
    public static String[] getTableDisplayValue(TableSyntaxNode tsn) {
        return getTableDisplayValue(tsn, 0);
    }

    public static String[] getTableDisplayValue(TableSyntaxNode tsn, int i) {
        ...
        if (name == null) {
            name = str2name(tsn.getTable().getGridTable().getStringValue(0, 0),
                    tsn.getType());
        }

        if (display == null) {
            display = str2display(tsn.getTable().getGridTable().getStringValue(0, 0),
                    tsn.getType());
        }
