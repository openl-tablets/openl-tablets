...
/**
    ...
    int width(BorderStyle bs1, BorderStyle bs2) {
        ...
        return (bs1 == null) ? bs2.width
        : ((bs2 == null) ? bs1.width : Math.max(bs1.width, bs2.width));
    }
    ...
    String style(BorderStyle bs1, BorderStyle bs2) {
        ...
        return (bs1 == null) ? bs2.style
        : ((bs2 == null) ? bs1.style : ((bs1 == BorderStyle.NONE) ? bs2.style : bs1.style));
    }
    ...
    short[] rgb(BorderStyle bs1, BorderStyle bs2) {
        ...
        return (bs1 == null) ? bs2.rgb
        : ((bs2 == null) ? bs1.rgb : ((bs1 == BorderStyle.NONE) ? bs2.rgb : bs1.rgb));
    }
    ...
    void setVerticalBorder(int column, TableModel tm) {
        ...
        for (int i = 0; i < height; i++) {
            ICellStyle ls = (((column + left) - 1) < 0) ? null
                : grid.getCellInfo((column + left) - 1, i + top).getCellStyle();
            ICellStyle rs = (((column + left) - 1) < 0) ? null
                : grid.getCellInfo(column + left, i + top).getCellStyle();

            CellModel cmLeft = (ls == null) ? null
                : tm.findCellModel(column - 1, i, ICellStyle.RIGHT);
            CellModel cmRight = (rs == null) ? null
                : tm.findCellModel(column, i, ICellStyle.LEFT);
    ...
    void setHorizontalBorder(int row, TableModel tm) {
        ...
        for (int i = 0; i < width; i++) {
            ICellStyle ts = (((row + top) - 1) < 0) ? null
                : grid.getCellInfo(i + left, (row + top) - 1).getCellStyle();
            ICellStyle bs = grid.getCellInfo(i + left, row + top).getCellStyle();

            CellModel cmTop = (ts == null) ? null
                : tm.findCellModel(i, row - 1, ICellStyle.BOTTOM);
            CellModel cmBottom = (bs == null) ? null
                : tm.findCellModel(i, row, ICellStyle.TOP);
