...
class TableValueFilter extends AGridFilter {
    ...
    public FormattedCell filterFormat(FormattedCell cell) {
        ...
        var relativeColumn = cell.getColumn() - startX;
        var relativeRow = cell.getRow() - startY;
        ...
        for (var i = 1; i < relativeColumn; i++) {
            columnOffset += table.getColumn(i).getSource().getWidth() - 1;
        }

        for (var i = 1; i < relativeRow; i++) {
            rowOffset += table.getRow(i).getSource().getHeight() - 1;
        }

        var col = cell.getColumn() - startX - columnOffset;
        var row = cell.getRow() - startY - rowOffset;
        ...
        if (logicalRow != null && logicalCol != null && logicalRow >= 0 && logicalCol >= 0
            ...
            var v = res.getValue(logicalRow, logicalCol);
