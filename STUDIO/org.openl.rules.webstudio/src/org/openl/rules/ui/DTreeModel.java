...
public class DTreeModel implements IProjectTypes, ITableNodeTypes {
    ...
    static final String[] DEFAULT_ICON_OPEN = {
            "images/dtree/folder-o-n.gif", "images/folder-o-error.png"
        };
    static final String[] DEFAULT_ICON_CLOSED = {
            "images/dtree/folder-c-n.gif", "images/folder-c-error.png"
        };
    static final String[] DEFAULT_ICON_LEAF = {
            "images/categoryset.gif", "images/categoryset.gif"
        };
    static String[][] icons = {
            {
            ...
            {
                "worksheet", "images/worksheet.gif", "images/worksheet.gif",
                "images/worksheet-error.png", "images/worksheet-error.png"
            },
            {
                PT_TABLE + "." + XLS_DT, "images/ruleset.gif", "images/ruleset-h.gif",
                "images/ruleset-error.png", "images/ruleset-error.png"
            },
            {
                PT_TABLE + "." + XLS_DATA, "images/data.gif", "images/data.gif",
                "images/data-error.png", "images/data-error.png"
            },
            {
                PT_TABLE + "." + XLS_DATATYPE, "images/dataobject.gif",
                "images/dataobject.gif", "images/dataobject-error.png",
                "images/dataobject-error.png"
            },
            {
                PT_TABLE + "." + XLS_ENVIRONMENT, "images/config_obj.gif",
                "images/config_obj.gif", "images/config_obj-error.png",
                "images/config_obj-error.png"
            },
            {
                PT_TABLE + "." + XLS_METHOD, "images/method.gif", "images/method.gif",
                "images/method-error.png", "images/method-error.png"
            },
            {
                PT_TABLE + "." + XLS_TEST_METHOD, "images/test.gif", "images/test.gif",
                "images/test-error.png", "images/test-error.png"
            },
            {
                PT_TABLE + "." + XLS_RUN_METHOD, "images/test.gif", "images/test.gif",
                "images/test-error.png", "images/test-error.png"
            }
        };
    ...
    public void renderElement(ProjectTreeElement parent, ProjectTreeElement element,
