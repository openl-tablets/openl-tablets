...
public class DependencyControllerTestCase extends TestCase {
    public void testVersionFromString() {
        ...
        int[][] expected = { { RepositoryProjectVersionImpl.MAX_MM_INT, RepositoryProjectVersionImpl.MAX_MM_INT, 1 }, { RepositoryProjectVersionImpl.MAX_MM_INT, RepositoryProjectVersionImpl.MAX_MM_INT, 1 },
                { 0, 4, 0 }, { 0, 4, 0 }, { 2, 1, 2 }, { 2, 1, 4 },
                { 21, 22, 123 } };
