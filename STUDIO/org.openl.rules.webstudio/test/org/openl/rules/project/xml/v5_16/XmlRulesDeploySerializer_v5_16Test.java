...
public class XmlRulesDeploySerializer_v5_16Test {
    ...
    public void testReadRulesDeploy() throws Exception {
        ...
        BaseRulesDeploySerializer<RulesDeploy_v5_16> serializer =
                new BaseRulesDeploySerializer<>(new RulesDeployVersionConverter_v5_16(), RulesDeploy_v5_16.class);
