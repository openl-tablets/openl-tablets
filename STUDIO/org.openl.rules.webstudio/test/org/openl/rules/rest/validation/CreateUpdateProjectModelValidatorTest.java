...
public class CreateUpdateProjectModelValidatorTest extends AbstractConstraintValidatorTest {
    ...
    public void testCreateProject_NotValid5() throws IOException {
        ...
        try {
            ...
            assertEquals("Cannot create project because project with such name already exists.", e.getMessage());
        }
    }
    ...
    public void testCreateProject_NotValid6() throws IOException {
        ...
        when(mockedRepo.check(eq(model.getPath() + model.getProjectName()))).thenReturn(mock(FileData.class));
    ...
    public void testCreateProject_NotValid7() throws IOException {
        ...
        try {
            ...
            assertEquals("Cannot create the project because a path conflicts with an existed project.", e.getMessage());
        }
    }
    ...
    public void testUpdateProject() throws IOException, ProjectException {
        ...
        try {
            ...
            assertEquals("Project 'Example 1 - Bank Rating' is not found.", e.getMessage());
        }
