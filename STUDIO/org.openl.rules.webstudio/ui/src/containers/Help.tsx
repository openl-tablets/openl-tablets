...
const documentationItems = [
    ...
    'OpenL Tablets - WebStudio User Guide',
...
export const Help: React.FC = () => {
    ...
    const baseLink = `${openlUrl}/files/openl-tablets/${openlVersion}/`
        ...
        <Row justify="center">
            <Col style={{ marginTop: 16 }} span={6}>
                ...
                <List>
                    ...
                    <List.Item>
                        <Link rel="noopener noreferrer" target="_blank" to="https://github.com/openl-tablets/openl-tablets/discussions">OpenL Tablets Discussions</Link>
                    </List.Item>
                </List>
                ...
                <List>
                    ...
                    <List.Item>
                        <Link rel="noopener noreferrer" target="_blank" to="/rest/api-docs">Internal REST API documentation based on the OpenAPI schema</Link>
                    </List.Item>
                </List>
            </Col>
            <Col span={1} />
