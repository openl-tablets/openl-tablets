...
public interface DiffElement {
     ...
     * <li>{@link DiffStatus#ORIGINAL_ABSENT} shows that it is absent in original data
     * but exists in at least one comparing data</li>
     * </ul>
    ...
    /**
     * Shows whether hierarchy of all children, regardless of their properties,
     * are the same for compared and original elements.
     *
    ...
    /**
     * Shows whether hierarchy and properties of all children
     * are the same for compared and original elements.
     *
     ...
     * <p>
     * In case if some comparing data has no such element it will return
     * {@literal null}.
     * 
