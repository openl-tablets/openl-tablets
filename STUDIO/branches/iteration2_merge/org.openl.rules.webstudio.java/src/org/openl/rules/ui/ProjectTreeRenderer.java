 ...
 * @author snshor
 */
public class ProjectTreeRenderer extends DTreeRenderer implements
		IProjectTypes, ITableNodeTypes {
	...
	static String[][] icons = {
			...
			,
			{ PT_TABLE + "." + XLS_DT, "webresource/images/dt3.png",
					"webresource/mages/dt3.png",
					"webresource/images/dt3-error.png",
					"webresource/images/dt3-error.png",
					"webresource/images/dt3-check.png",
					"webresource/images/dt3-check.png", },
			{ PT_TABLE + "." + XLS_SPREADSHEET,
			...
			{ PT_TABLE + "." + XLS_TBASIC,
	                 ...
	                 "webresource/images/tbasic-error.gif",
	                 "webresource/images/tbasic-check.gif",
	                 "webresource/images/tbasic-check.gif", },
	        { PT_TABLE + "." + XLS_COLUMN_MATCH,
	                 ...
	                 "webresource/images/cmatch-error.gif",
	                 "webresource/images/cmatch-check.gif",
	                 "webresource/images/cmatch-check.gif", },
			...
			{ PT_TABLE + "." + XLS_METHOD, "webresource/images/method.gif",
					...
					"webresource/images/method-error.png" },
			{ PT_TABLE + "." + XLS_TEST_METHOD,
					"webresource/images/test_ok.gif",
					"webresource/images/test_ok.gif",
					"webresource/images/test_ok-error.gif",
					"webresource/images/test_ok-error.gif" },
