...
<% } %>
        &nbsp;
        <a target="_top" href='<%=request.getContextPath()%><%= (Boolean)application.getAttribute("allowLocalUser") ? "/faces/login.xhtml":"/logoff.servlet?_j_acegi_logout=true"%>' title="Logout" onclick="return confirm('Are you sure you want to log off?')"><img border=0 src="<%= request.getContextPath()%>/images/logout.gif" alt="Logout"></a>
      </td>
      </table>
