...
%>   
 ...
 %>  	
   ...
   <tr>
   	<td class="menu"><a href="?<%=parsView%>&view=view.developer"><img src="../images/developer-view.png" title="Developer (Full) View"/></a></td>
   	<td class="menu"><a href="?<%=parsView%>&view=view.business"><img src="../images/business-view.png" title="Business View"/></a></td>
