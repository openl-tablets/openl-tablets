...
class XmlRulesDecisionTable2Delegator extends DecisionTable implements XmlRulesMethodDelegator {
    private DecisionTable delegate;

    public XmlRulesDecisionTable2Delegator(DecisionTable delegate) {
