...
// <<< INSERT >>>
        ...
        if (currentDate != null){
            if (currentDate instanceof java.util.Date) {
                ...
                IOpenCast opencast = ObjectToDataOpenCastConvertor.getConvertor(java.util.Date .class, (currentDate).getClass());
                if (opencast != null){
        ...
        if (requestDate != null){
            if (requestDate instanceof java.util.Date) {
                ...
                IOpenCast opencast = ObjectToDataOpenCastConvertor.getConvertor(java.util.Date .class, (requestDate).getClass());
                if (opencast != null){
        ...
        if (lob != null){
            if (lob instanceof java.lang.String) {
                ...
                IOpenCast opencast = ObjectToDataOpenCastConvertor.getConvertor(java.lang.String .class, (lob).getClass());
                if (opencast != null){
        ...
        if (usState != null){
            if (usState instanceof org.openl.rules.enumeration.UsStatesEnum) {
                ...
                IOpenCast opencast = ObjectToDataOpenCastConvertor.getConvertor(org.openl.rules.enumeration.UsStatesEnum .class, (usState).getClass());
                if (opencast != null){
        ...
        if (country != null){
            if (country instanceof org.openl.rules.enumeration.CountriesEnum) {
                ...
                IOpenCast opencast = ObjectToDataOpenCastConvertor.getConvertor(org.openl.rules.enumeration.CountriesEnum .class, (country).getClass());
                if (opencast != null){
        ...
        if (usRegion != null){
            if (usRegion instanceof org.openl.rules.enumeration.UsRegionsEnum) {
                ...
                IOpenCast opencast = ObjectToDataOpenCastConvertor.getConvertor(org.openl.rules.enumeration.UsRegionsEnum .class, (usRegion).getClass());
                if (opencast != null){
        ...
        if (currency != null){
            if (currency instanceof org.openl.rules.enumeration.CurrenciesEnum) {
                ...
                IOpenCast opencast = ObjectToDataOpenCastConvertor.getConvertor(org.openl.rules.enumeration.CurrenciesEnum .class, (currency).getClass());
                if (opencast != null){
        ...
        if (lang != null){
            if (lang instanceof org.openl.rules.enumeration.LanguagesEnum) {
                ...
                IOpenCast opencast = ObjectToDataOpenCastConvertor.getConvertor(org.openl.rules.enumeration.LanguagesEnum .class, (lang).getClass());
                if (opencast != null){
        ...
        if (region != null){
            if (region instanceof org.openl.rules.enumeration.RegionsEnum) {
                ...
                IOpenCast opencast = ObjectToDataOpenCastConvertor.getConvertor(org.openl.rules.enumeration.RegionsEnum .class, (region).getClass());
                if (opencast != null){
        ...
        if (caProvince != null){
            if (caProvince instanceof org.openl.rules.enumeration.CaProvincesEnum) {
                ...
                IOpenCast opencast = ObjectToDataOpenCastConvertor.getConvertor(org.openl.rules.enumeration.CaProvincesEnum .class, (caProvince).getClass());
                if (opencast != null){
        ...
        if (caRegion != null){
            if (caRegion instanceof org.openl.rules.enumeration.CaRegionsEnum) {
                ...
                IOpenCast opencast = ObjectToDataOpenCastConvertor.getConvertor(org.openl.rules.enumeration.CaRegionsEnum .class, (caRegion).getClass());
                if (opencast != null){
