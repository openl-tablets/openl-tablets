...
import org.openl.rules.repository.JcrRepositoryFactory;
...
import org.openl.rules.repository.jcr.impl.JcrRepositoryImpl;
 ...
 *
 */
public abstract class AbstractRepositoryFactory implements JcrRepositoryFactory {
	 ...
	 * 
	 * @throws if fails to check first start
	 */
