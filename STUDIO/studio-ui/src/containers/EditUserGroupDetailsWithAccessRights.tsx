...
import { DisplayUserName, RepositoryType, Role } from 'constants/'
...
const ROOT_REPOSITORY_ID_MAP: Record<RepositoryType, string> = {
    [RepositoryType.DESIGN]: 'REVTSUdO',
    [RepositoryType.PROD]: 'UFJPRA=='
}
