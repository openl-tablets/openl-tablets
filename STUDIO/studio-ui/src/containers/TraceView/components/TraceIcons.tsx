...
const RulesetIcon: React.FC<{ size?: number }> = ({ size = 16 }) => (
...
const SpreadsheetIcon: React.FC<{ size?: number }> = ({ size = 16 }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" style={{ verticalAlign: 'middle' }}>
...
const ValueIcon: React.FC<{ size?: number }> = ({ size = 16 }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" style={{ verticalAlign: 'middle' }}>
...
const MethodIcon: React.FC<{ size?: number }> = ({ size = 16 }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" style={{ verticalAlign: 'middle' }}>
        <text
            x="2"
            y="12"
...
const TestOkIcon: React.FC<{ size?: number }> = ({ size = 16 }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" style={{ verticalAlign: 'middle' }}>
...
const TestSuccessIcon: React.FC<{ size?: number }> = ({ size = 16 }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" style={{ verticalAlign: 'middle' }}>
        <path
            d="M2 8 L6 12 L14 4"
            fill="none"
...
const TestFailIcon: React.FC<{ size?: number }> = ({ size = 16 }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" style={{ verticalAlign: 'middle' }}>
...
const CMatchIcon: React.FC<{ size?: number }> = ({ size = 16 }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" style={{ verticalAlign: 'middle' }}>
...
const TBasicIcon: React.FC<{ size?: number }> = ({ size = 16 }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" style={{ verticalAlign: 'middle' }}>
        <rect x="1" y="1" width="14" height="14" fill="#e6f3ff" stroke="#4169e1" strokeWidth="1" />
        <line x1="5" y1="1" x2="5" y2="15" stroke="#4169e1" strokeWidth="1" />
        <line x1="9" y1="1" x2="9" y2="15" stroke="#4169e1" strokeWidth="1" />
...
const TBasicOperationIcon: React.FC<{ size?: number }> = ({ size = 16 }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" style={{ verticalAlign: 'middle' }}>
        <path
...
const TableViewIcon: React.FC<{ size?: number }> = ({ size = 16 }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" style={{ verticalAlign: 'middle' }}>
...
const NoResultIcon: React.FC<{ size?: number }> = ({ size = 16 }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" style={{ verticalAlign: 'middle' }}>
