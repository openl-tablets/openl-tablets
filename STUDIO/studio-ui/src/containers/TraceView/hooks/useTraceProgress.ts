...
export const useTraceProgress = ({
    ...
    const { setExecutionStatus, fetchTraceResult } = useTraceStore()
    ...
    const handleMessage = useCallback(
        ...
        [setExecutionStatus, fetchTraceResult]
    )
    ...
    useEffect(() => {
        ...
        const topic = `/user/queue/projects/${encodeURIComponent(projectId)}/tables/${encodeURIComponent(tableId)}/trace/status`
