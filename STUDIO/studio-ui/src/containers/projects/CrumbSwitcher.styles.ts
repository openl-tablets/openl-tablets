...
export const useStyles = createStyles(({ css, token }) => ({
    ...
    `,
    /**
     * The two halves side by side, where the name leads somewhere of its own: the reader follows the name
     * and opens the list from the caret, so neither gesture takes the other's place.
     */
    split: css`
        display: inline-flex;
        align-items: center;
