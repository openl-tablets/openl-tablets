...
public class SecureDesignMappedRepository extends SecureDesignBranchRepository implements FolderMapper {
    private final MappedRepository mappedRepository;

    public SecureDesignMappedRepository(MappedRepository repository,
