...
/**
 * {@link org.acegisecurity.userdetails.UserDetailsService} extentsion that returns
 * {@link UserInfoUserDetailsService} objects.
 * This interface must be implemented by any OpenL security implementation.
 *
...
public interface UserInfoUserDetailsService extends UserDetailsService {
	 ...
	 * actually requested..
	 *
	 * @param username the username presented to the {@link org.acegisecurity.providers.dao.DaoAuthenticationProvider}
