...
/**
 * <p>
 * Based on {@link org.acegisecurity.vote.RoleVoter}.
 * If Authentication has {@link org.openl.rules.security.Privileges#ROLE_ADMIN} authority it will get access
 * even if it is not specified explicitly.
 * </p>
 * <p>
...
public class OpenLRoleVoter implements AccessDecisionVoter {
    public boolean supports(ConfigAttribute configAttribute) {
        ...
        if ((attr != null) && attr.startsWith(Roles.ROLE_PREFIX)) {
            return true;
        } else {
            return false;
        }
