...
//        return (AProject) new MockProject(PROJECT1_NAME).addFolder(FOLDER1).addFile(FILE1_1).up().addFile(FILE1_2).up()
//                .up().addFolder(FOLDER2).up();
//    }
//
//    private AProject makeProject2() {
//        return (AProject) new MockProject(PROJECT2_NAME).addFolder(FOLDER1)._setEffectiveDate(EFFECTIVE_DATE).addFile(
...
//    }
//
//    private AProject makeProject3() {
//        props = new HashMap<String, Object>();
//        for (int i = 0; i < propData.length; i++) {
//            props.put(ATTRIBUTE + i + 1, propData[i]);
//        }
//        return (AProject) new MockProject(PROJECT3_NAME).addFolder(FOLDER1).addFile(FILE1_1)._setProps(props).up().up();
//    }
//
//    @Override
