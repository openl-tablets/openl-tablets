...
/**
 * {@link org.acegisecurity.userdetails.UserDetailsService} that can load UserInfo as
...
public class UserInfoUserDetailsServiceImpl implements UserInfoUserDetailsService {
     ...
     * {@inheritDoc}
     */
    public UserInfo loadUserByUsername(String name)
    ...
    /**
     * Creates new instance of <code>org.openl.rules.security.standalone.model.User</code> based on persistent user
     * object.
     *
