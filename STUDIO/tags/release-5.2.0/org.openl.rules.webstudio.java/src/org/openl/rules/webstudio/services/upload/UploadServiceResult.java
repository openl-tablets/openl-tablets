...
public class UploadServiceResult extends ServiceResult {
    ...
    /**
     * Number of uploaded files (can be different from 1 if user has uploaded
     * zip file with more than 1 file inside).
     * <p>
     * This values is always <code>1</code> for {@link UploadService}.
     * </p>
     *
