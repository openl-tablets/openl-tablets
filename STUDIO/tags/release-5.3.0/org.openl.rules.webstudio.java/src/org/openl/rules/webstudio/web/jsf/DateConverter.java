...
/**
 * Special date converter to suppress rich:calendar conversion errors in manual
 * input mode.
 *
...
public class DateConverter implements Converter {
    ...
    public Object getAsObject(FacesContext facesContext, UIComponent uiComponent, String value)
        ...
        String datePattern = ComponentUtils.getStringFromValueBinding(uiComponent, "datePattern");
        TimeZone timeZone = (TimeZone) ComponentUtils.getObjectFromValueBinding(uiComponent, "timeZone");
        try {
