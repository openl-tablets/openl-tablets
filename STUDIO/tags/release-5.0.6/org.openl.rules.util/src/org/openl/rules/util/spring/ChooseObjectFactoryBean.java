 ...
 * 
 * <p> The <code>casesMap</code> is a map with following structure:
 * key=&lt;pattern list&gt;, value=&lt;any object&gt;. </p>
 * 
 * <p> &lt;pattern list&gt; is a comma separated list of regular expressions ({@link
 ...
 * findMatch is not found value of defaultObject will be returned. </p>
 * 
 * <p> Note, that it is not possible to return <code>null</code> values using
 * FactoryBean. </p>
 * 
 * <p> Examples:
 * 
