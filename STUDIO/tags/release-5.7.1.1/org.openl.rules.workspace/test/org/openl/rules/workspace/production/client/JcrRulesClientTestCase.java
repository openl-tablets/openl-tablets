...
public class JcrRulesClientTestCase extends TestCase {
    ...
    private Project makeProject() {
        return (Project) new MockProject(PROJECT_NAME).addFolder(FOLDER1).addFile(FILE1_1).setInputStream(
    ...
    private Project makeProject2() {
        return (Project) new MockProject(PROJECT_NAME2).addFolder(FOLDER1).addFile(FILE1_2).setInputStream(
