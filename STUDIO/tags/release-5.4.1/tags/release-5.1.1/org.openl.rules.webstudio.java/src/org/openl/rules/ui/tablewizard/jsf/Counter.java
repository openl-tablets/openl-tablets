...
public class Counter {
    ...
    public int getPrev() {return count-1;}

    /**
     * Resets counter. The method is named in this way to allow JSF pages call it so:
     * <code>#{counter.reset}</code>
     *
     * @return <code>true</code>
     */
    public boolean isReset() {count = 0; return true;}
}
