...
//        CommonUser user = new CommonUserImpl("user1");
    ...
    private static void printProject(RProject prj) throws RRepositoryException, IOException {
        out.println("  P " + prj.getPath()
                + "    ver=" + prj.getActiveVersion().getVersionName() 
                + " lob=" + prj.getLineOfBusiness());
    ...
    private static void printTree(RFolder folder) throws RRepositoryException, IOException {
        out.println("  F " + folder.getPath()
                  + "    ver=" + folder.getActiveVersion().getVersionName()
                  + " lob=" + folder.getLineOfBusiness());
        ...
        for (RFile f : files) {
            out.println("  R " + f.getPath()
                      + "    ver=" + f.getActiveVersion().getVersionName() 
                      + " lob=" + f.getLineOfBusiness());
