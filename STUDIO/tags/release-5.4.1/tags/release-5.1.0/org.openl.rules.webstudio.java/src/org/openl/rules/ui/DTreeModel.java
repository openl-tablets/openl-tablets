...
public class DTreeModel implements IProjectTypes, ITableNodeTypes {
    ...
    static final String[] DEFAULT_ICON_OPEN = { "webresource/images/dtree/folder-o-n.gif",
            "webresource/images/folder-o-error.png" }, DEFAULT_ICON_CLOSED = {
            "webresource/images/dtree/folder-c-n.gif", "webresource/images/folder-c-error.png" }, DEFAULT_ICON_LEAF = {
