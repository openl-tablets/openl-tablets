...
public interface ProjectsContainer<T extends Project> {
     ...
     * regard first segment of the path as project name, then it should call {@link Project#getArtefactByPath(ArtefactPath)}
     * with the rest of <code>artefactPath</code> as parameter.
     *
