...
public final class Comments {
    ...
    public Comments(PropertyResolver environment, String prefix) {
        ...
        newBranchNameTemplate = environment.getProperty(REPOSITORY_PREFIX + prefix + "new-branch.pattern");
    }
    ...
    public String createProject(String projectName) {
        return getCreateProjectTemplate().replace(PROJECT_NAME, projectName == null ? StringUtils.EMPTY : projectName);
    }
