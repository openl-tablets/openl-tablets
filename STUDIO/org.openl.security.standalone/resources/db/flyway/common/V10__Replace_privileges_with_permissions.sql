...
INSERT INTO ACL_PERMISSION_MAPPING (CLASS, OBJECT_ID_IDENTITY, MASK, AUTHORITY) VALUES ('org.openl.security.acl.repository.DeploymentProjectArtifact', 'deploy-config', 50331664, 'EDIT_DEPLOYMENT');      /* ADD */
