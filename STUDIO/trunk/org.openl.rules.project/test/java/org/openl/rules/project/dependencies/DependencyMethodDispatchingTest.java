...
public class DependencyMethodDispatchingTest {
    ...
    public void testAmbigiousMethodException() {
        ...
        ProjectDescriptor descr = strategy.resolveProject(new File("test/resources/dependencies/testMethodDispatching"));
        ...
        ResolvingRulesProjectDependencyLoader loader2 = new ResolvingRulesProjectDependencyLoader("test/resources/dependencies/testMethodDispatching");
