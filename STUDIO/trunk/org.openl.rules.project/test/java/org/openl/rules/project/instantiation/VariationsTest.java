...
public class VariationsTest {
	...
	public void testVariationsFactory() {
		Variation argumentReplacementVariation = VariationsFactory
				.getVariation("changeArg", 2, ".", new Object());
		assertTrue(argumentReplacementVariation instanceof ArgumentReplacementVariation);
		assertEquals(
				((ArgumentReplacementVariation) argumentReplacementVariation)
						.getUpdatedArgumentIndex(),
				2);
		String path = "drivers[name = 'Sara']/age";
		Variation jxpathVariation = VariationsFactory.getVariation("jxpath", 3,
				path, new Object());
		assertTrue(jxpathVariation instanceof JXPathVariation);
		assertEquals(((JXPathVariation) jxpathVariation).getPath(), path);
		Variation cloningVariation = VariationsFactory.getVariation("clone", 1,
				path, new Object(), true);
		assertTrue(((DeepCloninigVariaion) cloningVariation)
				.getDelegatedVariation() instanceof JXPathVariation);
