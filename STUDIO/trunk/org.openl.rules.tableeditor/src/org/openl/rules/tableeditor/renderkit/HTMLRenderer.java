...
public class HTMLRenderer {
    ...
    protected String renderEditor(String editorId, String cellToEdit) {
        ...
        result.append(renderJSBody("var " + editor + ";")).append(renderJS("js/IconManager.js")).append(
                renderJS("js/TableEditor.js")).append(
                renderJSBody("var jsPath = \"" + WebUtil.internalPath("js/") + "\"")).append(
                renderEditorToolbar(editorId, editor)).append(renderJS("js/BaseEditor.js")).append(
                renderJS("js/TextEditor.js"))
                ...
                .append("<div id=\"").append(tableId).append("\"></div>").append(renderJS("js/initTableEditor.js"))
                .append(
                        renderJSBody("setTimeout(function(){"
                                + editor // setTimeout for IE
                                + " = initTableEditor(\"" + editorId + "\", \"" + WebUtil.internalPath("ajax/")
                                + "\",\"" + cellToEdit + "\")},10);"));
        return result.toString();
    }
    ...
    protected String renderEditorToolbar(String editorId, String editor) {
        ...
        // .append(renderEditorToolbarItem(editorId + "_move_row_down",
