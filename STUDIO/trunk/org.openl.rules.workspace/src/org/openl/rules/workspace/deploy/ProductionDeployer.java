...
public interface ProductionDeployer {
    ...
    /**
     * Deploys a collection of <code>Project</code>s to the production repository with given ID. A concrete deployer may
     * choose what to do if there is a deployment with given <i>id</i> already exists: overwrite it, throw an exception, etc.
     *
     * @param projects projects to deploy
