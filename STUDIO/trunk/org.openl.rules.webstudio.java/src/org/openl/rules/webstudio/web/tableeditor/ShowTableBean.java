...
public class ShowTableBean {
    ...
    public IGridTable getTable() {
        ...
        IGridTable table = studio.getModel().getTableWithMode(elementID == -1 ? studio.getTableID() : elementID,
                getView());
        return table;
    }
    ...
    public static class TestRunsResultBean {
        ...
        public class TestProxy {
            ...
            public String getTestName() {
                return WebTool.encodeURL(getTest().getTestName());
            }
