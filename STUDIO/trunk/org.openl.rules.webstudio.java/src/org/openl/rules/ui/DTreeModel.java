...
public class DTreeModel implements IProjectTypes, ITableNodeTypes {
    ...
    static final String[] DEFAULT_ICON_OPEN = { "webresource/images/dtree/folder-open.png",
            "webresource/images/dtree/folder-open-error.png" }, DEFAULT_ICON_CLOSED = {
            "webresource/images/dtree/folder.png", "webresource/images/dtree/folder-error.png" }, DEFAULT_ICON_LEAF = {
            "webresource/images/categoryset.gif", "webresource/images/categoryset.gif" };
    ...
    static String[][] icons = {
            ...
            { PT_TABLE + "." + XLS_DT, "webresource/images/ruleset.gif", "webresource/images/ruleset-h.gif",
            ...
            { PT_TABLE + "." + XLS_DATATYPE, "webresource/images/dataobject.gif", "webresource/images/dataobject.gif",
                    "webresource/images/dataobject-error.png", "webresource/images/dataobject-error.png" },
            ...
            { PT_TABLE + "." + XLS_TEST_METHOD, "webresource/images/test.gif", "webresource/images/test.gif",
