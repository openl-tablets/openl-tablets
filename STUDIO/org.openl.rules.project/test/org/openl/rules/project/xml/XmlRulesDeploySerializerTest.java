...
public class XmlRulesDeploySerializerTest {
    ...
    public void testReadRulesDeploy() throws Exception {
        ...
        assertEquals(1, rulesDeploy.getLogStorages().length);
        assertEquals(RulesDeploy.LogStorageType.CASSANDRA, rulesDeploy.getLogStorages()[0]);
    ...
    public void testWriteRulesDeploy() {
        ...
        XmlRulesDeploySerializer serializer = new XmlRulesDeploySerializer();
        rulesDeploy.setLogStorages(new RulesDeploy.LogStorageType[] { RulesDeploy.LogStorageType.CASSANDRA });
