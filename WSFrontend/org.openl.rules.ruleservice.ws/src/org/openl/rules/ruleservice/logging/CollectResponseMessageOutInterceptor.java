...
public class CollectResponseMessageOutInterceptor extends AbstractProcessLoggingMessageInterceptor {
    ...
    private LoggingInfoStoringService loggingInfoStoringService;

    public LoggingInfoStoringService getLoggingInfoStoringService() {
        return loggingInfoStoringService;
    }

    public CollectResponseMessageOutInterceptor(String phase, LoggingInfoStoringService loggingInfoStoringService) {
        super(phase);
        addBefore(StaxOutInterceptor.class.getName());
        this.loggingInfoStoringService = loggingInfoStoringService;
    }

    public CollectResponseMessageOutInterceptor(LoggingInfoStoringService loggingInfoStoringService) {
        this(Phase.PRE_STREAM, loggingInfoStoringService);
    }

    public CollectResponseMessageOutInterceptor(int lim, LoggingInfoStoringService loggingInfoStoringService) {
    ...
    private class StoreTask implements Runnable{
        ...
        public StoreTask(LoggingInfo loggingInfo) {
    ...
    protected void handleMessage(LoggingMessage message) {
        final LoggingInfo loggingInfo = LoggingInfoHolder.get();
        loggingInfo.setResponseMessage(message);
        loggingInfo.setOutcomingMessageTime(new Date());
        executorService.submit(new StoreTask(loggingInfo));
        LoggingInfoHolder.remove();
    }
