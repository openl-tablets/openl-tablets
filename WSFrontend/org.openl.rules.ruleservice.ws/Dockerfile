...
RUN unzip /tmp/*.war -d /usr/local/tomcat/webapps/webservices/ && chmod u=rw,g=r,o=r $(find /usr/local/tomcat/webapps/webservices -type f) && rm /tmp/*.war && mkdir /root/.openl && mkdir -p /usr/local/tomcat/shared/lib
