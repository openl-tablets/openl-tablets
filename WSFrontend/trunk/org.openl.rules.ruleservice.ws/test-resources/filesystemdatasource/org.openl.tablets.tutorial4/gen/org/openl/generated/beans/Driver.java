...
public class Driver {
    ...
    public Driver(String value) {
        this(value, "gender", 1, "maritalStatus", "state", 2, 3, 4, true);
    }

    public Driver(String name, String gender, int age, String maritalStatus, String state, int numAccidents,
            int numMovingViolations, int numDUI, boolean hadTraining) {
        super();
        this.name = name;
        this.gender = gender;
        this.age = age;
