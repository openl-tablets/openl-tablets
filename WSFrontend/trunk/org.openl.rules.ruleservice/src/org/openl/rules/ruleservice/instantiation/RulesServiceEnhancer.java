...
import org.openl.rules.ruleservice.factory.RuleInfo;
import org.openl.rules.ruleservice.factory.RulesFactory;
...
public class RulesServiceEnhancer {
    ...
    public Object instantiate() throws InstantiationException {
        ...
        try {
            ...
            return Proxy.newProxyInstance(instantiationStrategy.getLoader(), getProxyInterfaces(), handler);
        } catch (Exception e) {
            throw new InstantiationException(e.getMessage());
        }
    }
    ...
    private Class<?> decorateMethods(Class<?> clazz) throws Exception {
        ...
        ClassLoader classLoader = instantiationStrategy.getLoader();
