...
public class CleanUpListener
    ...
    @Override
    public void onRemoved(Iterable<CacheEntryEvent<? extends Key, ? extends CompiledOpenClass>> cacheEntryEvents)
            throws CacheEntryListenerException {
        cleanUp(cacheEntryEvents);
    }

    private static void cleanUp(Iterable<CacheEntryEvent<? extends Key, ? extends CompiledOpenClass>> cacheEntryEvents) {
