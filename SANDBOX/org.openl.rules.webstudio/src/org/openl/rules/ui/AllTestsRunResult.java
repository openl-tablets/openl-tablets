...
public class AllTestsRunResult
{
	...
	static public class Test
	{
		 ...
		 * @return
		 */
		public Object run(int tid, Object target, IRuntimeEnv env)
		{
			return method.run(tid, target, env);
		}
	}
	 ...
	 * @return
	 */
	public Object run(String testName, int tid, Object target, IRuntimeEnv env)
	{
		Test test = findTest(testName);
		return test.run(tid, target, env);
	}
