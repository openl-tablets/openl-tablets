...
* Spring Security 6.5 (from 5.x)
* Spring Boot 3.5 (from 2.x)
* OpenSAML 5.2 (from 4.x)
...
* Added a REST API to get the branch list for a project, supporting users with limited repository permissions
...
* **CVE-2025-41249**: Spring Framework vulnerability fixed via upgrade to 6.2.15
* **CVE-2025-41248**: Spring Security vulnerability fixed via upgrade to 6.5.7
...
* Apache Maven Compiler Plugin 3.15.0
* Dependency Check Maven Plugin 12.2.0
...
* Fixed an `UnsupportedOperationException` when retrieving test results with the `unpaged` parameter
* Fixed trace execution failing when a workbook for a virtual source code module had no sheets
* Fixed URL encoding in request URLs
