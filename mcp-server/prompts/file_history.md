...
**VIEW history:**
```
get_file_history(filePath, limit=20)
```

**FIND specific date:**
```
get_file_history(filePath, limit=100) → filter by date → find commitHash
```
...
```
1. get_file_history(filePath) → find last SAVE commit before ERASE
