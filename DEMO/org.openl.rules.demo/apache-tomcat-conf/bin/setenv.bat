...
set DEMO_OPTS=%DEMO_OPTS% -Dproduction-repository.factory=org.openl.rules.repository.factories.RmiJackrabbitProductionRepositoryFactory
set DEMO_OPTS=%DEMO_OPTS% -Dproduction-repository.uri=//localhost:1099/deployment-repository
